...
subplat-privacy-policy-2 = Положення про приватність { -product-mozilla-accounts(capitalization: "upper", case: "gen") }
subplat-privacy-policy-plaintext = { subplat-privacy-policy }:
subplat-privacy-policy-plaintext-2 = { subplat-privacy-policy-2 }:
subplat-moz-terms = Умови надання послуг { -product-mozilla-accounts(capitalization: "upper", case: "gen") }
