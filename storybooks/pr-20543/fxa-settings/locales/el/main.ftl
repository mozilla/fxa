...
cs-scope-firefox-vpn = Το ενσωματωμένο VPN του { -brand-firefox }
...
delete-account-acknowledge = Σημειώστε ότι με τη διαγραφή του λογαριασμού σας:
...
page-passkey-add-error-system-v2 = Προέκυψε πρόβλημα κατά τη δημιουργία του κλειδιού πρόσβασής σας. Δοκιμάστε ξανά αργότερα.
...
recent-activity-account-recovery-phone-replace-failure = Η αντικατάσταση του τηλεφώνου ανάκτησης απέτυχε
recent-activity-account-two-factor-replace-success = Η ταυτοποίηση δύο παραγόντων αντικαταστάθηκε
recent-activity-account-two-factor-replace-failure = Η αντικατάσταση της ταυτοποίησης δύο παραγόντων απέτυχε
...
recent-activity-account-passwordless-login-otp-sent = Απεστάλη κωδικός για σύνδεση χωρίς κωδικό πρόσβασης
recent-activity-account-passwordless-login-otp-failed = Ο κωδικός για σύνδεση χωρίς κωδικό πρόσβασης απέτυχε
...
passkey-row-max-limit-banner =
    { $count ->
       *[other] Έχετε χρησιμοποιήσει και τα { $count } κλειδιά πρόσβασης. Διαγράψτε ένα κλειδί πρόσβασης για να δημιουργήσετε ένα νέο.
    }
passkey-row-max-limit-disabled-reason = Έχετε φτάσει τον μέγιστο αριθμό κλειδιών πρόσβασης.
...
pair-choice-header-send-tab = Κάντε λήψη ή ανοίξτε το { -brand-firefox } στη συσκευή που θέλετε να στείλετε καρτέλες
...
set-password-passwordless-info = Αυτός ο κωδικός πρόσβασης κρυπτογραφεί και τα προστατεύει τα συγχρονισμένα δεδομένα σας.
...
signin-passkey-fallback-header = Ολοκλήρωση σύνδεσης
...
signin-passwordless-code-subheading = Η σύνδεση γίνεται σε ένα μόνο βήμα όταν χρησιμοποιείτε αυτόν τον κωδικό.
...
signin-passwordless-code-resend-link = Αποστολή νέου κωδικού μέσω email.
signin-passwordless-code-resend-error = Κάτι πήγε στραβά. Δεν ήταν δυνατή η αποστολή νέου κωδικού.
signin-passwordless-code-other-account-link = Χρήση διαφορετικού λογαριασμού


signup-passwordless-code-subheading = Η εγγραφή γίνεται σε ένα μόνο βήμα όταν χρησιμοποιείτε αυτόν τον κωδικό.


signin-passwordless-totp-required = Έχει ενεργοποιηθεί η ταυτοποίηση δύο παραγόντων στον λογαριασμό σας. Συνδεθείτε με τον κωδικό πρόσβασής σας.
