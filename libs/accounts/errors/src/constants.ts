...
export const ERRNO = {
  ...
  PASSKEY_ALREADY_REGISTERED: 225,
  ...
  PASSKEY_WRAP_NOT_FOUND: 234,
  PASSKEY_WRAP_CONFLICT: 235,
  PASSKEY_VERIFICATION_PROOF_INVALID: 236,
  // 237 is free; the next passkey errno goes there
