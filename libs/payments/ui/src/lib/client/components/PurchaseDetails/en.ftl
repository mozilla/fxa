...
purchase-details-unused-time-label = Unused time
purchase-details-subtotal-label = Subtotal
# "Credit applied" refers to account credit used to reduce the amount due on the invoice
purchase-details-credit-applied-label = Credit applied
# "Amount due" is the total that the customer owes after all credits, discounts, and taxes have been applied
purchase-details-amount-due-label = Amount due
