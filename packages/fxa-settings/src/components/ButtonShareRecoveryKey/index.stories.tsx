...
import ButtonShareRecoveryKey from '.';
import { withLocalization } from '../../../.storybook/decorators';
import { Account, AppContext } from '../../models';
import { MOCK_ACCOUNT, mockAppContext } from '../../models/mocks';

export default {
  title: 'Components/ButtonShareRecoveryKey',
  component: ButtonShareRecoveryKey,
...
const storyWithContext = (account: Account) => {
  const story = () => (
    <AppContext.Provider value={mockAppContext({ account })}>
      <AppLayout>
        <ButtonShareRecoveryKey {...{ recoveryKeyValue, viewName }} />
      </AppLayout>
    </AppContext.Provider>
  );
  return story;
