...
diners-logo-alt-text2 = { -brand-diners } ra’ãnga’i
...
error-payment-method-banner-message-add-new-card = Embojuaju kuatia’atã pyahu térã jehepyme’ẽrã ani hag̃ua oso’oso ne ñemboheraguapy.
error-payment-method-banner-label-update-payment-method = Embohekopyahu nde jehepyme’ẽrã
error-payment-method-expired-card = Nde kuatia’atã ndoikovéima. Embojuaju kuatia’atã pyahu térã jehepyme’ẽrã ani hag̃ua oso’oso ne ñemboheraguapy.
error-payment-method-banner-title-invalid-payment-information = Jehepyme’ẽ marandu ndoikói
error-payment-method-banner-message-account-issue = Oĩ peteĩ apañuái ne mba’ete ndive.
...
payments-header-bento-firefox-mobile = { -brand-firefox } kundahára pumbyrýpe g̃uarã
...
upgrade-purchase-details-credit-will-be-applied = Pe virume’ẽ oĩta ne mba’etépe ha ojeporúta nde kuatiañemure oútavape.
...
stay-subscribed-error-expired = Ko ñekuave’ẽ ndoikovéima.
...
next-charge-with-discount-no-tax = Hembyvéta { $discountPercent }% jehepyme’ẽrã oútavape { $nextInvoiceTotal } og̃uahẽvo { $currentPeriodEnd }.
next-charge-with-tax-card = Jehepyme’ẽrã oútava ha’éta { $nextInvoiceTotal } + { $taxDue } impuesto-ramo nde kuatia’atãme hu’ãtava { $last4 }-pe og̃uahẽvo { $currentPeriodEnd }.
next-charge-with-tax-payment-method = Jehepyme’ẽrã ha’éta { $nextInvoiceTotal } + { $taxDue } impuesto mba’éicha ehepyme’ẽta { $paymentMethod } { $currentPeriodEnd }.
next-charge-with-tax = Jehepyme’ẽrã ha’éta { $nextInvoiceTotal } + { $taxDue } impuesto-ramo { $currentPeriodEnd }.
next-charge-no-tax-card = Jehepyme’ẽrã ha’éta { $nextInvoiceTotal } nde kuatia’atãme hu’ãtava { $last4 }-pe og̃uahẽvo { $currentPeriodEnd }.
next-charge-no-tax-payment-method = Jehepyme’ẽrã ha’éta { $nextInvoiceTotal } mba’éichapa ehepyme’ẽta { $paymentMethod } og̃uahẽvo { $currentPeriodEnd }.
next-charge-no-tax = Jehepyme’ẽrã oútava ha’éta { $nextInvoiceTotal } pe { $currentPeriodEnd }.
