...
link-sr-new-window = പുതിയ ജാലകത്തില്‍ തുറക്കും


app-loading-spinner-aria-label-loading = ലഭ്യമാക്കുന്നു…
...
modal-mfa-protected-cancel-button = റദ്ദാക്കുക
...
page-passkey-add-cancel = റദ്ദാക്കുക
...
passkey-delete-modal-cancel-button = റദ്ദാക്കുക
...
pair-supp-allow-cancel-link = റദ്ദാക്കുക
