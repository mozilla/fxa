...
describe('FlowSetup2faPrompt', () => {
  ...
  it('renders as expected', () => {
    ...
    expect(
      screen.getByText(
        '123Done requires you set up two-step authentication to keep your account safe.'
      )
    ).toBeInTheDocument();
  ...
  it('calls onCancel when cancel button is clicked', async () => {
    const { onCancel } = renderFlowSetup2faPrompt();
  ...
  it('renders the TwoFactorAuthImage', () => {
    renderFlowSetup2faPrompt();
  });
});
