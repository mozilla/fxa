...
export class FxaMailer extends FxaEmailRenderer {
  ...
  async sendVerifyEmail(
    ...
    console.debug('sendVerifyEmail opts', {links, headers, rendered, opts});
    try {
      const sent = this.sendEmail(opts, headers, rendered);
  ...
  async sendVerifyLoginEmail(
    ...
    console.debug('send verifyLoginEmail data', {links, headers, opts, rendered});
    return this.sendEmail(opts, headers, rendered);
  }
