 ...
 * "Confirm" on the Backup codes page.
 *
...
/**
 * Event that indicates the user successfully authenticated via backup
 * codes.
 *
...
/**
 * Event that indicates a successful view/load of the backup codes
 * authentication page on the login funnel. The page prompts the user to
 * enter a backup security code.
 *
