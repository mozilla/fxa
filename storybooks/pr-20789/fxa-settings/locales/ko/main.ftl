...
passkey-row-header = 패스키
passkey-row-enabled = 사용함
...
terms-privacy-agreement-intro-3 = 계속 진행하면 다음 사항에 동의하게 됩니다:
terms-privacy-agreement-customized-terms = { $serviceName }: <termsLink>이용 약관</termsLink> 및 <privacyLink>개인정보 보호정책</privacyLink>
terms-privacy-agreement-mozilla-2 = { -product-mozilla-accounts(capitalization: "uppercase") } <mozillaAccountsTos>이용 약관</mozillaAccountsTos> 및 <mozillaAccountsPrivacy>개인정보 보호정책</mozillaAccountsPrivacy>
...
auth-error-224 = 패스키를 찾을 수 없음
auth-error-225 = 패스키가 이미 등록됨
...
passkey-registration-error-invalid-state = 이 패스키는 이미 등록되었습니다. 로그인하거나 다른 패스키를 추가하는 데 사용하세요.
passkey-registration-error-not-readable = 인증기에 접근할 수 없습니다. 다시 시도하거나 다른 방법을 선택하십시오.
...
passkey-authentication-error-invalid-state = 패스키에 문제가 발생했습니다. 다시 시도하거나 다른 로그인 방법을 사용하세요.
...
pair-choice-has-mobile-title = 모바일용 { -brand-firefox }를 사용하고 있습니다.
pair-choice-has-mobile-description = 모바일 기기에서 이미 { -brand-firefox }를 사용하고 있다면 지금 동기화를 시작할 수 있습니다.
pair-choice-needs-mobile-title = 모바일용 { -brand-firefox }를 사용하지 않습니다.
pair-choice-needs-mobile-description = 모바일 기기에 { -brand-firefox }를 다운로드하고 동기화를 시작하세요.
pair-choice-continue-button = 계속
pair-signed-in-successfully = 로그인 성공!
pair-account-created-now-syncing = 계정이 생성되었습니다. 동기화가 시작되었습니다.
pair-password-created-now-syncing = 비밀번호가 생성되었습니다. 동기화가 시작되었습니다.
...
service-welcome-signin-success-banner = 로그인 성공!
service-welcome-vpn-heading = 다음: VPN 켜기
service-welcome-vpn-description = 브라우저의 개인 정보 보호를 강화하기 위한 한 단계가 더 있습니다. 열린 패널로 가서 패널을 켜세요.
...
set-password-passwordless-info = 이 비밀번호는 동기화 된 데이터를 암호화하고 안전하게 유지합니다.
...
signin-recovery-error = 무언가 잘못되었습니다. 다시 로그인하세요.
...
signin-passkey-fallback-header = 로그인 완료
signin-passkey-fallback-heading = 동기화하려면 비밀번호 입력
...
signin-passwordless-code-heading = 인증 코드 입력
signin-passwordless-code-subheading = 이 코드를 이용하면 한 번만에 로그인할 수 있습니다.
signin-passwordless-code-instruction = { $expirationMinutes }분 이내에 <email>{ $email }</email> 메일로 전송된 코드를 입력하세요.
signin-passwordless-code-input-label-v2 = 6자리 숫자 코드 입력
signin-passwordless-code-confirm-button = 확인
signin-passwordless-code-required-error = 확인 코드 필요
signin-passwordless-code-expired = 코드가 만료되었나요?
signin-passwordless-code-resend-countdown = { $seconds }초 후에 이메일로 새 코드를 보내세요.
signin-passwordless-code-resend-link = 이메일로 새 코드를 받으세요.
signin-passwordless-code-resend-error = 문제가 발생했습니다. 새 코드를 보낼 수 없습니다.
signin-passwordless-code-other-account-link = 다른 계정 사용


signup-passwordless-code-subheading = 이 코드를 이용하면 한 번만에 가입할 수 있습니다.


signin-passwordless-totp-required = 계정에 2단계 인증이 켜져 있습니다. 비밀번호를 이용해 로그인해 주십시오.
