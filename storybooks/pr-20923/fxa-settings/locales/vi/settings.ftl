...
page-passkey-add-error-system-v2 = Đã xảy ra lỗi khi tạo passkey cho bạn. Vui lòng thử lại sau.
...
passkey-sub-row-rename-title = Đổi tên passkey
passkey-rename-modal-heading = Đổi tên passkey
passkey-rename-modal-description = Nhập tên mới cho passkey này.
passkey-rename-input-label = Tên passkey
passkey-rename-save-button = Lưu
passkey-rename-cancel-button = Hủy bỏ
passkey-rename-error-empty = Nhập tên cho passkey này
passkey-rename-error-too-long = Chỉ chấp nhận tên ít hơn 256 ký tự.
passkey-rename-error-invalid = Chỉ cho phép sử dụng chữ cái, số, dấu câu và ký hiệu.
passkey-rename-error-duplicate = Một passkey với tên này đã tồn tại
passkey-rename-success = Đã đổi tên passkey
passkey-rename-error = Đã xảy ra lỗi khi đổi tên passkey của bạn. Vui lòng thử lại sau vài phút.
...
terms-privacy-agreement-intro-3 = Bằng cách tiếp tục, bạn đồng ý với những điều sau:
...
terms-privacy-agreement-customized-terms = { $serviceName }: <termsLink>Điều khoản dịch vụ</termsLink> và <privacyLink>thông báo về quyền riêng tư</privacyLink>
# links to Mozilla Accounts Terms of Service and Privacy Notice, part of a bulleted list
terms-privacy-agreement-mozilla-2 = { -product-mozilla-accounts(capitalization: "uppercase") }: <mozillaAccountsTos>Điều khoản dịch vụ</mozillaAccountsTos> và <mozillaAccountsPrivacy>thông báo về quyền riêng tư</mozillaAccountsPrivacy>
...
auth-error-233 = Để tạo passkey, hãy thiết lập khóa màn hình, mã PIN, vân tay hoặc nhận diện khuôn mặt trên thiết bị hoặc khóa bảo mật của bạn. Sau đó thử lại.
...
set-password-passwordless-info = Mật khẩu này mã hoá dữ liệu đã đồng bộ của bạn và giữ cho dữ liệu được bảo mật.
...
signin-passkey-fallback-header = Hoàn tất đăng nhập
...
signin-passwordless-code-subheading = Việc đăng nhập chỉ mất một bước duy nhất khi bạn sử dụng mã này.
# This string is used to show a notification to the user for them to enter
# email confirmation code to update their multi-factor-authentication-protected
# account settings
# Variables:
...
signin-passwordless-code-resend-countdown = Gửi mã mới qua email sau { $seconds } giây
signin-passwordless-code-resend-link = Gửi mã mới qua email.
signin-passwordless-code-resend-error = Đã xảy ra sự cố. Không thể gửi mã mới.
signin-passwordless-code-other-account-link = Sử dụng một tài khoản khác
