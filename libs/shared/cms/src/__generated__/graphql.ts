...
export type ComponentAccountsShared = {
  ...
  headerBackground: Maybe<Scalars['String']['output']>;
...
export type ComponentAccountsSharedFiltersInput = {
  ...
  headerBackground: InputMaybe<StringFilterInput>;
