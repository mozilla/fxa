...
button-passkey-signin = כניסה באמצעות מפתח גישה
button-passkey-signin-loading = בתהליך התחברות מאובטחת…
...
cs-scope-firefox-vpn = ה־VPN המובנה של { -brand-firefox }
...
delete-account-delete-button-passwordless = מחיקת חשבון
...
page-passkey-add-error-system-v2 = הייתה בעיה ביצירת מפתח הגישה שלך. נא לנסות שוב מאוחר יותר.
...
passkey-registration-error-invalid-state = מפתח גישה זה כבר רשום. יש להשתמש בו כדי להיכנס, או להוסיף מפתח גישה אחר.
...
passkey-authentication-error-not-readable = לא הצלחנו לגשת ליישומון המאמת. נא לנסות שוב או להשתמש בשיטת כניסה אחרת.
passkey-authentication-error-unexpected = משהו השתבש. נא לנסות שוב או לבחור בשיטת כניסה אחרת.
passkey-authentication-error-not-found = מפתח הגישה לא מזוהה. נא להשתמש בשיטת כניסה אחרת.
...
pair-auth-complete-send-tab-heading = ניתן לשלוח כמה לשוניות
pair-auth-complete-send-tab-device-connected = ‏{ $deviceFamily } עבור { $deviceOS } מחובר.
pair-auth-complete-send-tab-benefits = באפשרותך לשלוח לשוניות פתוחות, ססמאות וסימניות בין מכשירים, באופן מיידי.
...
pair-failure-header-v2 = צימוד המכשיר נכשל
pair-failure-message-v2 = לא ניתן היה להשלים את ההגדרה. נא להתחבר עם הדוא״ל שלך.
pair-failure-try-again-link = ניסיון חוזר


pair-sync-header = סנכרון { -brand-firefox } עם הטלפון או מחשב הלוח שלך
pair-cad-header-v2 = חיבור מכשיר נוסף
...
pair-choice-subheader = סנכרון חווית המשתמש שלך ב־{ -brand-firefox }
pair-choice-description = צפייה בססמאות השמורות, הלשוניות, היסטוריית הגלישה שלך ועוד - בכל המכשירים שלך.
pair-choice-header-send-tab = יש להוריד או לפתוח את { -brand-firefox } במכשיר שאליו ברצונך לשלוח לשוניות
pair-choice-legend = נא לבחור באפשרות כדי להמשיך:
pair-choice-has-mobile-title = כבר יש לי { -brand-firefox } בנייד
pair-choice-has-mobile-description = ניתן להתחיל בסנכרון עכשיו אם כבר יש לך { -brand-firefox } במכשיר הנייד שלך.
pair-choice-needs-mobile-title = אין לי { -brand-firefox } בנייד
pair-choice-needs-mobile-description = יש להוריד את { -brand-firefox } למכשיר הנייד שלך, ואז להתחיל לסנכרן.
pair-choice-continue-button = המשך
pair-signed-in-successfully = התחברת בהצלחה!
pair-account-created-now-syncing = החשבון נוצר. כעת הינך במצב סנכרון.
pair-password-created-now-syncing = הססמה נוצרה. כעת הינך במצב סנכרון.


pair-download-subheader = הורדת { -brand-firefox } לנייד
pair-download-description = כדי לסנכרן את { -brand-firefox } בטלפון או במחשב הלוח שלך, תחילה יהיה עליך להוריד את { -brand-firefox } לנייד באופן הבא:
pair-download-step-scan-qr = <b>שלב { $stepNumber }</b>: יש להוריד את { -brand-firefox } על־ידי סריקת קוד QR זה עם המצלמה במכשיר הנייד שלך:
pair-download-step-continue-sync = <b>שלב { $stepNumber }</b>: יש לבחור באפשרות ״המשך לסנכרון״ כדי לסנכרן את חוויית המשתמש שלך ב־{ -brand-firefox } למכשיר הנייד שלך.
pair-continue-to-sync-button = המשך לסנכרון


pair-success-header-2 = המכשיר מחובר
pair-success-message-2 = הצימוד בוצע בהצלחה.
pair-success-tab-close-message = לשונית זו תיסגר באופן אוטומטי על־ידי { -brand-firefox }.
...
pair-unsupported-oops-header = אופס! נראה שאינכם משתמשים ב־{ -brand-firefox }.
pair-unsupported-switch-to-firefox = יש לעבור ל־{ -brand-firefox } ולפתוח את דף זה כדי לחבר מכשיר נוסף.
...
pair-unsupported-connecting-mobile-instructions-v2 = יש לפתוח את { -brand-firefox } במחשב שלך, לבקר ב־<b>firefox.com/pair</b>, ולעקוב אחרי ההנחיות שמופיעות על המסך כדי לחבר את המכשיר הנייד.
...
service-welcome-signin-success-banner = התחברת בהצלחה!
service-welcome-vpn-heading = השלב הבא: הפעלת ה־VPN
...
signin-passkey-fallback-header = סיום הכניסה
...
signin-passwordless-code-input-label-v2 = נא להזין קוד בן 6 ספרות
