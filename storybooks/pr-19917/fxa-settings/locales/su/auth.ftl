...
payment-plan-charged = Ditagih: { $invoiceTotal } dina { $invoiceDateOnly }
# Variables
...
# After the colon, there's a link to https://accounts.firefox.com/support
subscriptionSupportContact-plaintext = Hatur nuhun pikeun ngalanggan { $productName }. Lamun anjeun mibanda pananya ngeunaan langganan anjeun atawa perlu inpormasi leuwih leungkep ngeunaan { $productName }, prak iberan urang:
subscriptionUpdateBillingEnsure = Anjeun bisa mastikeun yén cara mayar jeung iber akun anjeun geus diropéa <a data-l10n-name="updateBillingUrl">di dieu</a>.
# After the colon, there's a link to https://accounts.firefox.com/subscriptions
subscriptionUpdateBillingEnsure-plaintext = Anjeun bisa mastikeun yén cara mayar jeung iber akun anjeun diropéa di dieu:
