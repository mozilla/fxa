...
/*
 * The pairing illustrations below are decorative. Every card that renders one
 * states the same thing in its heading and body copy, so WCAG 1.1.1 is met
 * without a text alternative and the artwork stays out of the accessibility
 * tree. `QrPhoneFrameImage` is only the phone around the scannable code, which
