...
upgrade-page-acknowledgment-from-trial = Khi nâng cấp, thời gian dùng thử miễn phí hiện tại của bạn sẽ kết thúc ngay lập tức và bạn sẽ bị tính phí cho gói dịch vụ mới ngay hôm nay.
...
cart-free-trial-mismatch-error = Quyền lợi dùng thử miễn phí của bạn đã thay đổi. Vui lòng thử lại.
...
new-account-prepaid-card-free-trial-not-allowed = Thẻ trả trước không thể được sử dụng để bắt đầu dùng thử miễn phí cho tài khoản mới. Vui lòng thử phương thức thanh toán khác.
...
subscription-management-free-trial-heading = Dùng thử miễn phí
subscription-management-your-free-trials-aria = Dùng thử miễn phí của bạn
# Heading for mobile only quick links menu
subscription-management-jump-to-heading = Đi đến
subscription-management-nav-free-trials = Dùng thử miễn phí
...
error-payment-method-banner-title-expired-card = Thẻ đã hết hạn
error-payment-method-banner-message-add-new-card = Thêm thẻ hoặc phương thức thanh toán mới để tránh gián đoạn gói đăng ký của bạn.
error-payment-method-banner-label-update-payment-method = Cập nhật phương thức thanh toán
error-payment-method-expired-card = Thẻ của bạn đã hết hạn. Vui lòng thêm thẻ hoặc phương thức thanh toán mới để tránh gián đoạn gói đăng ký của bạn.
error-payment-method-banner-title-invalid-payment-information = Thông tin thanh toán không hợp lệ
error-payment-method-banner-message-account-issue = Có vấn đề với tài khoản của bạn.
subscription-management-button-manage-payment-method-1 = Quản lý phương thức thanh toán
subscription-management-error-apple-pay = Có sự cố với tài khoản { -brand-apple-pay } của bạn. Vui lòng giải quyết sự cố để duy trì gói đăng ký đang hoạt động của bạn.
subscription-management-error-google-pay = Có sự cố với tài khoản { -brand-google-pay } của bạn. Vui lòng giải quyết sự cố để duy trì gói đăng ký đang hoạt động của bạn.
subscription-management-error-link = Có sự cố với tài khoản { -brand-link } của bạn. Vui lòng giải quyết sự cố để duy trì gói đăng ký đang hoạt động của bạn.
...
subscription-management-error-payment-method = Có sự cố với phương thức thanh toán của bạn. Vui lòng giải quyết sự cố để duy trì gói đăng ký đang hoạt động của bạn.
...
free-trial-ineligible-notice = Tài khoản của bạn không đủ điều kiện dùng thử miễn phí. Bạn có thể tiếp tục với gói đăng ký trả phí.
...
free-trial-content-trial-expires = Thời gian dùng thử miễn phí của bạn sẽ hết hạn vào { $date }.
free-trial-content-trial-cancelled = Đã huỷ dùng thử miễn phí của bạn.

# Charge info strings - with tax, per interval

free-trial-content-charge-info-with-tax-day = Bạn sẽ bị tính phí { $amount } + { $tax } thuế mỗi ngày sau khi thời gian dùng thử miễn phí kết thúc vào { $date }.
free-trial-content-charge-info-with-tax-week = Bạn sẽ bị tính phí { $amount } + { $tax } thuế mỗi tuần sau khi thời gian dùng thử miễn phí kết thúc vào { $date }.
free-trial-content-charge-info-with-tax-month = Bạn sẽ bị tính phí { $amount } + { $tax } thuế mỗi tháng sau khi thời gian dùng thử miễn phí kết thúc vào { $date }.
free-trial-content-charge-info-with-tax-halfyear = Bạn sẽ bị tính phí { $amount } + { $tax } thuế mỗi sáu tháng sau khi thời gian dùng thử miễn phí kết thúc vào { $date }.
free-trial-content-charge-info-with-tax-year = Bạn sẽ bị tính phí { $amount } + { $tax } thuế mỗi năm sau khi thời gian dùng thử miễn phí kết thúc vào { $date }.
free-trial-content-charge-info-with-tax-default = Bạn sẽ bị tính phí { $amount } + { $tax } thuế sau khi thời gian dùng thử miễn phí kết thúc vào { $date }.

# Charge info strings - no tax, per interval

free-trial-content-charge-info-no-tax-day = Bạn sẽ bị tính phí { $amount } mỗi ngày sau khi thời gian dùng thử miễn phí kết thúc vào { $date }.
free-trial-content-charge-info-no-tax-week = Bạn sẽ bị tính phí { $amount } mỗi tuần sau khi thời gian dùng thử miễn phí kết thúc vào { $date }.
free-trial-content-charge-info-no-tax-month = Bạn sẽ bị tính phí { $amount } mỗi tháng sau khi thời gian dùng thử miễn phí kết thúc vào { $date }.
free-trial-content-charge-info-no-tax-halfyear = Bạn sẽ bị tính phí { $amount } mỗi sáu tháng sau khi thời gian dùng thử miễn phí kết thúc vào { $date }.
free-trial-content-charge-info-no-tax-year = Bạn sẽ bị tính phí { $amount } mỗi năm sau khi thời gian dùng thử miễn phí kết thúc vào { $date }.
free-trial-content-charge-info-no-tax-default = Bạn sẽ bị tính phí { $amount } sau khi thời gian dùng thử miễn phí kết thúc vào { $date }.
free-trial-content-trial-ends = Thời gian dùng thử miễn phí của bạn kết thúc vào ngày { $date }. Vui lòng cập nhật phương thức thanh toán để tiếp tục truy cập sau khi thời gian dùng thử kết thúc.
free-trial-content-trial-active = Dùng thử miễn phí của bạn đang hoạt động.
free-trial-content-action-error = Đã xảy ra lỗi không mong muốn. Vui lòng thử lại.
free-trial-content-button-resume-trial = Tiếp tục dùng thử
...
free-trial-content-last-bill = Hoá đơn gần đây nhất • { $billedOnDate }
free-trial-content-last-bill-with-tax = { $invoiceTotal } + { $taxDue } thuế
...
plan-details-product-prorated-price = Giá theo tỷ lệ cho { $productName }
