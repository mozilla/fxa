...
# Variables
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
freeTrialEndingReminder-subject = Ваша бесплатна пробна верзија за { $productName } ускоро истиче
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
freeTrialEndingReminder-content-greeting = Поштовани { $productName } корисниче,
# Variables:
#   $serviceLastActiveDateOnly (String) - The date the free trial ends, e.g. January 20, 2016
freeTrialEndingReminder-content-trial-ending = Ваш бесплатни пробни период треба да се заврши <strong>{ $serviceLastActiveDateOnly }</strong>.
freeTrialEndingReminder-content-trial-ending-plaintext = Ваш бесплатни пробни период би требало да се заврши { $serviceLastActiveDateOnly }.
# Variables:
#   $invoiceTotal (String) - The total amount that will be charged, e.g. $9.99
#   $serviceLastActiveDateOnly (String) - The date the charge will occur, e.g. January 20, 2016
freeTrialEndingReminder-content-auto-charge = Осим ако не откажете до тада, ваша претплата ће аутоматски почети и наплатићемо <strong>{ $invoiceTotal }</strong> преко начина плаћања на вашем налогу дана <strong>{ $serviceLastActiveDateOnly }</strong>.
freeTrialEndingReminder-content-auto-charge-plaintext = Осим ако не откажете до тада, ваша претплата ће аутоматски почети и наплатићемо { $invoiceTotal } преко начина плаћања на вашем налогу дана { $serviceLastActiveDateOnly }.
freeTrialEndingReminder-content-charge-heading = Детаљи наплате
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
...
freeTrialEndingReminder-content-cancel-link = Да бисте избегли наплату, откажите пре <strong>{ $serviceLastActiveDateOnly }</strong>: <a data-l10n-name="freeTrialEndingReminder-cancel-subscription">Откажи претплату</a>
freeTrialEndingReminder-content-cancel-link-plaintext = Да бисте избегли наплату, откажите пре { $serviceLastActiveDateOnly }:
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
freeTrialEndingReminder-content-thanks = Хвала вам што сте испробали { $productName }. Ако имате било каквих питања о пробном периоду или претплати, <a data-l10n-name="freeTrialEndingReminder-contact-support">контактирајте нас</a>.
freeTrialEndingReminder-content-thanks-plaintext = Хвала вам што сте испробали { $productName }. Ако имате било каквих питања о пробном периоду или претплати, контактирајте нас.
freeTrialEndingReminder-content-closing = Срдачно,
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
freeTrialEndingReminder-content-signature = { $productName } тим
# Variables:
#  $subscriptionSupportUrlWithUtm (String) - URL to the subscription products support page
freeTrialEndingReminder-content-support-plaintext = Контактирајте нас: { $subscriptionSupportUrlWithUtm }
#  Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
