...
button-passkey-signin = Iniciar sesión con clave de acceso
button-passkey-signin-loading = Iniciar sesión de forma segura…
...
promo-qr-mobile-description = Escanear para obtener la aplicación
promo-qr-mobile-qr-alt =
    .alt = Código QR para descargar la aplicación móvil { -brand-firefox }. Posicioná la cámara de tu teléfono en la esquina inferior derecha de la pantalla para escanearla.
...
page-passkey-add-creating-heading = Creando clave de acceso…
page-passkey-add-follow-prompts = Seguí las indicaciones en tu dispositivo.
...
product-promo-vpn-description = Descubrí una capa adicional de navegación y protección anónimas.
product-promo-vpn-cta = Conseguí { -product-mozilla-vpn-short }
...
terms-privacy-agreement-intro-3 = Al continuar, aceptás lo siguiente:
terms-privacy-agreement-customized-terms = { $serviceName }: <termsLink>Términos del servicio</termsLink> y <privacyLink>nota de privacidad</privacyLink>
terms-privacy-agreement-mozilla-2 = { -product-mozilla-accounts(capitalization: "uppercase") }: Términos de servicio <mozillaAccountsTos></mozillaAccountsTos> y nota de privacidad <mozillaAccountsPrivacy></mozillaAccountsPrivacy>
...
pair-choice-subheader = Sincronizá tu experiencia de { -brand-firefox }
pair-choice-description = Mirá tus contraseñas guardadas, pestañas, historial de navegación y más en todos tus dispositivos.
pair-choice-header-send-tab = Descargá o abrí { -brand-firefox } en el dispositivo al que querés enviar las pestañas
pair-choice-legend = Seleccioná una opción para continuar:
...
pair-signed-in-successfully = ¡Inicio de sesión exitoso!
...
pair-download-subheader = Descargar { -brand-firefox } para dispositivos móviles
...
pair-unsupported-desktop-firefox-fallback-header-v2 = Algo salió mal.
...
set-password-passwordless-info = Esta contraseña cifra tus datos sincronizados y los mantiene seguros.
...
signin-recovery-error = Algo salió mal. Iniciá sesión de nuevo.
...
signin-passwordless-code-input-label-v2 = Ingresá el código de 6 dígitos
signin-passwordless-code-confirm-button = Confirmar
signin-passwordless-code-required-error = Código de confirmación requerido
...
signin-passwordless-code-resend-error = Algo salió mal. No se pudo enviar un nuevo código.
signin-passwordless-code-other-account-link = Usar una cuenta diferente


signup-passwordless-code-subheading = Registrarse solo toma un paso cuando usás este código.
