...
describe('DangerZone Component', () => {
  describe('Delete Recovery Phone', () => {
    ...
    it('shows confirmation dialog when delete recovery phone button is clicked', () => {
      mockConfirm.mockReturnValue(false);

      renderDangerZone();

      fireEvent.click(screen.getByTestId('delete-recovery-phone'));
    ...
    it('handles successful deleteRecoveryPhone mutation', async () => {
      mockConfirm.mockReturnValue(true);

      const mocks = [
        DeleteRecoveryPhone.mock('test-uid-123', true),
        RecordAdminSecurityEvent.mock(
          'test-uid-123',
          'account.recovery_phone_deleted'
        ),
