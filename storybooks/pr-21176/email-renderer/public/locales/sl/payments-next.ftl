...
diners-logo-alt-text2 = Logotip { -brand-diners }
...
next-charge-with-discount-no-tax-card = Dne { $currentPeriodEnd } boste pri naslednjem plačilu { $nextInvoiceTotal } s kartico, ki se konča na { $last4 }, prihranili { $discountPercent }%.
next-charge-with-discount-no-tax-payment-method = Dne { $currentPeriodEnd } boste pri naslednjem plačilu { $nextInvoiceTotal } s plačilnim sredstvom { $paymentMethod } prihranili { $discountPercent }%.
