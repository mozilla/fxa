...
freeTrialEndingReminder-content-trial-ending = Konec vaší bezplatné zkušební verze je naplánován na <strong>{ $serviceLastActiveDateOnly }</strong>.
freeTrialEndingReminder-content-trial-ending-plaintext = Vaše bezplatná zkušební verze končí { $serviceLastActiveDateOnly }.
# Variables:
...
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
freeTrialEndingReminder-content-signature = Tým produktu { $productName }
# Variables:
...
# Variables
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionCancellation-freeTrial-subject = Vaše bezplatná zkušební verze produktu { $productName } byla zrušena
# Variables
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
#   $trialEndDateOnly (String) - The date when the free trial ends, e.g. 01/20/2016
subscriptionCancellation-freeTrial-content = Vaše bezplatná zkušební verze produktu { $productName } byla zrušena. Váš přístup skončí dne { $trialEndDateOnly }. Nebude vám účtována žádná částka.
# Variables:
# $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
...
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-free-trial-subject = Vaše bezplatná zkušební verze produktu { $productName } byla znovu aktivována
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-title = Děkujeme, že jste si znovu aktivovali předplatné produktu { $productName }!
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-free-trial-title = Děkujeme za opětovnou aktivaci vaší bezplatné zkušební verze produktu { $productName }!
# Variables:
#  $invoiceTotal (String) - The amount of the subscription invoice, including currency, e.g. $10.00
...
subscriptionRenewalReminder-content-charge-with-tax-day = V tu chvíli vám { -brand-mozilla } obnoví denní předplatné a bude vám účtována platba ve výši { $invoiceTotalExcludingTax } + daň { $invoiceTax }.
subscriptionRenewalReminder-content-charge-with-tax-week = V tu chvíli vám { -brand-mozilla } obnoví týdenní předplatné a bude účtována platba ve výši { $invoiceTotalExcludingTax } + daň { $invoiceTax }.
subscriptionRenewalReminder-content-charge-with-tax-month = V tu chvíli vám { -brand-mozilla } obnoví měsíční předplatné a bude účtována platba ve výši { $invoiceTotalExcludingTax } + daň { $invoiceTax }.
subscriptionRenewalReminder-content-charge-with-tax-halfyear = V té době vám { -brand-mozilla } obnoví šestiměsíční předplatné a bude účtována platba ve výši { $invoiceTotalExcludingTax } + daň { $invoiceTax }.
subscriptionRenewalReminder-content-charge-with-tax-year = V tu chvíli { -brand-mozilla } obnoví vaše roční předplatné a bude účtována platba ve výši { $invoiceTotalExcludingTax } + daň { $invoiceTax }.
subscriptionRenewalReminder-content-charge-with-tax-default = V tu chvíli vám { -brand-mozilla } předplatné obnoví a bude vám účtována platba ve výši { $invoiceTotalExcludingTax } + daň { $invoiceTax }.
# Variables
#   $invoiceTotal (String) - The amount of the subscription invoice, including currency, e.g. $10.00
