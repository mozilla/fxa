...
postAddPasskey-requested-from = Solicitou isto a partir de:
...
postRemovePasskey-subject = Chave-passe apagada
postRemovePasskey-preview = Foi removida uma chave-passe da sua conta
postRemovePasskey-title = Apagou a sua chave-passe
postRemovePasskey-description = Terá de utilizar outro método para iniciar sessão.
postRemovePasskey-requested-from = Solicitou isto a partir de:
