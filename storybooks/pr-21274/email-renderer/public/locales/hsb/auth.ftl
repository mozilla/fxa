...
# Variables
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
freeTrialEndingReminder-subject = Waša darmotna testowa wersija { $productName } so bórze skónči
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
...
freeTrialEndingReminder-content-trial-ending = Waš darmotny testowy čas so <strong>{ $serviceLastActiveDateOnly }</strong> skónči.
freeTrialEndingReminder-content-trial-ending-plaintext = Waš darmotny testowy čas so { $serviceLastActiveDateOnly } skónči.
# Variables:
#   $invoiceTotal (String) - The total amount that will be charged, e.g. $9.99
#   $serviceLastActiveDateOnly (String) - The date the charge will occur, e.g. January 20, 2016
freeTrialEndingReminder-content-auto-charge = Jeli do toho njewupowědźeće, so waš abonement awtomatisce započnje a wobćežamy <strong>{ $serviceLastActiveDateOnly }</strong> płaćensku metodu na wašim konće z <strong>{ $invoiceTotal }</strong>.
freeTrialEndingReminder-content-auto-charge-plaintext = Jeli do toho njewupowědźeće, so waš abonement awtomatisce započnje a wobćežamy { $serviceLastActiveDateOnly } płaćensku metodu na wašim konće z { $invoiceTotal }.
freeTrialEndingReminder-content-charge-heading = Płaćenske podrobnosće
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
...
freeTrialEndingReminder-content-thanks-plaintext = Dźakujemy so, zo sće wopytał { $productName } wupruwował. Jeli maće prašenja wo wašej testowej wersiji abo abonemenće, stajće so z nami prošu do zwiska.
freeTrialEndingReminder-content-closing = Z přećelnym postrowom,
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
freeTrialEndingReminder-content-signature = Team { $productName }
# Variables:
#  $subscriptionSupportUrlWithUtm (String) - URL to the subscription products support page
freeTrialEndingReminder-content-support-plaintext = Stajće so z nami do zwiska: { $subscriptionSupportUrlWithUtm }
#  Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
...
# Variables
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionCancellation-freeTrial-subject = Waš darmotny probowy abonement { $productName } je so wupowědźił
# Variables
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
#   $trialEndDateOnly (String) - The date when the free trial ends, e.g. 01/20/2016
subscriptionCancellation-freeTrial-content = Waš darmotny probowy abonement { $productName } je so wupowědźił. Waš přistup so { $trialEndDateOnly } skónči. Njetrjebaće ničo płaćić.
# Variables:
# $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
...
subscriptionEndingReminder-content-line2-v2 = Jeli rady chceće { $productName } dale wužiwać, móžeće swój abonement w <a data-l10n-name="subscriptionEndingReminder-subscription-management">zrjadowanju abonementow</a> do <strong>{ $serviceLastActiveDateOnly }</strong> podlěšić. Jeli pomoc trjebaće, <a data-l10n-name="subscriptionEndingReminder-contact-support">stajće so z našim teamom pomocy do zwiska</a>.
subscriptionEndingReminder-content-line1-plaintext = Waš přistup k { $productName } so dnja { $serviceLastActiveDateOnly } skónči.
subscriptionEndingReminder-content-line2-plaintext-v2 = Jeli rady chceće { $productName } dale wužiwać, móžeće swój abonement w zrjadowanju abonementow do { $serviceLastActiveDateOnly } podlěšić. Jeli pomoc trjebaće, stajće so z našim teamom pomocy do zwiska.
...
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-free-trial-subject = Waša darmotna testowa wersija { $productName } je so reaktiwizowała
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-title = Wulki dźak, zo sće zaso zaktiwizował swój abonement { $productName }!
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-free-trial-title = Wulki dźak, zo sće swoju darmotnu testowu wersiju { $productName } reaktiwizował!
# Variables:
#  $invoiceTotal (String) - The amount of the subscription invoice, including currency, e.g. $10.00
