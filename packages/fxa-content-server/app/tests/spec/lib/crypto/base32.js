...
describe('lib/crypto/base32', () => {
  ...
  describe('decode', () => {
    ...
    it('should decode base32 string', () => {
      return Base32.decode('0123456789ABCDEFGHJKMNPQRSTVWXYZ')
        .then((key) => {
          const hexKey = Buffer.from(key).toString('hex');
          assert.equal(hexKey, '00443214c74254b635cf84653a56d7c675be77df', 'correctly decoded base32 to hex');
        });
    });

    it('should decode base32 recovery key', () => {
      return RecoveryKey.generateRecoveryKey(32)
        .then((string) => {
