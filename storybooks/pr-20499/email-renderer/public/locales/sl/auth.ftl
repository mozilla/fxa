...
freeTrialEndingReminder-content-charge-discount-2 = Popust
# Variables:
#   $invoiceTaxAmount (String) - The tax amount, e.g. $1.20
freeTrialEndingReminder-content-charge-tax = Davek: { $invoiceTaxAmount }
freeTrialEndingReminder-content-charge-tax-2 = Davek
# Variables:
#   $serviceLastActiveDateOnly (String) - The date the charge will occur, e.g. January 20, 2016
#   $invoiceTotal (String) - The total amount due, e.g. $9.99
freeTrialEndingReminder-content-charge-total = Skupaj zapadlosti { $serviceLastActiveDateOnly }: { $invoiceTotal }
freeTrialEndingReminder-content-charge-total-2 = Skupaj zapadlosti { $serviceLastActiveDateOnly }
freeTrialEndingReminder-content-account-link = Način plačila in podatke o računu si lahko ogledate ali posodobite <a data-l10n-name="freeTrialEndingReminder-update-billing">tukaj</a>.
freeTrialEndingReminder-content-account-link-plaintext = Svoj način plačila in podatke o računu lahko pregledate ali posodobite tukaj:
# Variables:
#   $serviceLastActiveDateOnly (String) - The date the trial ends, e.g. January 20, 2016
freeTrialEndingReminder-content-cancel-link = Da se izognete plačilu, prekličite do <strong>{ $serviceLastActiveDateOnly }</strong>: <a data-l10n-name="freeTrialEndingReminder-cancel-subscription">prekličite naročnino</a>
freeTrialEndingReminder-content-cancel-link-plaintext = Da se izognete plačilu, prekličite pred { $serviceLastActiveDateOnly }:
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
freeTrialEndingReminder-content-thanks = Hvala, ker ste preskusili { $productName }. Če imate kakršnakoli vprašanja glede preskusa ali naročnine, <a data-l10n-name="freeTrialEndingReminder-contact-support">nam pišite</a>.
freeTrialEndingReminder-content-thanks-plaintext = Hvala, ker ste preskusili { $productName }. Če imate kakršnakoli vprašanja glede preskusne različice ali naročnine, se obrnite na nas.
...
subscriptionEndingReminder-content-line2-v2 = Če želite še naprej uporabljati { $productName }, lahko ostanite prijavljeni v <a data-l10n-name="subscriptionEndingReminder-subscription-management">Upravljanje naročnin</a> pred <strong>{ $serviceLastActiveDateOnly }</strong> . Če potrebujete pomoč, <a data-l10n-name="subscriptionEndingReminder-contact-support">se obrnite na našo skupino za podporo</a>.
subscriptionEndingReminder-content-line1-plaintext = Vaš dostop do { $productName } se bo končal { $serviceLastActiveDateOnly }.
subscriptionEndingReminder-content-line2-plaintext-v2 = Če želite še naprej uporabljati { $productName }, lahko ostanete naročeni v Upravljanju naročnin pred { $serviceLastActiveDateOnly }. Če potrebujete pomoč, se obrnite na našo skupino za podporo.
...
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-freeTrial-subject = Vaše preskusno obdobje { $productName } je ponovno aktivirano
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-title = Hvala, ker ste ponovno aktivirali svojo naročnino na { $productName }!
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-freeTrial-title = Hvala, ker ste ponovno aktivirali preskusno različico { $productName }!
# Variables:
#  $invoiceTotal (String) - The amount of the subscription invoice, including currency, e.g. $10.00
