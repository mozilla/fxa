...
churn-cancel-flow-error-offer-expired-message = Det er akkurat no ingen rabattar tilgjengeleg for dette abonnementet. Du kan halde fram med oppseiinga om du ønskjer det.
...
subscription-management-error-google-pay = Det er eit problem med { -brand-google-pay }-kontoen din. Løys problemet for å oppretthalde dei aktive abonnementa dine.
subscription-management-error-link = Det er eit problem med { -brand-link }-kontoen din. Løys problemet for å oppretthalde dei aktive abonnementa dine.
...
subscription-management-error-payment-method = Det er eit problem med betalingsmåten din. Løys problemet for å oppretthalde dei aktive abonnementa dine.
...
checkbox-payment-required-no-charge = Ein betalingsmåte trengst for å starte prøveperioden. Du vil ikkje bli belasta før { $endDate }.
checkbox-confirm-free-trial-with-legal-links = Eg gir { -brand-mozilla } løyve til å belaste betalingsmåten min med beløpet som blir vist etter at prøveperioden blir avslutta { $endDate }, i samsvar med <termsOfServiceLink>bruksvilkår</termsOfServiceLink> og <privacyNoticeLink>personvernfråsegn</privacyNoticeLink>, fram til eg avsluttar abonnementet.
...
churn-cancel-flow-after = Etter det vil abonnementet ditt automatisk fornyast til standardprisen, med mindre du seier opp.
churn-cancel-flow-cancel-success-title = Det er trist å sjå at du forlèt oss.
# $productName (String) - The name of the product to create subscription, e.g. Mozilla VPN
# $date (Date) - Last day of product access
churn-cancel-flow-cancel-success-dialog-msg = { $productName }-abonnementet ditt er avslutta. Du vil framleis ha tilgang til { $productName } fram til { $date }.
churn-cancel-flow-cancel-turn-back-on = Du kan slå abonnementet ditt på igjen når som helst før det går ut.
churn-cancel-flow-cancel-success-dialog-aside = Har du spørsmål? Besøk <LinkExternal>{ -brand-mozilla }-brukarstøtte</LinkExternal>.
...
# The sentence before this informs the customer that they will save a discount on their next bill (e.g. You will save 10% on your next charge of $12 to your PayPal payment method on March 6, 2026.)
churn-stay-subscribed-after = Etter det vil abonnementet ditt automatisk fornyast til standardprisen, med mindre du seier opp.
...
# $productName (String) - The name of the product to create subscription, e.g. Mozilla VPN
# $date (Date) - Last day of product access
interstitial-offer-cancel-success-dialog-msg = { $productName }-abonnementet ditt er avslutta. Du vil framleis ha tilgang til { $productName } fram til { $date }.
interstitial-offer-turn-back-on = Du kan slå abonnementet ditt på igjen når som helst før det går ut.
...
stay-subscribed-next-charge-with-tax = Den neste belastninga di blir { $nextInvoiceTotal } + { $taxDue } moms den { $currentPeriodEnd }.
stay-subscribed-next-charge-no-tax = Den neste belastninga di blir { $nextInvoiceTotal } den { $currentPeriodEnd }.
...
subscription-content-link-churn-intervention-terms-apply = Vilkår gjeld
subscription-content-link-churn-intervention-terms-aria = Sjå kupongvilkår og restriksjonar
...
upgrade-purchase-details-credit-to-account = Kreditt ferda ut til konto
upgrade-purchase-details-credit-will-be-applied = Kreditten vil bli lagd til kontoen din og brukt til framtidige fakturaer.
...
stay-subscribed-error-expired = Dette tilbodet har gått ut.
stay-subscribed-error-discount-used = Rabattkoden er allereie brukt.
