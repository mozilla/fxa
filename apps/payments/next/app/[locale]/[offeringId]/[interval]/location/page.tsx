...
export default async function Location({
  ...
  return (
    <section
      className="bg-white rounded-b-lg shadow-sm shadow-grey-300 border-t-0 mb-6 pt-4 px-4 pb-14 rounded-t-lg text-grey-600 tablet:clip-shadow tablet:rounded-t-none desktop:px-12 desktop:pb-12"
    ...
    >
      ...
      <p className="mt-1 leading-6 text-sm">
        {l10n.getString(
          'location-subheader',
