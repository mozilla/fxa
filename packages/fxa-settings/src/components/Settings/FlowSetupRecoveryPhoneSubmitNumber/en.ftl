...
# "instead" of backup recovery phone
# takes the user to either view or add backup authentication codes
flow-setup-phone-submit-number-info-message-link  = Use backup authentication codes instead
