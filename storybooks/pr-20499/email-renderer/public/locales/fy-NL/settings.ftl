...
button-passkey-signin = Oanmelde mei passkey
...
button-passkey-signin-loading = Feilich oanmelde…
...
dark-mode-toggle-light = Ljocht
dark-mode-toggle-dark = Donker
dark-mode-toggle-system = Systeem
dark-mode-toggle-label = Tema wikselje
...
signin-recovery-error = Der is wat misgien. Meld jo opnij oan.
