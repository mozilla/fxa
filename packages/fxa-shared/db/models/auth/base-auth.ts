...
export enum Proc {
  ...
  DeleteAccount = 'deleteAccount_24',
  ...
  ReplaceTotpToken = 'replaceTotpToken_1',
  ResetAccount = 'resetAccount_20',
  ResetAccountTokens = 'resetAccountTokens_1',
  RevokeAccountTokens = 'revokeAccountTokens_1',
  SessionWithDevice = 'sessionWithDevice_20',
