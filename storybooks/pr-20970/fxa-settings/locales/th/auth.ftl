...
# Variables
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
freeTrialEndingReminder-subject = ช่วงทดลองใช้งานฟรีของคุณกับ { $productName } จะสิ้นสุดลงในไม่ช้า
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
freeTrialEndingReminder-content-greeting = เรียน ลูกค้า { $productName }
# Variables:
#   $serviceLastActiveDateOnly (String) - The date the free trial ends, e.g. January 20, 2016
freeTrialEndingReminder-content-trial-ending = ช่วงทดลองใช้งานฟรีของคุณจะถึงกำหนดสิ้นสุดในวันที่ <strong>{ $serviceLastActiveDateOnly }</strong>
freeTrialEndingReminder-content-trial-ending-plaintext = ช่วงทดลองใช้งานฟรีของคุณจะถึงกำหนดสิ้นสุดในวันที่ { $serviceLastActiveDateOnly }
# Variables:
#   $invoiceTotal (String) - The total amount that will be charged, e.g. $9.99
#   $serviceLastActiveDateOnly (String) - The date the charge will occur, e.g. January 20, 2016
freeTrialEndingReminder-content-auto-charge = หากคุณไม่ยกเลิกสมาชิกก่อนหน้านั้น การสมัครสมาชิกของคุณจะเริ่มต้นโดยอัตโนมัติ และเราจะเรียกเก็บเงินจำนวน <strong>{ $invoiceTotal }</strong> จากวิธีการชำระเงินในบัญชีของคุณในวันที่ <strong>{ $serviceLastActiveDateOnly }</strong>
freeTrialEndingReminder-content-auto-charge-plaintext = หากคุณไม่ยกเลิกสมาชิกก่อนหน้านั้น การสมัครสมาชิกของคุณจะเริ่มต้นโดยอัตโนมัติ และเราจะเรียกเก็บเงินจำนวน { $invoiceTotal } จากวิธีการชำระเงินในบัญชีของคุณในวันที่ { $serviceLastActiveDateOnly }
freeTrialEndingReminder-content-charge-heading = รายละเอียดค่าใช้จ่าย
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
#   $invoiceSubtotal (String) - The subtotal amount of the subscription, e.g. $12.99
freeTrialEndingReminder-content-charge-subscription = ค่าสมัครสมาชิก { $productName }: { $invoiceSubtotal }
freeTrialEndingReminder-content-charge-subscription-2 = ค่าสมัครสมาชิก { $productName }
# Variables:
#   $invoiceDiscountAmount (String) - The discount amount, as a negative number, e.g. -$3.00
freeTrialEndingReminder-content-charge-discount = ส่วนลด: { $invoiceDiscountAmount }
freeTrialEndingReminder-content-charge-discount-2 = ส่วนลด
# Variables:
#   $invoiceTaxAmount (String) - The tax amount, e.g. $1.20
freeTrialEndingReminder-content-charge-tax = ภาษี: { $invoiceTaxAmount }
freeTrialEndingReminder-content-charge-tax-2 = ภาษี
# Variables:
#   $serviceLastActiveDateOnly (String) - The date the charge will occur, e.g. January 20, 2016
#   $invoiceTotal (String) - The total amount due, e.g. $9.99
freeTrialEndingReminder-content-charge-total = ยอดรวมที่ต้องชำระในวันที่ { $serviceLastActiveDateOnly }: { $invoiceTotal }
freeTrialEndingReminder-content-charge-total-2 = ยอดรวมที่ต้องชำระในวันที่ { $serviceLastActiveDateOnly }
freeTrialEndingReminder-content-account-link = คุณสามารถตรวจสอบหรืออัปเดตวิธีการชำระเงินและข้อมูลบัญชีของคุณได้<a data-l10n-name="freeTrialEndingReminder-update-billing">ที่นี่</a>
freeTrialEndingReminder-content-account-link-plaintext = คุณสามารถตรวจสอบหรืออัปเดตวิธีการชำระเงินและข้อมูลบัญชีของคุณได้ที่นี่:
# Variables:
#   $serviceLastActiveDateOnly (String) - The date the trial ends, e.g. January 20, 2016
freeTrialEndingReminder-content-cancel-link = เพื่อหลักเลี่ยงการถูกเรียกเก็บเงิน โปรดยกเลิกสมาชิกก่อนวันที่ <strong>{ $serviceLastActiveDateOnly }</strong>: <a data-l10n-name="freeTrialEndingReminder-cancel-subscription">ยกเลิกสมาชิก</a>
freeTrialEndingReminder-content-cancel-link-plaintext = เพื่อหลักเลี่ยงการถูกเรียกเก็บเงิน โปรดยกเลิกสมาชิกก่อนวันที่ { $serviceLastActiveDateOnly }:
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
freeTrialEndingReminder-content-thanks = ขอบคุณที่ทดลองใช้ { $productName } หากคุณมีคำถามเพิ่มเติมเกี่ยวกับช่วงทดลองใช้งานหรือการสมัครสมาชิก กรุณา<a data-l10n-name="freeTrialEndingReminder-contact-support">ติดต่อเรา</a>
freeTrialEndingReminder-content-thanks-plaintext = ขอบคุณที่ทดลองใช้ { $productName } หากคุณมีคำถามเพิ่มเติมเกี่ยวกับช่วงทดลองใช้งานหรือการสมัครสมาชิก กรุณาติดต่อเรา
freeTrialEndingReminder-content-closing = ขอแสดงความนับถือ
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
freeTrialEndingReminder-content-signature = ทีมงาน { $productName }
# Variables:
#  $subscriptionSupportUrlWithUtm (String) - URL to the subscription products support page
freeTrialEndingReminder-content-support-plaintext = ติดต่อเรา: { $subscriptionSupportUrlWithUtm }
#  Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
...
# Variables
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionCancellation-freeTrial-subject = การทดลองใช้ { $productName } ฟรีของคุณถูกยกเลิกแล้ว
# Variables
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
#   $trialEndDateOnly (String) - The date when the free trial ends, e.g. 01/20/2016
subscriptionCancellation-freeTrial-content = การทดลองใช้ { $productName } ฟรีของคุณถูกยกเลิกแล้ว สิทธิ์การเข้าถึงจะสิ้นสุดลงในวันที่ { $trialEndDateOnly } และคุณจะไม่ถูกเรียกเก็บเงิน
# Variables:
# $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
...
subscriptionEndingReminder-content-line2-v2 = ถ้าคุณต้องการใช้ { $productName } ต่อไป คุณสามารถคงสถานะการสมัครสมาชิกได้ใน <a data-l10n-name="subscriptionEndingReminder-subscription-management">การจัดการการสมัครสมาชิก</a> ก่อนวันที่ <strong>{ $serviceLastActiveDateOnly }</strong> ถ้าคุณต้องการความช่วยเหลือ ให้<a data-l10n-name="subscriptionEndingReminder-contact-support">ติดต่อทีมสนับสนุนของเรา</a>
...
subscriptionEndingReminder-content-line2-plaintext-v2 = ถ้าคุณต้องการใช้ { $productName } ต่อไป คุณสามารถคงสถานะการสมัครสมาชิกได้ใน การจัดการการสมัครสมาชิก ก่อนวันที่ { $serviceLastActiveDateOnly } ถ้าคุณต้องการความช่วยเหลือ ให้ติดต่อทีมสนับสนุนของเรา
...
subscriptionRenewalReminder-content-charge-with-tax-day = ในเวลานั้น { -brand-mozilla } จะต่ออายุการสมัครสมาชิกรายวันของคุณ และจะมีการเรียกเก็บเงินจำนวน { $invoiceTotalExcludingTax } + ภาษี { $invoiceTax } จากวิธีการชำระเงินในบัญชีของคุณ
subscriptionRenewalReminder-content-charge-with-tax-week = ในเวลานั้น { -brand-mozilla } จะต่ออายุการสมัครสมาชิกรายสัปดาห์ของคุณ และจะมีการเรียกเก็บเงินจำนวน { $invoiceTotalExcludingTax } + ภาษี { $invoiceTax } จากวิธีการชำระเงินในบัญชีของคุณ
subscriptionRenewalReminder-content-charge-with-tax-month = ในเวลานั้น { -brand-mozilla } จะต่ออายุการสมัครสมาชิกรายเดือนของคุณ และจะมีการเรียกเก็บเงินจำนวน { $invoiceTotalExcludingTax } + ภาษี { $invoiceTax } จากวิธีการชำระเงินในบัญชีของคุณ
subscriptionRenewalReminder-content-charge-with-tax-halfyear = ในเวลานั้น { -brand-mozilla } จะต่ออายุการสมัครสมาชิกหกเดือนของคุณ และจะมีการเรียกเก็บเงินจำนวน { $invoiceTotalExcludingTax } + ภาษี { $invoiceTax } จากวิธีการชำระเงินในบัญชีของคุณ
subscriptionRenewalReminder-content-charge-with-tax-year = ในเวลานั้น { -brand-mozilla } จะต่ออายุการสมัครสมาชิกรายปีของคุณ และจะมีการเรียกเก็บเงินจำนวน { $invoiceTotalExcludingTax } + ภาษี { $invoiceTax } จากวิธีการชำระเงินในบัญชีของคุณ
subscriptionRenewalReminder-content-charge-with-tax-default = ในเวลานั้น { -brand-mozilla } จะต่ออายุการสมัครสมาชิกของคุณ และจะมีการเรียกเก็บเงินจำนวน { $invoiceTotalExcludingTax } + ภาษี { $invoiceTax } จากวิธีการชำระเงินในบัญชีของคุณ
# Variables
#   $invoiceTotal (String) - The amount of the subscription invoice, including currency, e.g. $10.00
subscriptionRenewalReminder-content-charge-invoice-total-day = ในเวลานั้น { -brand-mozilla } จะต่ออายุการสมัครสมาชิกรายวันของคุณ และจะมีการเรียกเก็บเงินจำนวน { $invoiceTotal } จากวิธีการชำระเงินในบัญชีของคุณ
subscriptionRenewalReminder-content-charge-invoice-total-week = ในเวลานั้น { -brand-mozilla } จะต่ออายุการสมัครสมาชิกรายสัปดาห์ของคุณ และจะมีการเรียกเก็บเงินจำนวน { $invoiceTotal } จากวิธีการชำระเงินในบัญชีของคุณ
subscriptionRenewalReminder-content-charge-invoice-total-month = ในเวลานั้น { -brand-mozilla } จะต่ออายุการสมัครสมาชิกรายเดือนของคุณ และจะมีการเรียกเก็บเงินจำนวน { $invoiceTotal } จากวิธีการชำระเงินในบัญชีของคุณ
subscriptionRenewalReminder-content-charge-invoice-total-halfyear = ในเวลานั้น { -brand-mozilla } จะต่ออายุการสมัครสมาชิกหกเดือนของคุณ และจะมีการเรียกเก็บเงินจำนวน { $invoiceTotal } จากวิธีการชำระเงินในบัญชีของคุณ
subscriptionRenewalReminder-content-charge-invoice-total-year = ในเวลานั้น { -brand-mozilla } จะต่ออายุการสมัครสมาชิกรายปีของคุณ และจะมีการเรียกเก็บเงินจำนวน { $invoiceTotal } จากวิธีการชำระเงินในบัญชีของคุณ
subscriptionRenewalReminder-content-charge-invoice-total-default = ในเวลานั้น { -brand-mozilla } จะต่ออายุการสมัครสมาชิกของคุณ และจะมีการเรียกเก็บเงินจำนวน { $invoiceTotal } จากวิธีการชำระเงินในบัญชีของคุณ
