...
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
freeTrialEndingReminder-content-signature = A { $productName } csapat
# Variables:
#  $subscriptionSupportUrlWithUtm (String) - URL to the subscription products support page
freeTrialEndingReminder-content-support-plaintext = Kapcsolatfelvétel: { $subscriptionSupportUrlWithUtm }
#  Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
...
subscriptionEndingReminder-content-line2-v2 = Ha továbbra is szeretné használni a(z) { $productName } terméket, akkor <strong>{ $serviceLastActiveDateOnly }</strong> előtt előfizethet az <a data-l10n-name="subscriptionEndingReminder-subscription-management">Előfizetés-kezelésben</a> részben. Ha segítségre van szüksége, <a data-l10n-name="subscriptionEndingReminder-contact-support">lépjen kapcsolatba az ügyfélszolgálati csapatunkkal</a>.
...
subscriptionEndingReminder-content-line2-plaintext-v2 = Ha továbbra is szeretné használni a(z) { $productName } terméket, akkor { $serviceLastActiveDateOnly } előtt feliratkozhat az Előfizetés-kezelésben. Ha segítségre van szüksége, forduljon támogatási csapatunkhoz.
