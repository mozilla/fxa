...
import { LocalizerOpts, ILocalizerBindings, FtlIdMsg } from '../l10n';
...
export abstract class RendererBindings implements ILocalizerBindings {
  ...
  async renderTemplate(
    ...
    const html = this.mjml2html(mjml, layout);
   ...
   * @returns HTML
   */
  protected abstract mjml2html(mjml: string, layout: string): string;
