...
connect-another-play-store-image-2 =
    .alt = Сцягніце { -brand-firefox } з { -google-play }
connect-another-app-store-image-3 =
    .alt = Сцягніце { -brand-firefox } з { -app-store }
...
modal-mfa-protected-cancel-button = Скасаваць
...
settings-recovery-phone-remove-cancel = Скасаваць
...
passkey-delete-modal-cancel-button = Скасаваць
...
auth-error-1001 = Спроба ўваходу скасавана
...
pair-auth-allow-refuse-device-link = Калі гэта былі не вы, <a>змяніце пароль</a>
