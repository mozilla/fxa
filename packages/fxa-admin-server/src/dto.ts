...
export interface IQuery {
  ...
  ): Nullable<Account> | Promise<Nullable<Account>>;
  ...
  getRecoveryPhonesLike(
    search: string
  ): Nullable<RecoveryPhone[]> | Promise<Nullable<RecoveryPhone[]>>;
  getDeleteStatus(
    taskNames: string[]
  ): AccountDeleteTaskStatus[] | Promise<AccountDeleteTaskStatus[]>;
  rateLimits(
    ip?: Nullable<string>,
...
export interface IMutation {
  ...
  deleteAccounts(
    locators: string[]
  ): AccountDeleteResponse[] | Promise<AccountDeleteResponse[]>;
  resetAccounts(
    locators: string[],
    notificationEmail: string
  ): AccountResetResponse[] | Promise<AccountResetResponse[]>;
  ...
  ): RelyingPartyCreatedDto | Promise<RelyingPartyCreatedDto>;
  updateRelyingParty(
    id: string,
    relyingParty: RelyingPartyUpdateDto
  ): boolean | Promise<boolean>;
  ...
  rotateRelyingPartySecret(
    id: string
  ): RotateSecretDto | Promise<RotateSecretDto>;
