...
button-passkey-signin = Қол жеткізу кілтімен кіру
...
auth-error-224 = Қол жеткізу кілті табылмады
auth-error-225 = Қол жеткізу кілті тіркелген
auth-error-226 = Қол жеткізу кілті шегіне жетті
auth-error-227 = Қол жеткізу кілтінің аутентификациясы сәтсіз аяқталды
auth-error-228 = Қол жеткізу кілтін тіркеу сәтсіз аяқталды
auth-error-238 = Қол жеткізу кілтін тексеру сәтсіз аяқталды
...
passkey-registration-error-not-allowed = Қол жеткізу кілтін баптау сәтсіз аяқталды немесе қолжетімді емес. Қайталап көріңіз немесе басқа тәсілді қолданып көріңіз.
passkey-registration-error-timeout = Қол жеткізу кілтін баптаудан бас тартылды. Қайталап көріңіз.
passkey-registration-error-not-supported = Қол жеткізу кілттері осында қолжетімді емес. Басқа тәсілді немесе құрылғыны қолданып көріңіз.
passkey-registration-error-security = Бұл бетте қол жеткізу кілттерін баптау мүмкін емес. Қауіпсіз сайтты пайдаланып, қайталап көріңіз.
passkey-registration-error-invalid-state = Бұл қол жеткізу кілті тіркелген болып тұр. Оны жүйеге кіру үшін пайдаланыңыз немесе басқа қол жеткізу кілтін қосыңыз.
...
passkey-registration-error-constraint = Бұл құрылғыда қол жеткізу кілттерін баптау мүмкін емес. Басқа әдісті немесе құрылғыны қолданып көріңіз.
passkey-registration-error-unexpected = Қол жеткізу кілтін баптау сәтсіз аяқталды. Қайталап көріңіз немесе басқа тәсілді қолданып көріңіз.


passkey-authentication-error-not-allowed = Қол жеткізу кілтімен кіру сәтсіз аяқталды немесе қолжетімді емес. Қайталап көріңіз немесе басқа әдісті таңдаңыз.
passkey-authentication-error-timeout = Қол жеткізу кілті сұрауының уақыты аяқталды. Қайталап көріңіз.
passkey-authentication-error-not-supported = Қол жеткізу кілттеріне қолдау жоқ. Басқа тәсілді немесе құрылғыны қолданып көріңіз.
passkey-authentication-error-security = Бұл бетте қол жеткізу кілттерін пайдалану мүмкін емес. Дұрыс қауіпсіз сайтта екеніңізді тексеріп, қайталап көріңіз.
passkey-authentication-error-invalid-state = Қол жеткізу кілтіңізбен бірнәрсе дұрыс болмады. Қайталап көріңіз немесе басқа кіру әдісін пайдаланыңыз.
...
signin-passkey-fallback-body = Деректеріңіздің қауіпсіздігін қамтамасыз ету үшін, осы қол жеткізу кілтін пайдаланған кезде пароліңізді енгізуіңіз керек.
...
signin-passwordless-code-input-label = 8-цифрлық кодты енгізіңіз
