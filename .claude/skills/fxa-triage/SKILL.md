...
- **Classifies every open bot dependency PR** (Dependabot + `blender/security-bump-*`), approves the functional-test gate, and reports conflicts and real breaks for a human. It never merges, edits code, or pushes.
