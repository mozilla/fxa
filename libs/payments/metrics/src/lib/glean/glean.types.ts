...
export const PaymentsGleanClientProvider = Symbol(
...
export interface IPaymentsGleanClientManager {
  recordPageView(args: PageMetricsData): void;
  recordRetentionFlow(args: RetentionFlowEventMetricsData): void;
  recordInterstitialOffer(args: RetentionFlowEventMetricsData): void;
}
