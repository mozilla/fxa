...
freeTrialEndingReminder-content-trial-ending = Η δωρεάν δοκιμαστική περίοδος έχει προγραμματιστεί να λήξει στις <strong>{ $serviceLastActiveDateOnly }</strong>.
freeTrialEndingReminder-content-trial-ending-plaintext = Η δωρεάν δοκιμαστική περίοδος έχει προγραμματιστεί να λήξει στις { $serviceLastActiveDateOnly }.
# Variables:
#   $invoiceTotal (String) - The total amount that will be charged, e.g. $9.99
#   $serviceLastActiveDateOnly (String) - The date the charge will occur, e.g. January 20, 2016
freeTrialEndingReminder-content-auto-charge = Αν δεν κάνετε ακύρωση πριν από τότε, η συνδρομή σας θα ξεκινήσει αυτόματα και θα χρεώσουμε <strong>{ $invoiceTotal }</strong> στη μέθοδο πληρωμής του λογαριασμού σας στις <strong>{ $serviceLastActiveDateOnly }</strong>.
freeTrialEndingReminder-content-auto-charge-plaintext = Αν δεν κάνετε ακύρωση πριν από τότε, η συνδρομή σας θα ξεκινήσει αυτόματα και θα χρεώσουμε { $invoiceTotal } στη μέθοδο πληρωμής του λογαριασμού σας στις { $serviceLastActiveDateOnly }.
...
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
freeTrialEndingReminder-content-signature = Η ομάδα του { $productName }
# Variables:
#  $subscriptionSupportUrlWithUtm (String) - URL to the subscription products support page
freeTrialEndingReminder-content-support-plaintext = Επικοινωνία: { $subscriptionSupportUrlWithUtm }
#  Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
...
subscriptionCancellation-freeTrial-content = Η δωρεάν δοκιμαστική περίοδος του { $productName } έχει ακυρωθεί. Η πρόσβασή σας θα λήξει στις { $trialEndDateOnly }. Δεν θα χρεωθείτε.
# Variables:
# $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
...
subscriptionEndingReminder-content-line2-v2 = Εάν επιθυμείτε να συνεχίσετε να χρησιμοποιείτε το { $productName }, μπορείτε να διατηρήσετε τη συνδρομή σας στη <a data-l10n-name="subscriptionEndingReminder-subscription-management">Διαχείριση συνδρομών</a> πριν από τις <strong>{ $serviceLastActiveDateOnly }</strong>. Εάν χρειάζεστε βοήθεια, <a data-l10n-name="subscriptionEndingReminder-contact-support">επικοινωνήστε με την ομάδα υποστήριξης</a>.
...
subscriptionEndingReminder-content-line2-plaintext-v2 = Εάν επιθυμείτε να συνεχίσετε να χρησιμοποιείτε το { $productName }, μπορείτε να διατηρήσετε τη συνδρομή σας στη Διαχείριση συνδρομών πριν από τις { $serviceLastActiveDateOnly }. Εάν χρειάζεστε βοήθεια, επικοινωνήστε με την ομάδα υποστήριξης.
...
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-freeTrial-subject = Η δοκιμαστική περίοδος του { $productName } έχει ενεργοποιηθεί εκ νέου
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-title = Ευχαριστούμε για την εκ νέου ενεργοποίηση της συνδρομής σας στο { $productName }!
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-freeTrial-title = Ευχαριστούμε για την εκ νέου ενεργοποίηση της δοκιμαστικής περιόδου του { $productName }!
# Variables:
#  $invoiceTotal (String) - The amount of the subscription invoice, including currency, e.g. $10.00
...
subscriptionRenewalReminder-content-charge-with-tax-day = Τότε, η { -brand-mozilla } θα ανανεώσει την ημερήσια συνδρομή σας και η μέθοδος πληρωμής του λογαριασμού σας θα χρεωθεί { $invoiceTotalExcludingTax } (+ { $invoiceTax } φόρος).
subscriptionRenewalReminder-content-charge-with-tax-week = Τότε, η { -brand-mozilla } θα ανανεώσει την εβδομαδιαία συνδρομή σας και η μέθοδος πληρωμής του λογαριασμού σας θα χρεωθεί { $invoiceTotalExcludingTax } (+ { $invoiceTax } φόρος).
subscriptionRenewalReminder-content-charge-with-tax-month = Τότε, η { -brand-mozilla } θα ανανεώσει τη μηνιαία συνδρομή σας και η μέθοδος πληρωμής του λογαριασμού σας θα χρεωθεί { $invoiceTotalExcludingTax } (+ { $invoiceTax } φόρος).
subscriptionRenewalReminder-content-charge-with-tax-halfyear = Τότε, η { -brand-mozilla } θα ανανεώσει την εξαμηνιαία συνδρομή σας και η μέθοδος πληρωμής του λογαριασμού σας θα χρεωθεί { $invoiceTotalExcludingTax } (+ { $invoiceTax } φόρος).
subscriptionRenewalReminder-content-charge-with-tax-year = Τότε, η { -brand-mozilla } θα ανανεώσει την ετήσια συνδρομή σας και η μέθοδος πληρωμής του λογαριασμού σας θα χρεωθεί { $invoiceTotalExcludingTax } (+ { $invoiceTax } φόρος).
subscriptionRenewalReminder-content-charge-with-tax-default = Τότε, η { -brand-mozilla } θα ανανεώσει τη συνδρομή σας και η μέθοδος πληρωμής του λογαριασμού σας θα χρεωθεί { $invoiceTotalExcludingTax } (+ { $invoiceTax } φόρος).
# Variables
#   $invoiceTotal (String) - The amount of the subscription invoice, including currency, e.g. $10.00
subscriptionRenewalReminder-content-charge-invoice-total-day = Τότε, η { -brand-mozilla } θα ανανεώσει την ημερήσια συνδρομή σας και η μέθοδος πληρωμής του λογαριασμού σας θα χρεωθεί { $invoiceTotal }.
subscriptionRenewalReminder-content-charge-invoice-total-week = Τότε, η { -brand-mozilla } θα ανανεώσει την εβδομαδιαία συνδρομή σας και η μέθοδος πληρωμής του λογαριασμού σας θα χρεωθεί { $invoiceTotal }.
subscriptionRenewalReminder-content-charge-invoice-total-month = Τότε, η { -brand-mozilla } θα ανανεώσει τη μηνιαία συνδρομή σας και η μέθοδος πληρωμής του λογαριασμού σας θα χρεωθεί { $invoiceTotal }.
subscriptionRenewalReminder-content-charge-invoice-total-halfyear = Τότε, η { -brand-mozilla } θα ανανεώσει την εξαμηνιαία συνδρομή σας και η μέθοδος πληρωμής του λογαριασμού σας θα χρεωθεί { $invoiceTotal }.
subscriptionRenewalReminder-content-charge-invoice-total-year = Τότε, η { -brand-mozilla } θα ανανεώσει την ετήσια συνδρομή σας και η μέθοδος πληρωμής του λογαριασμού σας θα χρεωθεί { $invoiceTotal }.
subscriptionRenewalReminder-content-charge-invoice-total-default = Τότε, η { -brand-mozilla } θα ανανεώσει τη συνδρομή σας και η μέθοδος πληρωμής του λογαριασμού σας θα χρεωθεί { $invoiceTotal }.
