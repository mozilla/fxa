...
loyalty-discount-terms-contact-support-product-aria = Contacta assistentia pro { $productName }
not-found-page-title-terms = Pagina non trovate
not-found-page-description-terms = Le pagina que tu cerca non existe.
not-found-page-button-terms-manage-subscriptions = Gerer abonamentos
...
interstitial-offer-error-customer-mismatch-message = Assecura te de haber accedite con le conto correcte, o contacta assistentia si tu desira adjuta.
...
error-payment-method-expired-card = Tu carta ha expirate. Adde un nove carta o methodo de pagamento a evitar interruption a tu abonamentos.
error-payment-method-banner-title-invalid-payment-information = Informationes de pagamento non valide
error-payment-method-banner-message-account-issue = Il ha un problema con tu conto.
subscription-management-button-manage-payment-method-1 = Gerer methodo de pagamento
subscription-management-error-apple-pay = Il ha un problema con tu conto { -brand-apple-pay }. Resolve le problema pro mantener tu abonamentos active.
subscription-management-error-google-pay = Il ha un problema con tu conto { -brand-google-pay }. Resolve le problema pro mantener tu abonamentos active.
subscription-management-error-link = Il ha un problema con tu conto { -brand-link }. Resolve le problema pro mantener tu abonamentos active.
...
subscription-management-error-payment-method = Il ha un problema con tu methodo de pagamento. Resolve le problema pro mantener tu abonamentos active.
...
checkbox-payment-required-no-charge = Un methodo de pagamento es necesse pro initiar tu prova gratuite. Tu non sera cargate usque { $endDate }.
checkbox-confirm-free-trial-with-legal-links = Io autorisa { -brand-mozilla } a cargar mi methodo de pagamento pro le amonta monstrate post que le prova gratuite fini le { $endDate }, secundo le <termsOfServiceLink>Conditiones de uso del servicio</termsOfServiceLink> e <privacyNoticeLink>Aviso de confidentialitate</privacyNoticeLink>, usque io cancellara mi abonamento.
...
free-trial-content-last-bill = Ultime factura • { $billedOnDate }
free-trial-content-last-bill-with-tax = { $invoiceTotal } + taxa de { $taxDue }
...
churn-error-page-title-customer-mismatch = Le coupon non pote esser redimite
churn-error-page-message-customer-mismatch = Iste coupon era emittite pro un differente abonamento e pote solo esser redimite per le destinatario original.
