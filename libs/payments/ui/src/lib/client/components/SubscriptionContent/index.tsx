          ...
          {canResubscribe ? (
            ...
            <>
              <div className="leading-6">
                {currentInvoiceTax ? (
                  <Localized
                    id="subscription-content-current-invoice-with-tax"
                    vars={{
                  ...
                  <Localized
                    id="subscription-content-current-invoice-no-tax"
                    vars={{
                      billedOnDate: currentInvoiceDateLongFallback,
                      invoiceTotal:
                        getCurrencyFallbackText(currentInvoiceTotal),
                  ...
                  >
                    <p>
                      <b>{getCurrencyFallbackText(currentInvoiceTotal)}</b>{' '}
                      <span className="text-grey-600 text-sm">
                        billed on {currentInvoiceDateLongFallback}
                      </span>
                    </p>
                ...
                {creditApplied && creditApplied < 0 ? (
                  <Localized
                    id="subscription-content-credit-applied"
                    vars={{
                      creditApplied: getCurrencyFallbackText(
                        Math.abs(creditApplied)
                      ),
                    }}
                  >
                    <p className="text-green-900 text-sm">
                      <b>{getCurrencyFallbackText(Math.abs(creditApplied))}</b>{' '}
                      credit applied
                    </p>
                  </Localized>
                ) : null}
                ...
                {nextInvoiceTotal && (
                  <div className="text-sm">
                    {nextInvoiceTax ? (
                      <Localized
                        id="subscription-content-next-invoice-with-tax"
                        vars={{
                          invoiceTotal:
                      ...
                      >
                        <p>
                          ...
                          is due <b>{currentPeriodEndLongFallback}</b>
                        </p>
                      </Localized>
                    ) : (
                      <Localized
                        id="subscription-content-next-invoice-no-tax"
                        vars={{
                          invoiceTotal:
                            getCurrencyFallbackText(nextInvoiceTotal),
                          nextBillDate: currentPeriodEndLongFallback,
                      ...
                      >
                        <p>
                          Next bill of{' '}
                          <b>{getCurrencyFallbackText(nextInvoiceTotal)}</b> is
                          due <b>{currentPeriodEndLongFallback}</b>
                        </p>
                      </Localized>
                    )}
                  </div>
