...
recent-activity-account-passkey-wrap-deleted = Passkey-Sync-Zugriff entfernt
recent-activity-account-passkey-wrap-deletion-failure = Entfernung des Passkey-Sync-Zugriffs fehlgeschlagen
