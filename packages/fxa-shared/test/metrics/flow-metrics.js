...
const flowMetrics = require('../../metrics/flow-metrics');
const sinon = require('sinon');

var mockDateNow, mockRandomBytes, mockFlowIdKey, mockUserAgent;

describe('metrics/flow-metrics', () => {
  beforeEach(() => {
  ...
  it('should export create and validate', () => {
  ...
  describe('create', () => {
    ...
    it('should generate different flowIds for different keys', () => {
    ...
    it('should generate the same flowId for different user agents', () => {
    ...
    it('should generate different flowIds for different random salts', () => {
      mockRandomBytes = 'MozillaFirefox!!';
    ...
    it('should generate different flowIds for different timestamps', () => {
      ...
      assert.notEqual(flowEventData1.flowId, flowEventData2.flowId);
      assert.notEqual(
        flowEventData1.flowBeginTime,
        flowEventData2.flowBeginTime
      );
    });
  });

  describe('validate', () => {
    it('should return false for data with user-agent', () => {
    ...
    it('should return true for good data without user-agent', () => {
      // Force the mocks to return bad data to be sure it really works
      mockDateNow = 1478626838531;
      mockFlowIdKey = 'foo';
      mockUserAgent = 'bar';
    ...
    it('should return false for a bad flow id', () => {
    ...
    it('should return false for a bad key', () => {
      // Force the mocks to return good data to be sure it really works
      mockDateNow = 1451566800000;
      mockFlowIdKey = 'S3CR37';
      mockUserAgent = 'Firefox';
    ...
    it('should return false for a bad flow begin time', () => {
      // Force the mocks to return good data to be sure it really works
      mockDateNow = 1451566800000;
      mockFlowIdKey = 'S3CR37';
      mockUserAgent = 'Firefox';
