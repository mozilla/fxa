...
export type SyncSuccessProps = {
   ...
   * cannot leave its primary action inert — the WebChannel message itself
   * lands with the flow wiring.
   */
 ...
 * sync settings.
 *
 * Presentational only: routing, WebChannel messages, and the page-view/Glean
