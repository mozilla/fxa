...
import InlinePasswordFreeSetupContainer from './container';
...
const Harness = () => {
  ...
  return (
    <>
      ...
      <InlinePasswordFreeSetupContainer />
    </>
  );
};
...
const render = (
  ...
  renderWithLocalizationProvider(
    <Wrapper>
      <MemoryRouter initialEntries={['/inline_password_free_setup']}>
        <Harness />
      </MemoryRouter>
    </Wrapper>
  );
...
describe('InlinePasswordFreeSetupContainer', () => {
