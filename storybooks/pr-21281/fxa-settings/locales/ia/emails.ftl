...
postRemovePasskey-subject = Clave-contrasigno delite
postRemovePasskey-preview = Un clave-contrasigno era removite ab tu conto
postRemovePasskey-title = Tu deleva tu clave-contrasigno
postRemovePasskey-description = Tu debera usar un altere methodo pro acceder.
postRemovePasskey-requested-from = Tu lo ha requirite ab:
postRemovePasskey-action = Gerer le conto
