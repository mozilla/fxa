...
postRemovePasskey-subject = Clé d’accès supprimée
postRemovePasskey-preview = Une clé d’accès a été supprimée de votre compte
postRemovePasskey-title = Vous avez supprimé votre clé d’accès
postRemovePasskey-description = Vous devrez utiliser une autre méthode pour vous connecter.
postRemovePasskey-requested-from = La demande a été effectuée depuis :
postRemovePasskey-action = Gérer le compte
