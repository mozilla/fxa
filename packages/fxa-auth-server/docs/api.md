...
```json
{
  "loginSrpToken": "b223b00e-5a10-46a9-983c-1c346c0d1907",
  "stretch": {
    "rounds": 100000,
...
* loginSrpToken - the loginSrpToken received from `/session/auth/start`
...
-d '{
  "loginSrpToken": "4c352927-cd4f-4a4a-a03d-7d1893d950b8",
...
```json
{
  "changePasswordSrpToken": "b223b00e-5a10-46a9-983c-1c346c0d1907",
  "stretch": {
    "rounds": 100000,
    "salt": "9e1a5712b22ea7ec06eb74422be67040e030a9f041fe258d8ed633d027271704"
  },
...
* changePasswordSrpToken - the changePasswordSrpToken received from `/startLogin`
* A - the derived SRP "A" value
* M - the derived SRP "M" value
