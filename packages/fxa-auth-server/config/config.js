...
import url from 'url';
import convictFormatWithMoment from 'convict-format-with-moment';
import convictFormatWithValidator from 'convict-format-with-validator';
import DEFAULT_SUPPORTED_LANGUAGES from './supportedLanguages';
import { createRequire } from 'module';
import { makeConvictMySQLConfig as makeMySQLConfig } from '@fxa/shared/db/mysql/core';

// TODO: Not sure about this... How to validate?
const DEFAULT_GEODB_DB_DEFAULT = fs
  .readFileSync(__dirname + '/../../fxa-geodb/db/cities-db.mmdb')
  .toString('base64');
...
const convictConf = convict({
  ...
  geodb: {
    dbPath: {
      ...
      default: DEFAULT_GEODB_DB_DEFAULT,
      env: 'GEODB_DBPATH',
      format: String,
    },
    enabled: {
