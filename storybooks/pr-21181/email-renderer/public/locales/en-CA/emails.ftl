...
automated-email-sign-in =
    This is an automated email; if you did not authorize this action, then please <a data-l10n-name="securitySettingsLink">review your account security settings</a>.
    For more information, please visit <a data-l10n-name="supportLink">{ -brand-mozilla } Support</a>.
...
postAddPasskey-sync-note = Please note, your password will continue to be required to access your { -brand-firefox } sync data.
