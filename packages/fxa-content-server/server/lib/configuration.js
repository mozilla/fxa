...
const conf = (module.exports = convict({
  ...
  showReactApp: {
    simpleRoutes: {
      ...
      fullRollout: {
        default: false,
        doc: 'Override the experiment rollout rate and show React version of "simple" routes to all users',
        format: Boolean,
        env: 'REACT_CONVERSION_SIMPLE_ROUTES_FULL_ROLLOUT',
      },
    },
    resetPasswordRoutes: {
      enabled: {
      ...
      fullRollout: {
        default: false,
        doc: 'Override the experiment rollout rate and show React version of "reset password" routes to all users',
        format: Boolean,
        env: 'REACT_CONVERSION_RESET_PASSWORD_ROUTES_FULL_ROLLOUT',
      },
    },
    oauthRoutes: {
      enabled: {
      ...
      fullRollout: {
        default: false,
        doc: 'Override the experiment rollout rate and show React version of "oauth" routes to all users',
        format: Boolean,
        env: 'REACT_CONVERSION_OAUTH_ROUTES_FULL_ROLLOUT',
      },
    },
    signInRoutes: {
      enabled: {
      ...
      fullRollout: {
        default: false,
        doc: 'Override the experiment rollout rate and show React version of "signin" routes to all users',
        format: Boolean,
        env: 'REACT_CONVERSION_SIGNIN_ROUTES_FULL_ROLLOUT',
      },
    },
    signUpRoutes: {
      enabled: {
      ...
      fullRollout: {
        default: false,
        doc: 'Override the experiment rollout rate and show React version of "signup" routes to all users',
        format: Boolean,
        env: 'REACT_CONVERSION_SIGNUP_ROUTES_FULL_ROLLOUT',
      },
    },
    pairRoutes: {
      enabled: {
      ...
      fullRollout: {
        default: false,
        doc: 'Override the experiment rollout rate and show React version of "pair" routes to all users',
        format: Boolean,
        env: 'REACT_CONVERSION_PAIR_ROUTES_FULL_ROLLOUT',
      },
    },
    postVerifyOtherRoutes: {
      ...
      fullRollout: {
        default: false,
        doc: 'Override the experiment rollout rate and show React version of any other "post verify" routes to all users',
        format: Boolean,
        env: 'REACT_CONVERSION_POST_VERIFY_OTHER_ROUTES_FULL_ROLLOUT',
      },
    },
    postVerifyThirdPartyAuthRoutes: {
      enabled: {
        ...
        format: Boolean,
        env: 'REACT_CONVERSION_POST_VERIFY_THIRD_PARTY_AUTH_ROUTES',
      },
      fullRollout: {
        default: false,
        doc: 'Override the experiment rollout rate and show React version of third party auth "post verify" routes to all users',
        format: Boolean,
        env: 'REACT_CONVERSION_POST_VERIFYTHIRD_PARTY_AUTH_ROUTES_FULL_ROLLOUT',
      },
    },
    postVerifyCADViaQRRoutes: {
      ...
      fullRollout: {
        default: false,
        doc: 'Override the experiment rollout rate and show React version of "post verify CAD vi QR" routes to all users',
        format: Boolean,
        env: 'REACT_CONVERSION_POST_VERIFY_CAD_VIA_QR_ROUTES_FULL_ROLLOUT',
      },
    },
    webChannelExampleRoutes: {
      ...
      fullRollout: {
        default: false,
        doc: 'Override the experiment rollout rate and show React version of "web channel example" routes to all users',
        format: Boolean,
        env: 'REACT_CONVERSION_WEB_CHANNEL_EXAMPLE_ROUTES_FULL_ROLLOUT',
      },
    },
    inlineTotpRoutes: {
      enabled: {
      ...
      fullRollout: {
        default: false,
        doc: 'Override the experiment rollout rate and show React version of "inline totp setup" routes to all users',
        format: Boolean,
        env: 'REACT_CONVERSION_INLINE_TOTP_ROUTES_FULL_ROLLOUT',
      },
    },
  },
  brandMessagingMode: {
  ...
  rolloutRates: {
    ...
    generalizedReactApp: {
      default: 0,
      doc: 'The rollout rate for the generalized react app experiment. Valid values are from 0 to 1.0',
