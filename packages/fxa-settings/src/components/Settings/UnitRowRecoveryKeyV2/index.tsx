...
// Currently an exact copy of UnitRowRecoveryKey
// TODO: Modify in FXA-7240

export const UnitRowRecoveryKeyV2 = () => {
  ...
  return (
    ...
    >
      <Localized id="rk-content-explain">
        <p className="text-sm mt-3 bg-red-300">
...
export default UnitRowRecoveryKeyV2;
