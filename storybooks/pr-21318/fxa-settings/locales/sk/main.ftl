...
dark-mode-toggle-label = Prepnúť tému
...
delete-account-delete-button-passwordless = Odstrániť účet
...
page-passkey-add-creating-heading = Vytvára sa prístupový kľúč…
page-passkey-add-follow-prompts = Postupujte podľa pokynov na vašom zariadení.
page-passkey-add-cancel = Zrušiť
...
product-promo-vpn-description = Objavte ďalšiu vrstvu anonymného prehliadania a ochrany.
product-promo-vpn-cta = Získajte { -product-mozilla-vpn-short }
...
auth-error-224 = Prístupový kľúč sa nenašiel
auth-error-225 = Prístupový kľúč je už zaregistrovaný
...
pair-auth-complete-send-tab-heading = Ste pripravení odoslať niekoľko kariet
pair-auth-complete-send-tab-device-connected = { $deviceFamily } pre { $deviceOS } je pripojený.
pair-auth-complete-send-tab-benefits = Medzi zariadeniami si môžete posielať otvorené karty, heslá a záložky.
...
pair-failure-header-v2 = Párovanie zariadenia zlyhalo
pair-failure-message-v2 = Nastavenie nebolo možné dokončiť. Prihláste sa pomocou svojho e‑mailu.
pair-failure-try-again-link = Skúsiť znova


pair-sync-header = Synchronizujte { -brand-firefox } na svojom telefóne alebo tablete
pair-cad-header-v2 = Pripojiť ďalšie zariadenie
...
pair2-authority-sync-success-heading-v2 = Vaše zariadenie je pripojené
pair2-authority-sync-success-description-v2 = Synchronizácia prebieha. Môže chvíľu trvať, kým sa zobrazia synchronizované údaje. Zatiaľ môžete pokračovať v prehliadaní.
pair2-authority-sync-success-sync-settings-button-v2 = Spravovať nastavenia synchronizácie
...
set-password-passwordless-info = Toto heslo šifruje vaše synchronizované údaje a chráni ich.
...
signin-recovery-error = Vyskytla sa chyba. Prihláste sa znova.
...
signin-passkey-fallback-header = Dokončiť prihlásenie
...
signin-passwordless-code-input-label-v2 = Zadajte šesťmiestny kód
signin-passwordless-code-confirm-button = Potvrdiť
signin-passwordless-code-required-error = Vyžaduje sa potvrdzovací kód
signin-passwordless-code-expired = Platnosť kódu vypršala?
...
signin-passwordless-code-resend-link = Odoslať e‑mailom nový kód.
signin-passwordless-code-resend-error = Niečo sa pokazilo. Nový kód sa nepodarilo odoslať.
signin-passwordless-code-other-account-link = Použiť iný účet


signup-passwordless-code-subheading = Registrácia s týmto kódom má iba jeden krok.
