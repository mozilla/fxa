...
define(['client/lib/errors', 'tests/lib/push-constants'], function(
  ERRORS,
  PushTestConstants
) {
  ...
  return {
    ...
    verifyTotpCodeTrueEnableToken: {
      status: 200,
      body:
        '{"success": true, "recoveryCodes": ["01001112", "01001113", "01001114", "01001115", "01001116", "01001117", "01001118", "01001119"]}',
    },
    verifyTotpCodeTrue: {
      status: 200,
      body: '{"success": true}',
    ...
    replaceRecoveryCodesSuccess: {
      status: 200,
      body:
        '{"recoveryCodes": ["01001112", "01001113", "01001114", "01001115", "01001116", "01001117", "01001118", "01001119"]}',
    },
    replaceRecoveryCodesSuccessNew: {
      status: 200,
      body:
        '{"recoveryCodes": ["99999999", "01001113", "01001114", "01001115", "01001116", "01001117", "01001118", "01001119"]}',
    },
    createRecoveryKey: {
      status: 200,
      body: '{}',
