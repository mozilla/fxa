...
// const mockLink = `${host}/mock-link`;
// const mockLinkOneClick = `${host}/mock-one-click-link`;
const mockLinkSupport = `${host}/mock-support-link`;
// const mockLinkUnsubscribe = `${host}/mock-unsubscribe`;
// const mockLinkReset = `${host}/mock-reset-link`;
const mockLinkPrivacy = `${host}/mock-privacy-link`;
// const mockLinkPasswordChange = `${host}/mock-password-change-link`;
// const mockLinkRevokeAccountRecovery = `${host}/mock-revoke-account-recovery-link`;
// const mockCssPath = '';
...
describe('FxA Email Renderer', () => {
  ...
  //     const email = await fxaEmailRenderer.renderCadReminderFirst({
  //       ...defaultLayoutTemplateValues,
  //       link: mockLink,
  ...
  //   it('should render and snapshot email', async () => {
  //     const renderer = new FxaEmailRenderer(new NodeRendererBindings());
