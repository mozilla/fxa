...
# Variables
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
freeTrialEndingReminder-subject = Tu { $productName } essayo gratuite tosto fini
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
...
freeTrialEndingReminder-content-auto-charge = Si tu non lo cancella ante alora, tu abonamento automaticamente comenciara e nos cargara <strong>{ $invoiceTotal }</strong> al methodo de pagamento sur tu conto le <strong>{ $serviceLastActiveDateOnly }</strong>.
freeTrialEndingReminder-content-auto-charge-plaintext = Si tu non lo cancella ante alora, tu abonamento automaticamente comenciara e nos cargara { $invoiceTotal } al methodo de pagamento sur tu conto le { $serviceLastActiveDateOnly }.
freeTrialEndingReminder-content-charge-heading = Cargar detalios
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
...
freeTrialEndingReminder-content-charge-subscription-2 = Abonamento a { $productName }
# Variables:
...
freeTrialEndingReminder-content-charge-discount-2 = Disconto
# Variables:
...
freeTrialEndingReminder-content-charge-total-2 = Total debite le { $serviceLastActiveDateOnly }
freeTrialEndingReminder-content-account-link = Tu pote revider o actualisar tu methodo de pagamento e le informationes de tu conto <a data-l10n-name="freeTrialEndingReminder-update-billing">ci</a>.
freeTrialEndingReminder-content-account-link-plaintext = Tu pote revider o actualisar tu methodo de pagamento e le informationes de tu conto ci:
# Variables:
#   $serviceLastActiveDateOnly (String) - The date the trial ends, e.g. January 20, 2016
freeTrialEndingReminder-content-cancel-link = Pro evitar de esser cargate, cancella ante <strong>{ $serviceLastActiveDateOnly }</strong>: <a data-l10n-name="freeTrialEndingReminder-cancel-subscription">Cancellar abonamento</a>
freeTrialEndingReminder-content-cancel-link-plaintext = Pro evitar de esser cargate, cancella ante { $serviceLastActiveDateOnly }:
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
...
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
freeTrialEndingReminder-content-signature = Le equipa de { $productName }
# Variables:
#  $subscriptionSupportUrlWithUtm (String) - URL to the subscription products support page
freeTrialEndingReminder-content-support-plaintext = Contacta nos: { $subscriptionSupportUrlWithUtm }
#  Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
...
# Variables
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionCancellation-freeTrial-subject = Tu prova gratuite de { $productName } ha essite cancellate
# Variables
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
#   $trialEndDateOnly (String) - The date when the free trial ends, e.g. 01/20/2016
subscriptionCancellation-freeTrial-content = Tu prova gratuite de { $productName } ha essite cancellate. Tu accesso finira le { $trialEndDateOnly }. Tu non sera cargate.
# Variables:
# $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
...
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-subject-2 = Tu abonamento a { $productName } ha essite reactivate
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-free-trial-subject = Tu essayo gratuite de { $productName } ha essite reactivate
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-title = Gratias pro le reactivation de tu subscription a { $productName }!
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-free-trial-title = Gratias pro le reactivation de tu essayo gratuite de { $productName }!
# Variables:
#  $invoiceTotal (String) - The amount of the subscription invoice, including currency, e.g. $10.00
