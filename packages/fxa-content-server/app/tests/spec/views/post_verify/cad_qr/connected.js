...
import View from 'views/post_verify/cad_qr/connected';
import WindowMock from '../../../../mocks/window';
import $ from 'jquery';

describe('views/post_verify/cad_qr/connected', () => {
  let account;
  let broker;
  let metrics;
  let model;
  ...
  describe('render', () => {
    it('renders the view', () => {
      assert.lengthOf(view.$('.cad-qr-connected'), 1);
      assert.lengthOf(view.$('.graphic-cad-qr-code-connected'), 1);
