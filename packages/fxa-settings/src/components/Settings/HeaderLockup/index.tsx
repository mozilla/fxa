    ...
    <>
      ...
      >
        {sidebarRevealedState ? (
          <Close className="text-violet-900 dark:text-grey-100 w-8" />
        ) : (
          <Menu className="text-violet-900 dark:text-grey-100 w-8" />
        )}
    ...
    <>
      ...
      >
        <Help
          ...
          title={localizedHelpText}
          role="img"
          className="w-5 text-violet-900 dark:text-grey-100"
        />
      </LinkExternal>
      <BentoMenu />
      <DropDownAvatarMenu />
