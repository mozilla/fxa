...
passkey-row-webauthn-not-supported = თქვენს ბრაუზერსა თუ მოწყობილობაზე მხარდაუჭერელია საშვები.
...
passkey-registration-error-not-supported = საშვები არაა მხარდაჭერილი აქ. სცადეთ სხვა გზა ან მოწყობილობა.
...
passkey-authentication-error-not-supported = საშვები არაა მხარდაჭერილი. სცადეთ სხვა გზა ან მოწყობილობა.
