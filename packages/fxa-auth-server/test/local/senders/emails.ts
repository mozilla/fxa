...
const TESTS: [string, any, Record<string, any>?][] = [
  ...
  ['postAddRecoveryPhoneEmail', new Map<string, Test | any>([
    ['subject', { test: 'equal', expected: 'Backup recovery phone added' }],
    ['headers', new Map([
    ...
    ['html', [
      { test: 'include', expected: 'You created a new backup recovery method' },
      { test: 'include', expected: 'You added ••••••1234 as your backup recovery phone' },
  ...
  ['postChangeRecoveryPhoneEmail', new Map<string, Test | any>([
    ['subject', { test: 'equal', expected: 'Backup recovery phone updated' }],
    ['headers', new Map([
    ...
    ['html', [
      { test: 'include', expected: 'You changed your backup recovery phone' },
      { test: 'include', expected: 'You now have a new backup recovery phone. Your previous phone number was deleted.' },
  ...
  ['postRemoveRecoveryPhoneEmail', new Map<string, Test | any>([
    ['subject', { test: 'equal', expected: 'Backup recovery phone removed' }],
    ['headers', new Map([
