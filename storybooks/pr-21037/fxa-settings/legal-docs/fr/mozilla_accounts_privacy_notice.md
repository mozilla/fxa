...
### Pour vous fournir votre compte Mozilla
...
* Plus de détails, notamment comment modifier vos paramètres de données :* Vous pouvez en savoir plus sur la [gestion de votre compte Mozilla](https://support.mozilla.org/kb/firefox-accounts-managing-account-data), l'[activation de la synchronisation](https://support.mozilla.org/kb/sync-firefox-desktop), le [fonctionnement de la synchronisation](https://support.mozilla.org/kb/sync) et les [données](https://dictionary.telemetry.mozilla.org/?page%3D1%26search%3Dmozilla%2520accounts) que nous collectons pour les comptes.

### Pour fournir et améliorer les comptes Mozilla et les services connectés
...
Mozilla utilise des données techniques et d'interaction pour sécuriser l'accès aux comptes Mozilla, permettre le transfert des données chiffrées à des fins de synchronisation et détecter les activités suspectes. Mozilla utilise également un pare-feu d'application Web tiers pour améliorer la protection contre les attaques d'applications Web et les attaques [DDoS](https://en.wikipedia.org/wiki/Denial-of-service_attack). Toutes les données stockées sur les serveurs Mozilla sont chiffrées.
...
Nous pouvons également être amenés à traiter vos données à caractère personnel pour nous conformer aux lois en vigueur et à des fins de protection des données, par exemple :

* Répondre à des [demandes légales](https://www.mozilla.org/about/policy/transparency/#dfn-legal-process) et se conformer à des [procédures légales](https://www.mozilla.org/about/policy/transparency/), telles que répondre à des citations à comparaître, répondre à des enquêtes ou des demandes émanant d'autorités gouvernementales. Mozilla a besoin d'une procédure légale valide pour exiger la divulgation de données d'utilisateurs spécifiques à un gouvernement.
...
* Effectuer la modération du contenu et les activités connexes liées à la confiance et à la sécurité.
...
Vous pouvez modifier vos [paramètres de compte Mozilla ](https://support.mozilla.org/kb/firefox-accounts-managing-account-data) à tout moment.
...
| Type de données | Description | Exemples à l'attention des utilisateurs de comptes Mozilla |
| ----- | ----- | ----- |
| Données de compte | Il s'agit de données relatives à la gestion de votre compte Mozilla, telles que les informations d'inscription.  | Nom d'utilisateur du compte, pseudo, identifiant du compte Mozilla.  |
| Données d’authentification | Nous recevons des données afin de sécuriser vos comptes et créons également des données liées à l'authentification afin de maintenir la sécurité de votre compte.  | Hachage du mot de passe, tokenData. |
| Données de contact | L'adresse e-mail que vous fournissez lors de la création de votre compte, ainsi que toutes autres coordonnées que vous choisissez de nous communiquer.  | Adresse e-mail, adresse e-mail secondaire, numéro de téléphone. |
| Données d’interaction | Il s'agit des données relatives à votre utilisation de nos services. | Nombre de clics, journaux d'événements, données d'utilisation.  |
...
| Paramètres | Il s'agit de vos préférences ou de vos paramètres concernant la manière dont les services sont fournis, tels que vos préférences en matière de confidentialité. Si vous n'avez pas fait de choix spécifiques, il s'agit des paramètres par défaut.  | Paramètres de confidentialité, paramètres du compte.  |
| Données relatives aux performances du système | Il s'agit de données sur le fonctionnement des services sur votre appareil.  | THorodatage, réussite/échec des soumissions.  |
| Données techniques | Il s'agit d'informations sur le matériel à partir duquel vous accédez à nos services (comme votre ordinateur de bureau, votre smartphone ou votre tablette), ses configurations et connexions.  | Système d'exploitation de l'appareil, navigateur et version, horodatage, paramètres régionaux. |
| Identifiants uniques  | Il s'agit d'identifiants uniques, qui peuvent être créés à différents moments pour gérer vos interactions avec le service.  | Accounts_id, session_id.  |
...
<table>
  ...
  <tbody>
    <tr>
      <td><a id="bookmark-how-we-use-data"></a>Pour vous fournir votre compte Mozilla</td>
      <td>
        <ul>
          <li>Données techniques</li>
          <li>Identifiants uniques</li>
          <li>Performances du système</li>
          <li>Donn&es d'autorisation</li>
          <li>Données de contenu</li>
          <li>Données de contact</li>
        </ul>
      </td>
      <td>
        <p><strong>Contrat</strong> pour vous fournir les fonctionnalités nécessaires au fonctionnement des comptes Mozilla.</p>
        <p><strong>Intérêt légitime</strong> à fournir des fonctionnalités, comme l'utilisation d'avatars et de pseudos facultatifs.</p>
      </td>
    </tr>
    <tr>
      <td>Pour fournir et améliorer les comptes Mozilla et les services connectés</td>
      <td>
        <ul>
          <li>Données techniques</li>
      ...
      <td>
        <p><strong>Contrat</strong> pour s'assurer que les comptes Mozilla restent opérationnels.</p>
    ...
    <tr>
      ...
      <td>
        <p><strong>Contrat</strong> visant à fournir une infrastructure sécurisée permettant le fonctionnement des comptes Mozilla.</p>
        <p><strong>Intérêt légitime </strong> à fournir des mesures de sécurité supplémentaires, par exemple la possibilité d'utiliser l'authentification à deux facteurs.</p>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <strong>Intérêt légitime</strong> à prendre des mesures de protection de la vie privée avant d'effectuer des analyses ou de partager des données avec des partenaires.
      </td>
    </tr>
    <tr>
      <td>Pour communiquer avec vous, notamment dans le cadre de la commercialisation de nos services</td>
      <td>
        <ul>
          <li>Informations de contact (coordonnées)</li>
          <li>Identifiants uniques</li>
          <li>Données d’interaction</li>
        </ul>
      </td>
      <td>
        <p><strong>Intérêt légitime</strong> à fournir des mises à jour importantes relatives aux comptes et à promouvoir nos produits et services, notamment par l'envoi de communications marketing et l'évaluation et l'amélioration de nos campagnes marketing.</p>
    ...
    <tr>
      <td>Pour respecter les lois applicables, identifier et prévenir les activités nuisibles, non autorisées ou illégales</td>
      <td>
        <ul>
          <li>Tous les types de données</li>
        </ul>
      ...
      <td>
        ...
        <p><strong>Intérêt légitime</strong>, lorsque cela n'est pas strictement requis par la loi, pour soutenir des processus ou des demandes juridiques ou réglementaires, prévenir la fraude et gérer et protéger nos droits, notre propriété et/ou notre sécurité (et ceux/celle de nos utilisateurs).</p>
      </td>
    </tr>
  </tbody>
</table>
