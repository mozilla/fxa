...
cart-free-trial-mismatch-error = Ваше право на бесплатни пробни период се променило. Покушајте поново.
...
new-account-prepaid-card-free-trial-not-allowed = Припејд картице не могу да се користе за покретање бесплатног пробног периода на новим налозима. Покушајте са другим начином плаћања.
...
free-trial-ineligible-notice = Ваш налог не испуњава услове за бесплатан пробни период. Можете наставити са плаћеном претплатом.
...
free-trial-content-button-cancel-subscription = Откажи претплату
free-trial-content-button-cancel-subscription-aria = Откажи претплату за { $productName }
...
free-trial-content-trial-ended = Ваш бесплатни пробни период је завршен <bold>{ $date }</bold>.
free-trial-content-could-not-process-payment = Нисмо могли да обрадимо вашу уплату. Ажурирајте начин плаћања да бисте поново добили приступ. Обрада може трајати до 24 сата и може варирати у зависности од банке или начина плаћања.
...
manage-payment-method-tax-address-required = Нисмо могли да утврдимо ваше место плаћања. Проверите податке о начину плаћања и покушајте поново.
