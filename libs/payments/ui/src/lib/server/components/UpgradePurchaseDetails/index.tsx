...
export function UpgradePurchaseDetails(props: UpgradePurchaseDetailsProps) {
  ...
  return (
    <section
      ...
      className={`bg-white clip-shadow rounded-b-lg shadow-sm shadow-grey-300 text-sm pt-4 px-4 ${sessionExists ? 'mt-0 rounded-t-none tablet:rounded-t-tg' : 'mt-6 rounded-t-lg'}`}
    >
