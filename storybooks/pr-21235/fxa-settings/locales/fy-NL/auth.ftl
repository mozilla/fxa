...
freeTrialEndingReminder-content-charge-subscription-2 = Abonnemint op { $productName }
# Variables:
...
freeTrialEndingReminder-content-charge-discount-2 = Koarting
# Variables:
...
freeTrialEndingReminder-content-charge-total-2 = Totaal te beteljen op { $serviceLastActiveDateOnly }
...
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-subject-2 = Jo abonnemint op { $productName } is opnij aktivearre
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-free-trial-subject = Jo fergeze proefperioade fan { $productName } is opnij aktivearre
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-title = Tank foar it opnij aktivearjen fan jo abonnemint op { $productName }!
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-free-trial-title = Tank foar it opnij aktivearjen fan jo fergeze proefperioade fan { $productName }!
# Variables:
#  $invoiceTotal (String) - The amount of the subscription invoice, including currency, e.g. $10.00
