 ...
 *
 * Generated from `reg.apple_oauth_start`.
 */
export const appleOauthStart = new EventMetricType(
  {
    category: 'reg',
    name: 'apple_oauth_start',
    sendInPings: ['events'],
    lifetime: 'ping',
    disabled: false,
  },
 ...
 *
 * Generated from `reg.google_oauth_start`.
 */
export const googleOauthStart = new EventMetricType(
  {
    category: 'reg',
