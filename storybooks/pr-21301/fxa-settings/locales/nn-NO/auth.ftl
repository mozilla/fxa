...
freeTrialEndingReminder-content-cancel-link = For å unngå belastning, avslutt før <strong>{ $serviceLastActiveDateOnly }</strong>: <a data-l10n-name="freeTrialEndingReminder-cancel-subscription">Avslutt abonnementet</a>
freeTrialEndingReminder-content-cancel-link-plaintext = For å unngå belastning, avslutt før { $serviceLastActiveDateOnly }:
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
freeTrialEndingReminder-content-thanks = Takk for at du prøver { $productName }. Om du har spørsmål om prøveperioden eller abonnementet ditt, kan du <a data-l10n-name="freeTrialEndingReminder-contact-support">kontakte oss</a>.
freeTrialEndingReminder-content-thanks-plaintext = Takk for at du prøver { $productName }. Om du har spørsmål om prøveperioden eller abonnementet ditt, kan du kontakte oss.
...
# Variables
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionCancellation-freeTrial-subject = Prøveperioden for { $productName } er avslutta
# Variables
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
#   $trialEndDateOnly (String) - The date when the free trial ends, e.g. 01/20/2016
subscriptionCancellation-freeTrial-content = Prøveperioden din for { $productName } er avslutta. Tilgangen din vert { $trialEndDateOnly }. Du vil ikkje bli belasta.
# Variables:
# $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
...
subscriptionEndingReminder-content-line2-v2 = Om du vil fortsette å bruke { $productName }, kan du halde fram med å vere abonnent i <a data-l10n-name="subscriptionEndingReminder-subscription-management">abonnementshandsaminga</a> før <strong>{ $serviceLastActiveDateOnly }</strong>. Om du treng hjelp, kan du <a data-l10n-name="subscriptionEndingReminder-contact-support">kontakte brukerstøtteteteamet vårt</a>.
subscriptionEndingReminder-content-line1-plaintext = Tilgangen din til { $productName } vert avslutta { $serviceLastActiveDateOnly }.
subscriptionEndingReminder-content-line2-plaintext-v2 = Om du vil fortsette å bruke { $productName }, kan du halde fram med å vere abonnent i abonnementshandsaminga før { $serviceLastActiveDateOnly }. Om du treng hjelp, kan du kontakte brukarstøtteteamet vårt.
...
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-free-trial-subject = Gratis-prøveperioden din for { $productName } er fornya
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-title = Takk for at du reaktiverte abonnementet på { $productName }!
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-free-trial-title = Takk for at du fornya gratis-prøveperioden din for { $productName }!
# Variables:
#  $invoiceTotal (String) - The amount of the subscription invoice, including currency, e.g. $10.00
