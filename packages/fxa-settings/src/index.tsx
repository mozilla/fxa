...
try {
  // Fx Desktop opens the pairing-authority page with none of the attribution
  // params it gave /pair. Restore them from the hand-off stash before
  // the router and every UrlQueryData reads the URL.
