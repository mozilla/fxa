...
# Variables
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
freeTrialEndingReminder-subject = თქვენი { $productName } უფასო საცდელი დროით მალე ამოიწურება
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
...
freeTrialEndingReminder-content-charge-tax-2 = საგადასახადო
# Variables:
#   $serviceLastActiveDateOnly (String) - The date the charge will occur, e.g. January 20, 2016
...
freeTrialEndingReminder-content-charge-total-2 = ბოლო თარიღი { $serviceLastActiveDateOnly }
...
freeTrialEndingReminder-content-account-link-plaintext = გადახდის საშუალებისა და ანგარიშის მონაცემების გადახედვა ან განახლება შეგიძლიათ აქედან:
# Variables:
#   $serviceLastActiveDateOnly (String) - The date the trial ends, e.g. January 20, 2016
freeTrialEndingReminder-content-cancel-link = თანხის ჩამოჭრის ასარიდებლად, გააუქმეთ თარიღამდე <strong>{ $serviceLastActiveDateOnly }</strong>: <a data-l10n-name="freeTrialEndingReminder-cancel-subscription">გამოწერის გაუქმება</a>
freeTrialEndingReminder-content-cancel-link-plaintext = თანხის ჩამოჭრის ასარიდებლად გააუქმეთ თარიღამდე { $serviceLastActiveDateOnly }:
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
freeTrialEndingReminder-content-thanks = გმადლობთ, რომ გადაწყვიტეთ მოსინჯოთ { $productName }. თუ გაქვთ კითხვები თქვენი საცდელი ან გამოწერილი ვერსიის შესახებ, გთხოვთ <a data-l10n-name="freeTrialEndingReminder-contact-support">მოვწეროთ</a>.
freeTrialEndingReminder-content-thanks-plaintext = გმადლობთ, რომ გადაწყვიტეთ მოსინჯოთ { $productName }. თუ გაქვთ კითხვები თქვენი საცდელი ან გამოწერილი ვერსიის შესახებ, გთხოვთ მოგვწეროთ.
freeTrialEndingReminder-content-closing = პატივისცემით,
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
freeTrialEndingReminder-content-signature = { $productName } პროდუქტის გუნდი
# Variables:
#  $subscriptionSupportUrlWithUtm (String) - URL to the subscription products support page
freeTrialEndingReminder-content-support-plaintext = დაგვიკავშირდით: { $subscriptionSupportUrlWithUtm }
#  Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
...
# Variables
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionCancellation-freeTrial-subject = საცდელი დროით გამოწერილი { $productName } გაუქმებულია
# Variables
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
#   $trialEndDateOnly (String) - The date when the free trial ends, e.g. 01/20/2016
subscriptionCancellation-freeTrial-content = { $productName } უფასო საცდელი დროით გაუქმებულია. წვდომის შეწყვეტის თარიღია { $trialEndDateOnly }. თანხა არ ჩამოგეჭრებათ.
# Variables:
# $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
...
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-free-trial-subject = თქვენი უფასო საცდელი { $productName } კვლავ ამოქმედდა
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-title = გმადლობთ, რომ კვლავ გამოიწერეთ { $productName }!
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-free-trial-title = გმადლობთ, რომ კვლავ აამოქმედეთ უფასო საცდელი დროით { $productName }!
# Variables:
#  $invoiceTotal (String) - The amount of the subscription invoice, including currency, e.g. $10.00
