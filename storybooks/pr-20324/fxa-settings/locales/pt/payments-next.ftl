...
not-found-loyalty-discount-description = A página que está à procura não existe.
not-found-loyalty-discount-button-back-to-subscriptions = Voltar para subscrições
...
already-canceling-title = A sua subscrição está marcada para terminar
# $productName (String) - The name of the product to create subscription, e.g. Mozilla VPN
...
cancel-subscription-button-keep-subscription = Manter subscrição
...
churn-cancel-flow-cancel-success-title = Lamentamos vê-lo partir
# $productName (String) - The name of the product to create subscription, e.g. Mozilla VPN
# $date (Date) - Last day of product access
...
churn-stay-subscribed-button-go-to-product-page = Ir para { $productName }
...
free-trial-content-button-cancel-trial-aria = Cancelar teste para { $productName }
...
free-trial-content-link-view-invoice = Ver fatura
# $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
free-trial-content-link-view-invoice-aria = Ver fatura para { $productName }
# $date (Date) - The date the free trial ended (e.g., January 16, 2026)
free-trial-content-payment-failed = O seu teste gratuito terminou em <bold>{ $date }</bold>. Não conseguimos processar o seu pagamento para iniciar a sua subscrição. Por favor, atualize o seu método de pagamento para ativar a sua subscrição e restaurar o acesso aos seus serviços.
free-trial-content-payment-failed-no-date = Não conseguimos processar o seu pagamento para iniciar a sua subscrição. Por favor, atualize o seu método de pagamento para ativar a sua subscrição e restaurar o acesso aos seus serviços.
...
interstitial-offer-success-cancel-title = Lamentamos vê-lo partir
# $productName (String) - The name of the product to create subscription, e.g. Mozilla VPN
# $date (Date) - Last day of product access
...
interstitial-offer-button-keep-current-interval-daily = Manter subscrição diária
interstitial-offer-button-keep-current-interval-weekly = Manter subscrição semanal
interstitial-offer-button-keep-current-interval-halfyearly = Manter subscrição de seis meses
interstitial-offer-button-keep-current-interval-monthly = Manter subscrição mensal
interstitial-offer-button-keep-subscription = Manter subscrição
...
free-trial-first-charge-title = Primeira cobrança: { $endDate }
...
subscription-content-link-churn-intervention-terms-apply = Aplicam-se termos
subscription-content-link-churn-intervention-terms-aria = Ver termos e restrições dos cupões
