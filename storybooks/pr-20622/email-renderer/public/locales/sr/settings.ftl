...
password-strength-long-instruction = Изаберите јаку лозинку коју нисте користили на другим страницама. Уверите се да испуњава безбедносне захтеве:
...
delete-account-delete-button-passwordless = Обриши налог
...
page-passkey-add-creating-heading = Стварање приступног кључа…
page-passkey-add-follow-prompts = Пратите упутства на вашем уређају.
page-passkey-add-cancel = Откажи

## Success / Error messages (shown in alert bar after returning to settings)

page-passkey-add-success = Приступни кључ је направљен
page-passkey-add-error-system-v2 = Дошло је до проблема при стварању вашег приступног кључа. Покушајте поново касније.
...
product-promo-vpn-description = Откријте додатни слој анонимног прегледања и заштите.
# Links out to the VPN site
product-promo-vpn-cta = Набавите { -product-mozilla-vpn-short }
...
passkey-row-max-limit-banner =
    { $count ->
        [one] Искористили сте један приступни кључ. Обришите приступни кључ да бисте направили нови.
        [few] Искористили сте сва { $count } приступна кључа. Обришите приступни кључ да бисте направили нови.
       *[other] Искористили сте свих { $count } приступних кључева. Обришите приступни кључ да бисте направили нови.
    }
# Tooltip shown on the disabled Create button when the passkey limit is reached
passkey-row-max-limit-disabled-reason = Достигли сте највећи број приступних кључева.
...
auth-error-239 = Нажалост, нисмо могли да обришемо ваш налог. Покушајте поново или контактирајте подршку ако се ово и даље настави.
...
passkey-registration-error-not-supported-link = Сазнајте више
...
passkey-authentication-error-not-supported-v2 = Ваш прегледач или уређај не подржава приступне кључеве.
# RP ID / origin mismatch, or insecure context (e.g., embedded iframe)
passkey-authentication-error-security = Приступни кључеви се не могу користити на овој страници. Проверите да ли сте на исправној безбедној страници и покушајте поново.
...
pair-auth-allow-refuse-device-link = Ако то нисте били ви, <a>промените лозинку</a>
...
# Heading
pair-auth-complete-send-tab-heading = Спремни сте да пошаљете неке језичке
# Variable { $deviceFamily } is generally a browser name, for example "Firefox"
# Variable { $deviceOS } is an operating system short name, for example "iOS", "Android"
pair-auth-complete-send-tab-device-connected = { $deviceFamily } за { $deviceOS } је повезан.
pair-auth-complete-send-tab-benefits = Можете одмах да шаљете отворене језичке, лозинке и обележиваче између уређаја.
...
pair-failure-header-v2 = Упаривање уређаја није успело
pair-failure-message-v2 = Подешавање није могло да се заврши. Пријавите се помоћу своје е-поште.
pair-failure-try-again-link = Покушајте поново

## Pair index page

pair-sync-header = Усклађујте { -brand-firefox } на вашем телефону или таблету
pair-cad-header-v2 = Повежите други уређај
...
pair-choice-subheader = Ускладите ваше { -brand-firefox } искуство
# Description shown on the choice screen
pair-choice-description = Прегледајте своје сачуване лозинке, језичке, историју прегледања и остало - на свим вашим уређајима.
# Heading shown on the choice screen when the user arrived via a Send Tab entrypoint
pair-choice-header-send-tab = Преузмите или отворите { -brand-firefox } на уређају на који желите да пошаљете језичке
# Legend for the radio button fieldset
pair-choice-legend = Изаберите могућност за наставак:
# Radio option: user already has Firefox for mobile — title
pair-choice-has-mobile-title = Већ имам { -brand-firefox } за мобилне уређаје
# Radio option: user already has Firefox for mobile — description
pair-choice-has-mobile-description = Започните усклађивање сада ако већ имате { -brand-firefox } на свом мобилном уређају.
# Radio option: user does not have Firefox for mobile — title
pair-choice-needs-mobile-title = Немам { -brand-firefox } за мобилне уређаје
# Radio option: user does not have Firefox for mobile — description
pair-choice-needs-mobile-description = Преузмите { -brand-firefox } на свој мобилни уређај, а затим започните усклађивање.
# Continue button on choice screen (disabled until a radio option is selected)
pair-choice-continue-button = Настави
# Success banner shown after signing in
pair-signed-in-successfully = Успешно сте пријављени!
# Success banner shown after signing up and verifying email via a Send Tab flow
pair-account-created-now-syncing = Налог је направљен. Сада се усклађујете.
# Success banner shown after creating a password for a passwordless account via a Send Tab flow
pair-password-created-now-syncing = Лозинка је направљена. Сада се усклађујете.

## Download screen — shown after selecting "I don’t have Firefox for mobile"

# Subheader for the download screen
pair-download-subheader = Преузмите { -brand-firefox } за мобилне уређаје
# Description for the download screen
pair-download-description = Да бисте ускладили { -brand-firefox } на вашем телефону или таблету, прво морате да преузмете { -brand-firefox } за мобилне уређаје. Ево како:
# Step 1: scan QR code. $stepNumber is the step number (1)
pair-download-step-scan-qr = <b>Корак { $stepNumber }</b>: Преузмите { -brand-firefox } скенирањем овог КР кода камером на вашем мобилном уређају:
# Step 2: continue to sync. $stepNumber is the step number (2)
pair-download-step-continue-sync = <b>Корак { $stepNumber }</b>: Изаберите „Настави усклађивање” да бисте ускладили своје искуство са { -brand-firefox } на вашем мобилном уређају.
# Button on the download screen that opens about:preferences for pairing
pair-continue-to-sync-button = Настави усклађивање

## PairSuccess - a view which displays  on successful completion of the device pairing process

pair-success-header-2 = Уређај је повезан
pair-success-message-2 = Упаривање је успело.
pair-success-tab-close-message = Овај језичак ће { -brand-firefox } самостално затворити.
...
pair-unsupported-oops-header = Упс! Чини се да не користите { -brand-firefox }.
# Shown below the heading on desktop non-Firefox, prompting the user to switch browsers
pair-unsupported-switch-to-firefox = Пребаците се на { -brand-firefox } и отворите ову страницу да бисте повезали други уређај.
...
pair-unsupported-connecting-mobile-instructions-v2 = Отворите { -brand-firefox } на вашем рачунару, посетите <b>firefox.com/pair</b> и пратите упутства на екрану да бисте повезали ваш мобилни уређај.
# v2: "Learn more" link below the mobile instructions; links to a Mozilla support article.
pair-unsupported-learn-more-link-v2 = Сазнајте више
...
pair-unsupported-desktop-firefox-fallback-header-v2 = Упс! Нешто је пошло наопако.
pair-unsupported-desktop-firefox-fallback-message-v2 = Затворите овај језичак и покушајте поново.
...
signin-passwordless-code-input-label-v2 = Унесите шестоцифрени код
