...
diners-logo-alt-text2 = Logótipo de { -brand-diners }
...
free-trial-ineligible-notice = A sua conta não é elegível para um teste gratuito. Pode continuar com uma subscrição paga.
...
free-trial-content-button-cancel-subscription = Cancelar subscrição
free-trial-content-button-cancel-subscription-aria = Cancelar subscrição para { $productName }
