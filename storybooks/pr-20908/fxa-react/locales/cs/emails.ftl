...
automated-email-sign-in =
    Toto je automaticky generovaný e-mail; pokud jste tuto akci neschválili, <a data-l10n-name="securitySettingsLink">zkontrolujte prosím nastavení zabezpečení svého účtu</a>.
    Další informace najdete na stránkách <a data-l10n-name="supportLink">podpory { -brand-mozilla }</a>.
automated-email-sign-in-plaintext = Pokud jste tuto akci neschválili, zkontrolujte prosím nastavení zabezpečení svého účtu na adrese:
...
change-password-plaintext = Pokud máte podezření, že se někdo pokouší neoprávněně získat přístup do vašeho účtu, změňte si prosím své heslo.
...
codes-reminder-description-create-codes = Vytvořte si nové záložní ověřovací kódy, které vám pomohou dostat se zpět do účtu, pokud k němu nebudete mít přístup.
...
passwordChangeRequired-sign-in-3 = Pro opětovné přihlášení do svého účtu stačí obnovit heslo.
...
postAddPasskey-title = Vytvořili jste přístupový klíč
postAddPasskey-description = Nyní se s ním můžete přihlásit ke všem službám { -product-mozilla-account }.
postAddPasskey-sync-note = Upozorňujeme, že pro přístup k vašim synchronizovaným datům v aplikaci { -brand-firefox } budete i nadále potřebovat heslo.
# Links out to a support article about passkeys and { -brand-firefox } sync
postAddPasskey-learn-more = Zjistit více
postAddPasskey-requested-from = Požádali jste o to z:
...
postRemovePasskey-subject = Přístupový klíč byl smazán
postRemovePasskey-preview = Z vašeho účtu byl odebrán přístupový kód
postRemovePasskey-title = Smazali jste svůj přístupový kód
postRemovePasskey-description = K přihlášení budete muset použít jinou metodu.
postRemovePasskey-requested-from = Tuto žádost jste zaslali:
postRemovePasskey-action = Spravovat účet
