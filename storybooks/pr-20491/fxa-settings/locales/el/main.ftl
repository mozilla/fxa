...
passkey-row-webauthn-not-supported = Το πρόγραμμα περιήγησης ή η συσκευή σας δεν υποστηρίζει κλειδιά πρόσβασης.
...
passkey-registration-error-not-supported = Τα κλειδιά πρόσβασης δεν υποστηρίζονται εδώ. Δοκιμάστε μια άλλη μέθοδο ή συσκευή.
...
passkey-authentication-error-not-supported = Τα κλειδιά πρόσβασης δεν υποστηρίζονται. Δοκιμάστε μια άλλη μέθοδο ή συσκευή.
