...
-product-mozilla-account = บัญชี Mozilla
-product-mozilla-accounts =
    { $capitalization ->
        [uppercase] บัญชี Mozilla
       *[lowercase] บัญชี Mozilla
    }
...
link-sr-new-window = เปิดในหน้าต่างใหม่


app-loading-spinner-aria-label-loading = กำลังโหลด…
...
signin-passkey-fallback-go-to-settings = ไปยังการตั้งค่า
