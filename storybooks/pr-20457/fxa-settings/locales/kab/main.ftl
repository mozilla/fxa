...
-product-mozilla-account = Amiḍan n Mozilla
-product-mozilla-accounts =
    { $capitalization ->
        [uppercase] Imiḍanen n Mozilla
       *[lowercase] Imiḍanen n Mozilla
    }
...
link-sr-new-window = Yettalday deg usfaylu amaynut


app-loading-spinner-aria-label-loading = Asali…
