...
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
freeTrialEndingReminder-content-greeting = ਸਤਿਕਾਰਯੋਗ { $productName } ਗਾਹਕ,
freeTrialEndingReminder-content-charge-subscription-2 = { $productName } ਮੈਂਬਰੀ
# Variables:
#   $invoiceDiscountAmount (String) - The discount amount, as a negative number, e.g. -$3.00
freeTrialEndingReminder-content-charge-discount = ਰਿਆਇਤ: { $invoiceDiscountAmount }
freeTrialEndingReminder-content-charge-discount-2 = ਰਿਆਇਤ
# Variables:
#   $invoiceTaxAmount (String) - The tax amount, e.g. $1.20
freeTrialEndingReminder-content-charge-tax = ਟੈਕਸ: { $invoiceTaxAmount }
freeTrialEndingReminder-content-charge-tax-2 = ਟੈਕਸ
# Variables:
#   $serviceLastActiveDateOnly (String) - The date the charge will occur, e.g. January 20, 2016
#   $invoiceTotal (String) - The total amount due, e.g. $9.99
freeTrialEndingReminder-content-charge-total = { $serviceLastActiveDateOnly } ਨੂੰ ਕੁੱਲ ਦੇਣਦਾਰੀ: { $invoiceTotal }
freeTrialEndingReminder-content-charge-total-2 = { $serviceLastActiveDateOnly } ਨੂੰ ਕੁੱਲ ਦੇਣਦਾਰੀ
freeTrialEndingReminder-content-closing = ਤਹਿ ਦਿਲੋਂ,
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
freeTrialEndingReminder-content-signature = { $productName } ਟੀਮ
# Variables:
#  $subscriptionSupportUrlWithUtm (String) - URL to the subscription products support page
freeTrialEndingReminder-content-support-plaintext = ਸਾਡੇ ਨਾਲ ਸੰਪਰਕ ਕਰੋ: { $subscriptionSupportUrlWithUtm }
#  Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
...
subscriptionEndingReminder-content-closing = ਕੀਮਤੀ ਮੈਂਬਰ ਬਣਨ ਲਈ ਧੰਨਵਾਦ ਹੈ!
subscriptionEndingReminder-churn-title = ਕੀ ਪਹੁੰਚ ਰੱਖਣਾ ਚਾਹੁੰਦੇ ਹੋ?
#  Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
