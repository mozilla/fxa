  ...
  describe('lib/fxa-client', function () {
    ...
    describe('errors', function () {
      ...
      describe('realClient does not return a promise', function () {
        it('does not normalize', function () {
          ...
          return client
            ._getClient({ keyStretchVersion: 2 })
    ...
    describe('verifyCode', function () {
      ...
      it('throws any errors', function () {
        sinon.stub(realClient, 'verifyCode').callsFake(function () {
          return Promise.reject(
            AuthErrors.toError('INVALID_VERIFICATION_CODE')
          );
        });
    ...
    describe('passwordResetResend', function () {
      ...
      beforeEach(function () {
        ...
        sinon
          .stub(realClient, 'passwordForgotResendCode')
          .callsFake(function () {
            return Promise.resolve({});
          });
      });
    ...
    describe('completePasswordReset', function () {
      ...
      beforeEach(function () {
        sinon
          .stub(realClient, 'passwordForgotVerifyCode')
          .callsFake(function () {
            return Promise.resolve({
      ...
      it('delegates to the fxa-auth-client', () => {
        ...
        return client
          ...
          .then((resp) => {
            ...
            assert.isTrue(
              realClient.accountKeys.calledOnceWith(
                'keyFetchToken',
                'unwrapBKey'
              )
            );
    ...
    describe('verifyIdToken', () => {
      it('delegates to the fxa-auth-client', () => {
        ...
        return client
          .verifyIdToken('sometoken', 'abcd1234', 100)
          .then((resp) => {
            assert.isTrue(
              realClient.verifyIdToken.calledOnceWith(
                'sometoken',
                'abcd1234',
                100
              )
