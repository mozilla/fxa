...
const TESTS: [string, any, Record<string, any>?][] = [
  ...
  ['postAddRecoveryPhoneEmail', new Map<string, Test | any>([
    ...
    ['html', [
      ...
      { test: 'include', expected: decodeUrl(configHref('initiatePasswordResetUrl', 'recovery-phone-added', 'reset-password', 'email', 'reset_password_confirm=false', 'email_to_hash_with=')) },
    ...
    ['text', [
      ...
      { test: 'include', expected: `If you did not authorize this action, please reset your password now at ${configUrl('initiatePasswordResetUrl', 'recovery-phone-added', 'reset-password', 'email', 'reset_password_confirm=false', 'email_to_hash_with=')}` },
  ...
  ['postChangeRecoveryPhoneEmail', new Map<string, Test | any>([
    ...
    ['text', [
      ...
      { test: 'include', expected: `${MESSAGE.date}` },
      { test: 'exists', expected: `${MESSAGE.time}` },
      { test: 'include', expected: `If you did not authorize this action, please reset your password now at ${configUrl('initiatePasswordResetUrl', 'recovery-phone-changed', 'reset-password', 'email', 'reset_password_confirm=false', 'email_to_hash_with=')}` },
  ...
  ['postPasswordResetRecoveryPhoneEmail', new Map<string, Test | any>([
    ['subject', { test: 'equal', expected: 'Recovery phone used' }],
    ['headers', new Map([
      ['X-SES-MESSAGE-TAGS', { test: 'equal', expected: sesMessageTagsHeaderValue('postPasswordResetRecoveryPhone') }],
      ['X-Template-Name', { test: 'equal', expected: 'postPasswordResetRecoveryPhone' }],
      ['X-Template-Version', { test: 'equal', expected: TEMPLATE_VERSIONS.postPasswordResetRecoveryPhone }],
    ])],
    ['html', [
      ...
      { test: 'include', expected: decodeUrl(configHref('initiatePasswordResetUrl', 'password-reset-recovery-phone', 'reset-password', 'email', 'reset_password_confirm=false', 'email_to_hash_with=')) },
  ...
  ['postRemoveRecoveryPhoneEmail', new Map<string, Test | any>([
    ...
    ['text', [
      ...
      { test: 'include', expected: `${MESSAGE.date}` },
      { test: 'exists', expected: `${MESSAGE.time}` },
      { test: 'include', expected: `If you did not authorize this action, please reset your password now at ${configUrl('initiatePasswordResetUrl', 'recovery-phone-removed', 'reset-password', 'email', 'reset_password_confirm=false', 'email_to_hash_with=')}` },
  ...
  ['postSigninRecoveryPhoneEmail', new Map<string, Test | any>([
    ...
    ['html', [
      ...
      { test: 'include', expected: decodeUrl(configHref('initiatePasswordResetUrl', 'signin-recovery-phone', 'reset-password', 'email', 'reset_password_confirm=false', 'email_to_hash_with=')) },
    ...
    ['text', [
      ...
      { test: 'include', expected: `If you did not authorize this action, please reset your password now at ${configUrl('initiatePasswordResetUrl', 'signin-recovery-phone', 'reset-password', 'email', 'reset_password_confirm=false', 'email_to_hash_with=')}` },
  ...
  ['postSigninRecoveryCodeEmail', new Map<string, Test | any>([
    ...
    ['html', [
      ...
      { test: 'include', expected: decodeUrl(configHref('initiatePasswordResetUrl', 'signin-recovery-code', 'reset-password', 'email', 'reset_password_confirm=false', 'email_to_hash_with=')) },
    ...
    ['text', [
      ...
      { test: 'include', expected: `If you did not authorize this action, please reset your password now at ${configUrl('initiatePasswordResetUrl', 'signin-recovery-code', 'reset-password', 'email', 'reset_password_confirm=false', 'email_to_hash_with=')}` },
  ...
  ['subscriptionSubsequentInvoiceEmail', new Map<string, Test | any>([
    ...
    ['html', [
      ...
      { test: 'notInclude', expected: `Charged ${MESSAGE_FORMATTED.invoiceTotal} on 03/20/2020` },
      { test: 'include', expected: `Next Invoice: 04/19/2020` },
      { test: 'include', expected: `View your invoice` },
      { test: 'notInclude', expected: 'utm_source=email' },
      { test: 'notInclude', expected: 'PayPal' },
  ...
  ['subscriptionUpgradeEmail', new Map<string, Test | any>([
    ...
    ['html', [
      ...
      { test: 'include', expected: `from ${MESSAGE_FORMATTED.paymentAmountOld} per ${MESSAGE.productPaymentCycleOld} to ${MESSAGE_FORMATTED.paymentAmountNew} per ${MESSAGE.productPaymentCycleNew}.` },
      { test: 'include', expected: `You have been charged a one-time fee of ${MESSAGE_FORMATTED.paymentProrated} to reflect your subscription’s higher price for the remainder of this billing period (${MESSAGE.productPaymentCycleOld}).` },
    ...
    ['html', [
      ...
      { test: 'include', expected: `from ${MESSAGE_FORMATTED.paymentAmountOld} per ${MESSAGE.productPaymentCycleOld} to ${MESSAGE_FORMATTED.paymentAmountNew} per ${MESSAGE.productPaymentCycleNew}.` },
      { test: 'notInclude', expected: `one-time fee of ${MESSAGE_FORMATTED.paymentProrated} to reflect your subscription’s higher price for the remainder of this billing period (${MESSAGE.productPaymentCycleOld}).` },
      { test: 'notInclude', expected: `one-time fee of ${MESSAGE_FORMATTED.paymentProrated} to reflect the higher charge for the remainder of this ${MESSAGE.productPaymentCycleOld}.` },
      { test: 'notInclude', expected: 'utm_source=email' },
    ]],
    ['text', [
