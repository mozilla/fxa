    ...
    },
    {
      ...
      handler: async function (request) {
        ...
        try {
          ...
          recordSecurityEvent('account.two_step_auth_change_success', {
            db,
            request,
          });
          glean.twoStepAuthChange.success(request, { uid });
          ...
          recordSecurityEvent('account.two_step_auth_change_failure', {
            db,
            request,
          });
          glean.twoStepAuthChange.failure(request, { uid });
          return {
            success: false,
          };
        }
