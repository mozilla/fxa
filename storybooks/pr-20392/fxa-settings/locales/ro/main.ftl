...
button-passkey-signin = Autentificare cu cheie de acces
button-passkey-signin-loading = Autentificare securizată…
...
pair-auth-allow-refuse-device-link = Dacă nu ai fost tu, <a>schimbă-ți parola</a>
...
signin-recovery-error = Ceva nu a funcționat. Te rugăm să te autentifici din nou în cont.
