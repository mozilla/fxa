...
describe('pbkdf2', () => {
  it(
    'pbkdf2 derive',
    () => {
      const salt = Buffer.from('identity.mozilla.com/picl/v1/first-PBKDF:andré@example.org');
  ...
  it(
    ...
    () => {
      const salt = Buffer.from('identity.mozilla.com/picl/v1/second-PBKDF:andré@example.org');
      const K2 = '5b82f146a64126923e4167a0350bb181feba61f63cb1714012b19cb0be0119c5';
