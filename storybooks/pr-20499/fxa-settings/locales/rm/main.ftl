...
link-sr-new-window = S'avra en ina nova fanestra


app-loading-spinner-aria-label-loading = Chargiar…
...
pair-auth-allow-refuse-device-link = Sche ti n'has betg fatg quai, <a>mida tes pled-clav</a>
