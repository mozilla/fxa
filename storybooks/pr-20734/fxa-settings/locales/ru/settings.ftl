...
button-passkey-signin = Войти с ключом доступа
...
button-passkey-signin-loading = Защищённый вход…
...
dark-mode-toggle-label = Переключить тему
...
cs-scope-firefox-vpn = Встроенный VPN в { -brand-firefox }
...
la-unlink-content-3 = Вы уверены, что хотите отвязать свой аккаунт? Отвязывание аккаунта не приведёт к автоматическому выходу из подключённых служб. Выход из них вам нужно будет выполнять вручную в разделе «‎Подключённые службы»‎.
...
recent-activity-account-recovery-phone-replace-complete = Телефон для восстановления изменён
recent-activity-account-recovery-phone-replace-failure = Замена телефона для восстановления не удалась
recent-activity-account-two-factor-replace-success = Двухэтапная аутентификация заменена
recent-activity-account-two-factor-replace-failure = Замена двухэтапной аутентификации не удалась
recent-activity-account-recovery-phone-setup-failed = Не удалось настроить телефон для восстановления
recent-activity-account-recovery-phone-reset-password-complete = Сброс пароля с помощью телефона для восстановления завершен
recent-activity-account-recovery-phone-reset-password-failed = Сбросить пароль с использованием телефона для восстановления не удалось
# A code was emailed to the user to authorize a sensitive account change (e.g. removing 2FA, deleting the account).
recent-activity-account-mfa-otp-sent = Запрошена авторизация на изменение аккаунта
# The user successfully entered the code emailed to authorize a sensitive account change.
recent-activity-account-mfa-otp-verified = Смена аккаунта авторизована
# The user entered an incorrect or expired code when trying to authorize a sensitive account change.
recent-activity-account-mfa-otp-failed = Ошибка авторизации изменения аккаунта
recent-activity-account-passkey-registration-success = Ключ доступа добавлен
recent-activity-account-passkey-registration-failure = Регистрация ключа доступа не удалась
recent-activity-account-passkey-removed = Ключ доступа удалён
recent-activity-account-passkey-authentication-success = Вход с ключом доступа завершён
recent-activity-account-passkey-authentication-failure = Не удалось войти с ключом доступа
recent-activity-account-passwordless-login-otp-sent = Код для беспарольного входа отправлен
recent-activity-account-passwordless-login-otp-failed = Код беспарольного входа не сработал
...
passkey-row-header = Ключи доступа
passkey-row-enabled = Включён
...
passkey-registration-canceled-link = Узнать больше
# Browser or platform does not support passkeys or the requested options (e.g., user verification, discoverable credential).
passkey-registration-error-not-supported-v2 = Браузер или устройство не поддерживают ключ доступа.
# Link label appended after passkey-registration-error-not-supported-v2, opens a SUMO support article.
passkey-registration-error-not-supported-link = Подробнее
...
passkey-registration-error-could-not-complete = Установка ключа доступа не может быть завершена. Попробуйте другой метод или устройство.
...
passkey-authentication-error-not-found = Ключ доступа не распознан. Используйте другой способ входа.
...
pair-auth-allow-refuse-device-link = Если это были не вы, <a>смените пароль</a>
...
set-password-passwordless-info = Этот пароль шифрует ваши синхронизируемые данные и обеспечивает их безопасность.
...
signin-recovery-error = Что-то пошло не так. Пожалуйста, войдите снова.
...
signin-passkey-fallback-header = Завершить вход
...
signin-passwordless-code-subheading = При использовании этого кода вход занимает всего один шаг.
# This string is used to show a notification to the user for them to enter
# email confirmation code to update their multi-factor-authentication-protected
# account settings
# Variables:
...
signin-passwordless-code-instruction =
    { $expirationMinutes ->
        [one] Введите код, отправленный на <email>{ $email }</email>, в течение { $expirationMinutes } минуты.
