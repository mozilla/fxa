...
describe('AppleIapService', () => {
  ...
  describe('processNotification', () => {
    it('returns null for not application notifications', async () => {
      ...
      jest
        .spyOn(appleIapService, 'querySubscriptionPurchase')
        .mockResolvedValue(mockPurchase as AppStoreSubscriptionPurchase);
  ...
  describe('getSubscriptions', () => {
    it('returns subscriptions', async () => {
      ...
      const result = await appleIapService.getSubscriptions(mockUserId);
      expect(result).toEqual([mockPurchase]);
    });
  });

  describe('querySubscriptionPurchase', () => {
    it('queries a subscription purchase by its bundle id and original transaction id', async () => {
      ...
      const result = await appleIapService.querySubscriptionPurchase(
        bundleId,
