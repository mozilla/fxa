...
terms-privacy-agreement-intro-3 = Ved at fortsætte accepterer du følgende:
...
terms-privacy-agreement-customized-terms = { $serviceName }: <termsLink>Tjenestevilkår</termsLink> og <privacyLink>privatlivserklæring</privacyLink>
# links to Mozilla Accounts Terms of Service and Privacy Notice, part of a bulleted list
terms-privacy-agreement-mozilla-2 = { -product-mozilla-accounts(capitalization: "uppercase") } <mozillaAccountsTos>tjenestevilkår</mozillaAccountsTos> og <mozillaAccountsPrivacy>privatlivserklæring</mozillaAccountsPrivacy>
