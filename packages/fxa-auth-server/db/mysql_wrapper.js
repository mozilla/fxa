  ...
  var client = {
    ...
    _runNextQuery: function() {
      ...
      slowQueryTimer = setTimeout(function() {
        if (++consecutiveFailures > options.max_reconnect_attempts) {
          ...
          console.log("Query taking more than " + options.max_query_time_ms + "ms!  reconnecting to mysql");
