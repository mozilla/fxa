...
# Variables
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
freeTrialEndingReminder-subject = Tu prueba gratuita de { $productName } termina pronto
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
freeTrialEndingReminder-content-greeting = Estimado cliente de { $productName }:
# Variables:
#   $serviceLastActiveDateOnly (String) - The date the free trial ends, e.g. January 20, 2016
freeTrialEndingReminder-content-trial-ending = La prueba gratuita está programada para finalizar el <strong>{ $serviceLastActiveDateOnly }</strong>.
freeTrialEndingReminder-content-trial-ending-plaintext = La prueba gratuita está programada para finalizar el { $serviceLastActiveDateOnly }.
# Variables:
#   $invoiceTotal (String) - The total amount that will be charged, e.g. $9.99
#   $serviceLastActiveDateOnly (String) - The date the charge will occur, e.g. January 20, 2016
freeTrialEndingReminder-content-auto-charge = A menos que cancelés antes de esa fecha, tu suscripción comenzará automáticamente y te cobraremos <strong>{ $invoiceTotal }</strong> en el método de pago de tu cuenta el <strong>{ $serviceLastActiveDateOnly }</strong>.
freeTrialEndingReminder-content-auto-charge-plaintext = A menos que cancelés antes de esa fecha, tu suscripción comenzará automáticamente y te cobraremos { $invoiceTotal } en el método de pago de tu cuenta el { $serviceLastActiveDateOnly }.
...
freeTrialEndingReminder-content-cancel-link = Para evitar el cobro, cancelá antes del <strong>{ $serviceLastActiveDateOnly }</strong>: <a data-l10n-name="freeTrialEndingReminder-cancel-subscription">Cancelar suscripción</a>
freeTrialEndingReminder-content-cancel-link-plaintext = Para evitar el cobro, cancelá antes del { $serviceLastActiveDateOnly }:
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
freeTrialEndingReminder-content-thanks = Gracias por probar { $productName }. Si tenés alguna pregunta sobre tu versión de prueba o suscripción, <a data-l10n-name="freeTrialEndingReminder-contact-support">contactanos</a>.
freeTrialEndingReminder-content-thanks-plaintext = Gracias por probar { $productName }. Si tenés alguna pregunta sobre tu versión de prueba o suscripción, contactanos.
...
freeTrialEndingReminder-content-support-plaintext = Contactanos: { $subscriptionSupportUrlWithUtm }
#  Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
...
# Variables
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionCancellation-freeTrial-subject = Se canceló tu prueba gratuita de { $productName }
# Variables
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
#   $trialEndDateOnly (String) - The date when the free trial ends, e.g. 01/20/2016
subscriptionCancellation-freeTrial-content = Se canceló tu prueba gratuita de { $productName }. El acceso terminará el { $trialEndDateOnly }. No se te cobrará.
# Variables:
# $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
...
subscriptionEndingReminder-content-line2-v2 = Si querés continuar usando { $productName }, podés mantenerte suscripto en <a data-l10n-name="subscriptionEndingReminder-subscription-management">Administración de suscripciones</a> antes del <strong>{ $serviceLastActiveDateOnly }</strong>. Si necesitás ayuda, <a data-l10n-name="subscriptionEndingReminder-contact-support">contactate con nuestro equipo de soporte</a>.
subscriptionEndingReminder-content-line1-plaintext = Tu acceso a { $productName } terminará el { $serviceLastActiveDateOnly }.
subscriptionEndingReminder-content-line2-plaintext-v2 = Si querés continuar usando { $productName }, podés mantenerte suscripto en Administración de suscripciones antes del { $serviceLastActiveDateOnly }. Si necesitás ayuda, contactá a nuestro equipo de soporte.
...
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-subject-2 = Tu suscripción de { $productName } fue reactivada
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-free-trial-subject = Se reactivó tu prueba gratuita de { $productName }
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-title = ¡Gracias por reactivar tu suscripción a { $productName }!
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-free-trial-title = ¡Gracias por reactivar tu prueba gratuita de { $productName }!
# Variables:
#  $invoiceTotal (String) - The amount of the subscription invoice, including currency, e.g. $10.00
...
subscriptionRenewalReminder-content-charge-with-tax-default = En ese momento, { -brand-mozilla } renovará tu suscripción y se aplicará un cargo de { $invoiceTotalExcludingTax } + { $invoiceTax } de impuestos al método de pago en tu cuenta.
# Variables
#   $invoiceTotal (String) - The amount of the subscription invoice, including currency, e.g. $10.00
...
subscriptionRenewalReminder-content-charge-invoice-total-halfyear = En ese momento, { -brand-mozilla } renovará tu suscripción semestral y se aplicará un cargo de { $invoiceTotal } al método de pago en tu cuenta.
