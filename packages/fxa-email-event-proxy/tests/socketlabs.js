    ...
    test('sqs.sendMessage was called correctly', () => {
      ...
      assert.deepEqual(message, {
        ...
        delivery: {
          ...
          smtpResponse:
            '250 2.0.0 OK 1534264537 z7-v6si7118563qta.91 - gsmtp\r\n',
        },
      });
    });
      ...
      test('result is correct', () => {
        return promise.then(result =>
          assert.deepEqual(result, {
            statusCode: 200,
            body:
              '{"result":"Processed 1 events","ValidationKey":"validation"}',
  ...
  suite('call with a correct failure event:', () => {
    ...
    setup(done => {
      promise = proxy.main({
        ...
        body:
          'Type=Failed&DateTime=Mon%2C%2013%20Aug%202018%2020%3A29%3A59%20GMT&MailingId=&MessageId=bc449116-f031-4e23-98a4-2db3c34dc0cf&Address=foo%40example.com&SecretKey=secret&FailureCode=4003&Reason=500%205.4.0%20System%20rule%20action%20set%20to%20fail%20connection.&RemoteMta=&ServerId=19796&FailureType=0&FromAddress=verification%40latest.dev.lcip.org&BounceStatus=&DiagnosticCode=',
        queryStringParameters: {
          auth: 'authentication string',
        },
      });
  ...
  suite('call with a correct complaint event:', () => {
    ...
    setup(done => {
      promise = proxy.main({
        ...
        body:
          'Type=Complaint&DateTime=Mon%2C%2001%20Oct%202012%2014%3A07%3A26%20GMT&MailingId=m012&MessageId=0000000155&Address=test%40example.com&ServerId=1000&SecretKey=secret&FblType=abuse&UserAgent=Yahoo%21-Mail-Feedback%2F1.0&From=test%40example.com&To=test%40example.com&Length=495',
        queryStringParameters: {
          auth: 'authentication string',
        },
      });
