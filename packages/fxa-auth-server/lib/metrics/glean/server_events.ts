...
class EventsServerEventLogger {
  ...
  /**
   * Record and submit a login_from_known_ip event:
   * Login from Known IP Event that indicates a user logged in from an IP address they have used before within the allowedRecency configured value.
   * Event is logged using internal mozlog logger.
   *
   * @param {string} user_agent - The user agent.
   * @param {string} ip_address - The IP address. Will be used to decode Geo
  ...
  /**
   * Record and submit a login_skip_for_new_accounts event:
   * Login Skip 2FA for New Accounts Event that indicates a user skipped 2FA because their account is new and under the maxAge configured value.
   * Event is logged using internal mozlog logger.
   *
   * @param {string} user_agent - The user agent.
   * @param {string} ip_address - The IP address. Will be used to decode Geo
