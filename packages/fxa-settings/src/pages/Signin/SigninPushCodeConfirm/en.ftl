...
signin-totp-code-recovery-code-link = Verify another way
# Error displayed in a tooltip when the form is submitted without a code
signin-totp-code-required-error = Authentication code required

signin-code-confirm-heading-w-default-service-v3 = Is this you?
signin-code-confirm-heading-w-custom-service-v3 =
signin-code-confirm-heading-w-default-service-v3 = Please approve this login from your Firefox mobile application.
signin-code-confirm-recovery-code-link-v2 = Verify another way

pair-supp-allow-heading-text = Is this you? <span>for { $email }</span>