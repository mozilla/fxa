...
const SETTINGS_V2 = {
  ...
  SECURITY: {
    ...
    TFA: {
      ...
      CHANGE_TFA:
        '#security div:nth-child(2) > div:nth-child(3) div.unit-row-actions button:nth-child(1)',
...
module.exports = {
  ...
  RECOVERY_KEY: {
    ...
    PASSWORD_INPUT: SETTINGS_V2.SECURITY.RECOVERY_KEY.PASSWORD_INPUT, // '#account-recovery-confirm-password #password',
  ...
  SETTINGS: {
    ...
    ERROR: SETTINGS_V2.SUCCESS_MESSAGE,
  },
  SETTINGS_AVATAR: {
