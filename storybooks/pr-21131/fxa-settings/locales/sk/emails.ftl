...
postRemovePasskey-subject = Prístupový kľúč bol odstránený
postRemovePasskey-preview = Prístupový kľúč bol odstránený z vášho účtu
postRemovePasskey-title = Odstránili ste svoj prístupový kľúč
postRemovePasskey-description = Na prihlásenie budete musieť použiť iný spôsob.
