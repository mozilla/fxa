 ...
 * file, You can obtain one at http://mozilla.org/MPL/2.0/. */
 ...
 export function ConnectAnotherDevicePromo() {
   return (
    <div className="my-1 flex flex-col mobileLandscape:flex-row" data-testid="connect-another-device-promo">
      <div className="flex flex-col flex-1 text-center mobileLandscape:text-left mobileLandscape:rtl:text-right">
          ...
          <p className="text-grey-300 text-xs">Find Firefox in the Google Play and App Store or
          <br/>
          <LinkExternal href="https://www.mozilla.org/en-US/firefox/mobile/"
                        className="link-blue"
                        data-testid="download-link"
          >send a download link to your device.</LinkExternal></p>
      </div>
      <div className="flex flex-2 justify-center mt-5 mobileLandscape:mt-0 mobileLandscape:justify-end mobileLandscape:rtl:justify-start">
        <LinkExternal className="self-center" data-testid="play-store-link"
        ...
        <LinkExternal className="self-center p-2" data-testid="app-store-link"
