...
subscriptionEndingReminder-content-line2 = Егер { $productName } өнімін пайдалануды жалғастырғыңыз келсе, <strong>{ $serviceLastActiveDateOnly }</strong> күніне дейін <a data-l10n-name="subscriptionEndingReminder-account-settings">Тіркелгі баптауларында</a> жазылымды қайта белсендіре аласыз. Егер көмек қажет болса, <a data-l10n-name="subscriptionEndingReminder-contact-support">қолдау көрсету тобына хабарласыңыз</a>.
