...
module.exports = () => ({
  ...
  config: {
    ...
    handler: async function (req) {
      ...
      // No fxa-db handle here to count remaining sessions. Deauthorization
      // reads that as "one remains", so a native client's row survives here
      // unless its own refresh token was the one destroyed.
