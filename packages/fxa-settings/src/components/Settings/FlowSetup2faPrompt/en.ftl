...
flow-setup-2fa-prompt-description = { $serviceName } requires you set up two-step authentication to keep your account safe.
...
flow-setup-2fa-prompt-cancel = Cancel
