...
export const Banner = forwardRef(
  (
    { type, content, animation, dismissButton, link, isFancy }: BannerProps,
    ...
    return (
      <div
        ...
        aria-describedby="banner-content"
