...
freeTrialEndingReminder-content-charge-subscription-2 = Abonnement op { $productName }
# Variables:
...
freeTrialEndingReminder-content-charge-total-2 = Totaal verschuldigd op { $serviceLastActiveDateOnly }
...
# Variables
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionCancellation-freeTrial-subject = Uw gratis proefperiode van { $productName } is opgezegd
# Variables
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
#   $trialEndDateOnly (String) - The date when the free trial ends, e.g. 01/20/2016
subscriptionCancellation-freeTrial-content = Uw gratis proefperiode van { $productName } is opgezegd. Uw toegang eindigt op { $trialEndDateOnly }. U hoeft niets te betalen.
# Variables:
# $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
...
subscriptionEndingReminder-content-line2-v2 = Als u { $productName } wilt blijven gebruiken, kunt u vóór <strong>{ $serviceLastActiveDateOnly }</strong> geabonneerd blijven in <a data-l10n-name="subscriptionEndingReminder-subscription-management">Abonnementsbeheer</a>. Als u hulp nodig hebt, <a data-l10n-name="subscriptionEndingReminder-contact-support">neem dan contact op met ons ondersteuningsteam</a>.
subscriptionEndingReminder-content-line1-plaintext = Uw toegang tot { $productName } eindigt op { $serviceLastActiveDateOnly }.
subscriptionEndingReminder-content-line2-plaintext-v2 = Als u { $productName } wilt blijven gebruiken, kunt u vóór { $serviceLastActiveDateOnly } geabonneerd blijven in Abonnementsbeheer. Neem contact op met ons ondersteuningsteam als u hulp nodig hebt.
...
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-free-trial-subject = Uw gratis proefperiode van { $productName } is opnieuw geactiveerd
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-title = Bedankt voor het opnieuw activeren van uw abonnement op { $productName }!
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-free-trial-title = Bedankt voor het opnieuw activeren van uw gratis proefperiode van { $productName }!
# Variables:
#  $invoiceTotal (String) - The amount of the subscription invoice, including currency, e.g. $10.00
...
subscriptionRenewalReminder-content-charge-with-tax-week = Op dat moment verlengt { -brand-mozilla } uw weekabonnement en wordt { $invoiceTotalExcludingTax } + { $invoiceTax } btw in rekening gebracht op de betalingsmethode van uw account.
...
subscriptionRenewalReminder-content-charge-with-tax-default = Op dat moment verlengt { -brand-mozilla } uw abonnement en wordt { $invoiceTotalExcludingTax } + { $invoiceTax } btw in rekening gebracht op de betalingsmethode van uw account.
# Variables
#   $invoiceTotal (String) - The amount of the subscription invoice, including currency, e.g. $10.00
