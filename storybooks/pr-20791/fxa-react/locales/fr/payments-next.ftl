...
cart-free-trial-mismatch-error = Votre éligibilité à l’essai gratuit a changé. Veuillez réessayer.
...
new-account-prepaid-card-free-trial-not-allowed = Les cartes prépayées ne peuvent pas être utilisées pour commencer un essai gratuit sur les nouveaux comptes. Veuillez essayer un autre moyen de paiement.
...
interstitial-offer-error-subscription-not-found-heading = Nous n’avons pas pu trouver d’abonnement actif
interstitial-offer-error-subscription-not-found-message = Il semble que cet abonnement ne soit plus actif.
interstitial-offer-error-customer-mismatch-heading = Cet abonnement n’est pas associé à votre compte
interstitial-offer-error-customer-mismatch-message = Assurez-vous d’être connecté·e avec le bon compte ou contactez l’assistance si vous avez besoin d’aide.
interstitial-offer-error-general-heading = L’offre n’est pas disponible
interstitial-offer-error-general-message = Il semble que cette offre ne soit pas disponible en ce moment.
interstitial-offer-error-button-back-to-subscriptions = Retour aux abonnements
interstitial-offer-error-button-cancel-subscription = Continuer pour annuler
interstitial-offer-error-button-sign-in = Connexion
interstitial-offer-error-button-contact-support = Contacter l’assistance
...
subscription-management-free-trial-heading = Essais gratuits
subscription-management-your-free-trials-aria = Vos essais gratuits
# Heading for mobile only quick links menu
subscription-management-jump-to-heading = Atteindre
subscription-management-nav-free-trials = Essais gratuits
...
free-trial-ineligible-notice = Votre compte n’est pas éligible pour un essai gratuit. Vous pouvez continuer avec un abonnement payant.
...
# $productName (String) - The name of the product to create subscription, e.g. Mozilla VPN
churn-cancel-flow-thanks-valued-subscriber = Merci d’utiliser { $productName } !
churn-cancel-flow-button-back-to-subscriptions = Retour aux abonnements
churn-cancel-flow-action-error = Une erreur inattendue s’est produite. Veuillez réessayer.
...
# $productName (String) - The name of the product to create subscription, e.g. Mozilla VPN
churn-cancel-flow-discount-already-applied-message = Cette remise a été appliquée à un abonnement à { $productName } sur votre compte. Si vous avez encore besoin d’aide, contactez notre équipe d’assistance.
churn-cancel-flow-button-manage-subscriptions = Gérer les abonnements
churn-cancel-flow-button-contact-support = Contacter l’assistance
...
free-trial-content-trial-expires = Votre essai gratuit expire le { $date }.
free-trial-content-trial-cancelled = Votre essai gratuit a été annulé.
...
free-trial-content-last-bill = Dernière facture • { $billedOnDate }
free-trial-content-last-bill-with-tax = { $invoiceTotal } + { $taxDue } de taxes
free-trial-content-last-bill-no-tax = { $invoiceTotal }

##

free-trial-content-link-view-invoice = Voir la facture
# $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
...
churn-error-page-title-customer-mismatch = Le bon de réduction ne peut pas être utilisé
churn-error-page-message-customer-mismatch = Ce bon de réduction a été émis pour un abonnement différent et ne peut être utilisé que par son destinataire d’origine.
churn-error-page-button-sign-in = Connexion
...
manage-payment-method-intent-error-card-declined = La transaction n’a pas pu être traitée. Veuillez vérifier les informations relatives à votre carte bancaire et réessayez.
manage-payment-method-intent-error-expired-card-error = Il semble que votre carte bancaire ait expiré. Essayez avec une autre carte.
manage-payment-method-intent-error-try-again = Hum, une erreur s’est produite lors de l’autorisation du paiement. Réessayez ou contactez l’émetteur de votre carte.
...
next-charge-with-discount-no-tax-payment-method = Vous économiserez { $discountPercent } % sur votre prochain paiement de { $nextInvoiceTotal } sur votre moyen de paiement { $paymentMethod } le { $currentPeriodEnd }.
next-charge-with-discount-no-tax = Vous économiserez { $discountPercent } % sur votre prochain paiement de { $nextInvoiceTotal } le { $currentPeriodEnd }.
...
next-charge-with-tax-payment-method = Votre prochain paiement sera de { $nextInvoiceTotal } + { $taxDue } de taxes sur votre moyen de paiement { $paymentMethod } le { $currentPeriodEnd }.
next-charge-with-tax = Votre prochain paiement sera de { $nextInvoiceTotal } + { $taxDue } de taxes le { $currentPeriodEnd }.
...
next-charge-no-tax-payment-method = Votre prochain paiement sera de { $nextInvoiceTotal } sur votre moyen de paiement { $paymentMethod } le { $currentPeriodEnd }.
