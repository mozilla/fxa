...
passwordResetAccountRecovery-action-4 = مدیریت حساب‌کاربری
passwordResetRecoveryPhone-action = مدیریت حساب‌کاربری
postAddAccountRecovery-action = مدیریت حساب‌کاربری
postAddLinkedAccount-action = مدیریت حساب‌کاربری
