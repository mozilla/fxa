...
export class SubscriptionManagementService {
  ...
  async applyStripeCouponToSubscription(args: { // right now overwrites existing discounts
    uid: string;
    subscriptionId: string;
    ...
    try {
      const updatedSubscription = await this.subscriptionManager.update(subscriptionId, {
        discounts: [{coupon: stripeCouponId}],  // this overwrites existing discounts. do we want to fetch existing discounts in addition to this one?
