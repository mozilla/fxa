...
error-payment-method-banner-title-expired-card = Spadnjena karta
error-payment-method-banner-message-add-new-card = Přidajće nowu kartu abo płaćensku metodu, zo byšće přetorhnjenje swojich abonementow wobešoł.
error-payment-method-banner-label-update-payment-method = Płaćensku metodu aktualizować
error-payment-method-expired-card = Waša karta je spadnyła. Prošu přidajće nowu kartu abo płaćensku metodu, zo byšće přetorhnjenje swojich abonementow wobešoł.
error-payment-method-banner-title-invalid-payment-information = Njepłaćiwe płaćenske informacije
error-payment-method-banner-message-account-issue = Je problem z wašim kontom.
subscription-management-button-manage-payment-method-1 = Płaćensku metodu rjadować
subscription-management-error-apple-pay = Je problem z wašim kontom { -brand-apple-pay }. Prošu rozrisajće problem, zo byšće swoje aktiwne abonementy wobchował.
subscription-management-error-google-pay = Je problem z wašim kontom { -brand-google-pay }. Prošu rozrisajće problem, zo byšće swoje aktiwne abonementy wobchował.
subscription-management-error-link = Je problem z wašim kontom { -brand-link }. Prošu rozrisajće problem, zo byšće swoje aktiwne abonementy wobchował.
...
subscription-management-error-payment-method = Je problem z wašej płaćenskej metodu. Prošu rozrisajće problem, zo byšće swoje aktiwne abonementy wobchował.
...
subscription-management-breadcrumb-payment-2 = Płaćenske metody rjadować
...
checkbox-confirm-free-trial-with-legal-links = Awtorizuju { -brand-mozilla } po <termsOfServiceLink>płaćenskich wuměnjenjach</termsOfServiceLink> a <privacyNoticeLink>rozłoženju wo škiće datow</privacyNoticeLink> swoju płaćensku metodu za podatu sumu poćežić, po tym zo testowy čas je so dnja { $endDate } skónčił, doniž swój abonement njewupowědźu.
...
free-trial-content-last-bill = Poslednja zličbowanka • { $billedOnDate }
free-trial-content-last-bill-with-tax = { $invoiceTotal } + { $taxDue } dawka
...
payment-method-management-save-default = Jako standardnu płaćensku metodu nastajić
...
plan-details-product-prorated-price = Podźělna płaćizna za { $productName }
next-plan-details-tax = Dawki a popłatki
next-plan-details-total-label = Dohromady
# "Unused time" refers to the remaining value of the current subscription that hasn't been used yet
purchase-details-unused-time-label = Dobropis za njezwužity čas
purchase-details-subtotal-label = Mjezywuslědk
# "Credit applied" refers to account credit used to reduce the amount due on the invoice
purchase-details-credit-applied-label = Dobropis je nałoženy
...
subscription-content-coupon-will-be-applied = Rabat { $promotionName } so nałoži
...
subscription-content-link-churn-intervention-terms-apply = Płaća wuměnjenja
subscription-content-link-churn-intervention-terms-aria = Kuponowe wuměnjenja a wobmjezowanja sej wobhladać
...
churn-error-page-title-customer-mismatch = Kupon njeda so wupłaćić
churn-error-page-message-customer-mismatch = Tutón kupon je so za druhi abonement wudał a da so jenož wot originalneho přijimarja wupłaćić.
...
upgrade-purchase-details-credit-to-account = Za konto wudaty dobropis
upgrade-purchase-details-credit-will-be-applied = Dobropis so na waše konto nałožuje a za přichodne zličbowanki wužiwa.
...
next-charge-with-tax-payment-method = Waše přichodne wotknihowanje budźe { $nextInvoiceTotal } + { $taxDue } dawkow za płaćensku metodu { $paymentMethod } dnja { $currentPeriodEnd }.
next-charge-with-tax = Waše přichodne wotknihowanje budźe { $nextInvoiceTotal } + dawk { $taxDue } dnja { $currentPeriodEnd }.
next-charge-no-tax-card = Waše přichodne wotknihowanje budźe { $nextInvoiceTotal } za kortu, kotraž so dnja { $currentPeriodEnd } na { $last4 } kónči.
next-charge-no-tax-payment-method = Waše přichodne wotknihowanje budźe { $nextInvoiceTotal } za płaćensku metodu { $paymentMethod } dnja { $currentPeriodEnd }.
