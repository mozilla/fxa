...
# Shown instead of -body for non-passkey flows that need keys later (e.g. the Turn-on-Sync resume of a keyless account).
signin-fallback-enter-password-body = Your password encrypts your synced data so only you can access it.
