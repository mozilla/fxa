...
postRemovePasskey-subject = Gronidłowy kluc jo se wulašował
postRemovePasskey-preview = Gronidłowy kluc jo se wótwónoźeł z wašogo konta
postRemovePasskey-title = Sćo wótwónoźeł swój gronidłowy kluc
postRemovePasskey-description = Musyśo drugu metodu za pśizjawjenje wužywaś.
postRemovePasskey-requested-from = Sćo póžedał to wót:
postRemovePasskey-action = Konto zastojaś
