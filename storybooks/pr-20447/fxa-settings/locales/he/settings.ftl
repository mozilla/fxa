...
passkey-registration-error-not-supported = מפתחות גישה אינם נתמכים כאן. נא לנסות שיטה או מכשיר אחרים.
...
passkey-authentication-error-not-supported = מפתחות גישה אינם נתמכים. נא לנסות שיטה או מכשיר אחרים.
