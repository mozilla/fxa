        ...
        /***/ function(module, exports, __webpack_require__) {
          ...
          exports.hasDefinitelyTyped = async (descriptor, configuration) => {
            ...
            try {
              ...
              return (
                ((_a = packageInfo.types) === null || _a === void 0
                  ? void 0
          ...
          function createInMemoryCache(options = { serializable: true }) {
            ...
            return {
              get(
                ...
                const miss =
                  (events && events.miss) || (() => Promise.resolve());
        ...
        /***/ function(module, exports, __webpack_require__) {
          ...
          const generateSecuredApiKey = () => {
            return (parentApiKey, restrictions) => {
              ...
              const securedKey = crypto
                ...
                .digest("hex");
              return Buffer.from(securedKey + queryParameters).toString(
                "base64"
              );
            };
          };
          ...
          const deleteObject = base => {
            return (objectID, requestOptions) => {
              return clientCommon.createWaitablePromise(
                deleteObjects(base)([objectID], requestOptions).then(
                  response => {
          ...
          const saveSynonyms = base => {
            return (synonyms, requestOptions) => {
              const { forwardToReplicas, replaceExistingSynonyms, ...options } =
                requestOptions || {};
              const mappedRequestOptions = transporter.createMappedRequestOptions(
                options
              );
