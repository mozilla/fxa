...
postAddPasskey-description = Μπορείτε πλέον να το χρησιμοποιείτε για να συνδέεστε σε όλες τις υπηρεσίες του { -product-mozilla-account(case: "gen", capitalization: "lower") } σας.
