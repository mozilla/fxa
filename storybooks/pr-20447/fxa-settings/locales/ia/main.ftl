...
link-sr-new-window = Aperi in un nove fenestra
...
button-passkey-signin = Accede con clave-contrasigno
button-passkey-signin-loading = Accedente con securitate…
...
dark-mode-toggle-label = Activar/Disactivar le thema
...
passkey-row-header = Claves-contrasigno
...
terms-privacy-agreement-intro-3 = Procedente, tu concorda con le sequente:
terms-privacy-agreement-customized-terms = { $serviceName }: <termsLink>conditiones de uso del servicio</termsLink> e <privacyLink>aviso de confidentialitate</privacyLink>
terms-privacy-agreement-mozilla-2 = { -product-mozilla-accounts(capitalization: "uppercase") }: <mozillaAccountsTos>conditiones de uso del servicio</mozillaAccountsTos> e <mozillaAccountsPrivacy>aviso de confidentialitate</mozillaAccountsPrivacy>
...
pair-auth-allow-refuse-device-link = Si non era tu, <a>cambia la contrasigno</a>
