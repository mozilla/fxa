...
postRemovePasskey-subject = Приступни кључ је обрисан
postRemovePasskey-preview = Приступни кључ је уклоњен са вашег налога
postRemovePasskey-title = Обрисали сте свој приступни кључ
postRemovePasskey-description = Мораћете да користите други начин пријаве.
postRemovePasskey-requested-from = Захтевали сте ово са:
postRemovePasskey-action = Управљајте налогом
