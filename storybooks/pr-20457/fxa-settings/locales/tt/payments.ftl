...
new-user-invalid-email-domain = Адресны язганда хата җибәрмәдегезме? { $domain } эл. почта хезмәтен күрсәтми.
...
payment-legal-copy-stripe-and-paypal-3 = { -brand-mozilla } түләүләрне хәвефсез эшкәртү өчен { -brand-name-stripe } һәм { -brand-paypal } куллана.
payment-legal-link-stripe-paypal-2 = <stripePrivacyLink>{ -brand-name-stripe }-ның хосусыйлык сәясәте</stripePrivacyLink> &nbsp; <paypalPrivacyLink>{ -brand-paypal }-ның хосусыйлык сәясәте</paypalPrivacyLink>
payment-legal-copy-paypal-2 = { -brand-mozilla } түләүләрне хәвефсез эшкәртү өчен { -brand-paypal } куллана.
payment-legal-link-paypal-3 = <paypalPrivacyLink>{ -brand-paypal } хосусыйлык сәясәте</paypalPrivacyLink>.
payment-legal-copy-stripe-3 = { -brand-mozilla } түләүләрне хәвефсез эшкәртү өчен { -brand-name-stripe } куллана.
...
price-details-no-tax-day =
    { $intervalCount ->
        [one] Көнгә { $priceAmount }
       *[other] { $intervalCount } көн саен { $priceAmount }
    }
    .title =
        { $intervalCount ->
            [one] Көнгә { $priceAmount }
...
price-details-no-tax-week =
    { $intervalCount ->
        [one] Атнага { $priceAmount }
       *[other] { $intervalCount } атна саен { $priceAmount }
    }
    .title =
        { $intervalCount ->
            [one] Атнага { $priceAmount }
...
price-details-no-tax-month =
    { $intervalCount ->
        [one] Айга { $priceAmount }
       *[other] { $intervalCount } ай саен { $priceAmount }
    }
    .title =
        { $intervalCount ->
            [one] Айга { $priceAmount }
...
price-details-no-tax-year =
    { $intervalCount ->
        [one] Елга { $priceAmount }
       *[other] { $intervalCount } ел саен { $priceAmount }
    }
    .title =
        { $intervalCount ->
            [one] Елга { $priceAmount }
...
payment-error-1 = Хмм. Түләвегезне раслаганда проблема килеп чыкты. Янәдән тырышып карагыз яки картаны чыгаручы белән элемтәгә керегез.
...
sub-route-idx-cancel-aside-2 = Сорауларыгыз бармы? <a>{ -brand-mozilla } Ярдәм</a> битен зыярат итегез
