...
link-sr-new-window = Öppnas i nytt fönster
...
terms-privacy-agreement-customized-terms = { $serviceName }: <termsLink>Användarvillkor</termsLink> och <privacyLink>Sekretesspolicy</privacyLink>
terms-privacy-agreement-mozilla-2 = { -product-mozilla-accounts(capitalization: "uppercase") }: <mozillaAccountsTos>Användarvillkor</mozillaAccountsTos> och <mozillaAccountsPrivacy>sekretesspolicy</mozillaAccountsPrivacy>
