...
import type { MeteringEventInput, SweepCandidate } from './metering.types';
...
export const MeteringWireEventFactory = (
  override?: Partial<MeteringWireEvent>
): MeteringWireEvent => ({
  id: faker.string.uuid(),
...
export const MeteringEventInputFactory = (
  override?: Partial<MeteringEventInput>
): MeteringEventInput => {
  ...
  return {
    ...
    amount: faker.number.int({ min: 1, max: 1000 }),
    eventTime: new Date('2026-05-15T11:00:00.000Z'),
    ingestedAt: new Date('2026-05-15T11:00:01.000Z'),
    ...override,
  };
};

export const SweepCandidateFactory = (
  override?: Partial<SweepCandidate>
): SweepCandidate => ({
  subject: faker.string.uuid(),
  usage: faker.number.int({ min: 1, max: 1000 }),
  ...override,
});
