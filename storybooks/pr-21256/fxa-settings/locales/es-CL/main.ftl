...
recent-activity-account-passkey-wrap-deleted = Se eliminó el acceso a sincronización para la llave de acceso
recent-activity-account-passkey-wrap-deletion-failure = Falló la eliminación del acceso a sincronización para la llave de acceso
...
passkey-row-info-link-2 = Más información
passkey-row-max-limit-banner =
    { $count ->
        [one] Has usado todas las { $count } claves de acceso. Elimina una llave de acceso para crear una nueva.
...
terms-privacy-agreement-intro-3 = Al continuar, aceptas lo siguiente:
terms-privacy-agreement-customized-terms = { $serviceName }: <termsLink>Términos de servicio</termsLink> y <privacyLink>Aviso de privacidad</privacyLink>
terms-privacy-agreement-mozilla-2 = <mozillaAccountsTos>Términos de servicio</mozillaAccountsTos> y <mozillaAccountsPrivacy>Aviso de privacidad</mozillaAccountsPrivacy> de { -product-mozilla-accounts(capitalization: "uppercase") }
...
pair-auth-allow-heading-text = ¿Acabas de conectarte en { -brand-firefox }?
pair-auth-allow-confirm-button = Sí, aprobar dispositivo
pair-auth-allow-refuse-device-link = Si no has sido tú, <a>cambia tu contraseña</a>
...
signin-recovery-error = Algo se fue a las pailas. Por favor, vuelve a conectarte.
...
signin-passwordless-code-subheading = Conectarse solo requiere un paso al usar este código.
...
signin-passwordless-code-resend-link = Enviar código nuevo por correo.
signin-passwordless-code-resend-error = Algo se fue a las pailas. No se pudo enviar un código nuevo.
signin-passwordless-code-other-account-link = Usar una cuenta diferente


signup-passwordless-code-subheading = Registrarse solo requiere un paso al usar este código.
