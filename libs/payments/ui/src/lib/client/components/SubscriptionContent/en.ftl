...
subscription-content-current-invoice-with-tax = <b>{ $invoiceTotal } + { $taxDue }</b><span>billed on { $billedOnDate }</span>
subscription-content-current-invoice-no-tax = <b> { $invoiceTotal }</b><span>billed on { $billedOnDate }</span>
subscription-content-credit-applied = <b>{ $creditApplied }</b> credit applied
subscription-content-coupon-applied = { $promotionName } applied
subscription-content-next-invoice-with-tax = Next bill of <b>{ $nextInvoiceTotal } + { $taxDue }</b> is due on <b>{ $nextBillDate }</b>
subscription-content-next-invoice-no-tax = Next bill of <b>{ $nextInvoiceTotal }</b> is due on <b>{ $nextBillDate }</b>
