...
export const BentoMenu = () => {
  ...
  const iconInvertedClassNames = classNames(iconClassNames, 'dark:invert');
  ...
  return (
    <div className="relative self-center flex mx-2" ref={bentoMenuInsideRef}>
      ...
      >
        <BentoIcon className="w-5 text-violet-900 dark:text-grey-100" />
      </button>
              ...
              <div className="w-full text-xs">
                <ul className="list-none">
                  ...
                  <li>
                    ...
                    >
                      <div className={iconInvertedClassNames}>
