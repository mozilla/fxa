...
freeTrialEndingReminder-content-cancel-link = 若要避免被收費，請在 <strong>{ $serviceLastActiveDateOnly }</strong> 前取消訂閱：<a data-l10n-name="freeTrialEndingReminder-cancel-subscription">在此取消訂閱</a>
freeTrialEndingReminder-content-cancel-link-plaintext = 若要避免被收費，請在 { $serviceLastActiveDateOnly } 前取消訂閱：
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
freeTrialEndingReminder-content-thanks = 感謝您試用 { $productName }。若您有關於試用或訂閱的任何問題，請<a data-l10n-name="freeTrialEndingReminder-contact-support">聯絡我們</a>。
freeTrialEndingReminder-content-thanks-plaintext = 感謝您試用 { $productName }。若您有關於試用或訂閱的任何問題，請聯絡我們。
freeTrialEndingReminder-content-closing = 感謝您，
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
freeTrialEndingReminder-content-signature = { $productName } 團隊
# Variables:
...
subscriptionEndingReminder-content-line2-v2 = 若您想繼續使用 { $productName }，可以在 <strong>{ $serviceLastActiveDateOnly }</strong> 之前到<a data-l10n-name="subscriptionEndingReminder-subscription-management">訂閱管理</a>繼續訂閱。若需要協助，請<a data-l10n-name="subscriptionEndingReminder-contact-support">聯絡我們的支援團隊</a>。
subscriptionEndingReminder-content-line1-plaintext = 您對 { $productName } 的使用權限將於 { $serviceLastActiveDateOnly } 結束。
subscriptionEndingReminder-content-line2-plaintext-v2 = 若您想繼續使用 { $productName }，可以在 { $serviceLastActiveDateOnly } 之前到「訂閱管理」頁面繼續訂閱。若需要協助，請聯絡我們的支援團隊。
...
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-subject-2 = 已重新啟用您的 { $productName } 訂閱
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-free-trial-subject = 已重新啟用您的 { $productName } 免費試用
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-title = 感謝您重新開始訂閱 { $productName }！
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-free-trial-title = 感謝您重新啟用 { $productName } 免費試用！
# Variables:
#  $invoiceTotal (String) - The amount of the subscription invoice, including currency, e.g. $10.00
...
subscriptionRenewalReminder-content-charge-with-tax-halfyear = 屆時，{ -brand-mozilla } 將續訂您的 6 個月訂閱方案，並對您帳號設定的付款方式收取 { $invoiceTotalExcludingTax } + { $invoiceTax } 稅。
...
subscriptionRenewalReminder-content-charge-invoice-total-halfyear = 屆時，{ -brand-mozilla } 將續訂您的 6 個月訂閱方案，並對您帳號設定的付款方式收取 { $invoiceTotal }。
