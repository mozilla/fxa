...
import { mockAppSettingsContext, mockEmail, MOCK_ACCOUNT } from '../../../models/mocks';
import { MOCK_SERVICES } from '../ConnectedServices/mocks';
import { AppSettingsContext } from 'fxa-settings/src/models';
...
const storyWithContext = (
  ...
  const story = () => (
    <LocationProvider>
      <AppSettingsContext.Provider value={mockAppSettingsContext(context)}>
        <AppLayout>
          <PageSettings />
        </AppLayout>
