...
churn-cancel-flow-error-already-canceling-message = კვლავ შეგიძლიათ გამოიყენოთ { $productName } ვადამდე { $currentPeriodEnd }.
churn-cancel-flow-error-page-button-keep-subscription = გამოწერის შენარჩუნება
...
interstitial-offer-button-cancel-subscription = განაგრძეთ გაუქმება
...
churn-cancel-flow-button-continue-to-cancel = განაგრძეთ გაუქმება
