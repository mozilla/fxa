...
-product-mozilla-account = គណនី Mozilla
-product-mozilla-accounts =
    { $capitalization ->
        [uppercase] គណនី Mozilla
       *[lowercase] គណនី Mozilla
    }
...
app-general-err-heading = កំហុសកម្មវិធីទូទៅ
app-general-err-message = មានអ្វីមួយខុសប្រក្រតី។ សូមព្យាយាមម្តងទៀតនៅពេលក្រោយ។
...
app-loading-spinner-aria-label-loading = កំពុងផ្ទុក…


app-logo-alt-3 =
    .alt = ឡូហ្គោ m { -brand-mozilla }
