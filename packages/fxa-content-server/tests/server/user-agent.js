...
const userAgent = require('../../server/lib/user-agent');

registerSuite('userAgent', {
  tests: {
    ...
    'parses a valid vulnerable-but-safe user-agent string': () => {
    ...
    'excludes unsafe input from the result': () => {
