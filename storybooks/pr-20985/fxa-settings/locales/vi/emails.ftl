...
postAddPasskey-subject = Đã tạo passkey
postAddPasskey-preview = Giờ đây bạn có thể sử dụng thiết bị của bạn để đăng nhập
postAddPasskey-title = Bạn đã tạo passkey
postAddPasskey-description = Giờ đây bạn có thể sử dụng nó để đăng nhập vào tất cả các dịch vụ { -product-mozilla-account } của bạn.
postAddPasskey-sync-note = Xin lưu ý rằng bạn vẫn cần mật khẩu để truy cập dữ liệu đồng bộ { -brand-firefox } của bạn.
# Links out to a support article about passkeys and { -brand-firefox } sync
postAddPasskey-learn-more = Tìm hiểu thêm
postAddPasskey-requested-from = Bạn đã yêu cầu điều này từ:
postAddPasskey-action = Quản lý tài khoản
...
postRemovePasskey-subject = Đã xoá passkey
postRemovePasskey-preview = Một passkey đã xoá khỏi tài khoản của bạn
postRemovePasskey-title = Bạn đã xoá passkey của bạn
postRemovePasskey-description = Bạn sẽ cần sử dụng phương thức khác để đăng nhập.
postRemovePasskey-requested-from = Bạn đã yêu cầu điều này từ:
postRemovePasskey-action = Quản lý tài khoản
