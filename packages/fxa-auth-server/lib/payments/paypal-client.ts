...
export class PayPalClient {
   ...
   * Although the API is extensive, we only need a very limited set of inputs.
   *
   * TODO
   * - There are additional parameters required for a digital good
   *
   * @param {string} amt - The amount to charge as a string e.g. "15.99"
