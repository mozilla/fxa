...
# Variables
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
freeTrialEndingReminder-subject = Waša dermotna testowa wersija { $productName } se skóro skóńcyjo
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
...
freeTrialEndingReminder-content-charge-tax-2 = Dank
# Variables:
#   $serviceLastActiveDateOnly (String) - The date the charge will occur, e.g. January 20, 2016
...
freeTrialEndingReminder-content-charge-total-2 = Dogromady płaśobny dnja { $serviceLastActiveDateOnly }
...
freeTrialEndingReminder-content-cancel-link = Aby se wobśěženja wobinuł, wupowěźejśo do <strong>{ $serviceLastActiveDateOnly }</strong>: <a data-l10n-name="freeTrialEndingReminder-cancel-subscription">Abonement wupowěźeś</a>
...
freeTrialEndingReminder-content-support-plaintext = Stajśo se z nami do zwiska: { $subscriptionSupportUrlWithUtm }
#  Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
...
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-free-trial-subject = Waša dermotna testowa wersija { $productName } jo se reaktiwěrowała
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-title = Wjeliki źěk, až sćo zasej zaktiwěrował swój abonement { $productName }!
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-free-trial-title = Wjeliki źěk, až sćo reaktiwěrował swóju dermotnu testowu wersiju { $productName }!
# Variables:
#  $invoiceTotal (String) - The amount of the subscription invoice, including currency, e.g. $10.00
