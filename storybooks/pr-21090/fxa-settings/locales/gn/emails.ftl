...
automated-email-sign-in =
    Kóva ha’e ñandutiveve ijeheguíva; neremomeĩriramo, upéicharamo <a data-l10n-name="securitySettingsLink">emoambue ne ñe’ẽñemi</a>.
    Eñemomaranduve hag̃ua, ikatúpa eikemi <a data-l10n-name="supportLink">{ -brand-mozilla } oipytyvõva</a>.
...
postAddPasskey-sync-note = Eikuaáke upe ne ñe’ẽñemi tekotevẽtaha eike hag̃ua ne mba’ekuaarã { -brand-firefox } ñembohekópe.
...
postRemovePasskey-subject = Ñe’ẽ ñemi jeikeha oguéma
postRemovePasskey-preview = Ñe’ẽ ñemi jeikeha oguéma ne mba’etégui
postRemovePasskey-title = Emboguéma ñe’ẽ ñemi jeikeha
postRemovePasskey-description = Eiporuva’erã ambue mba’e eikekuaa hag̃ua.
postRemovePasskey-requested-from = Nde ejerure ko myanyhẽha:
postRemovePasskey-action = Eñangareko mba’etére
