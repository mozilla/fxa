...
passkey-registration-error-not-supported = Рұқсат кілттері осында қолжетімді емес. Басқа тәсілді немесе құрылғыны қолданып көріңіз.
...
passkey-authentication-error-not-supported = Рұқсат кілттеріне қолдау жоқ. Басқа тәсілді немесе құрылғыны қолданып көріңіз.
