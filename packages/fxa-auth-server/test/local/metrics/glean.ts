...
const recordTwoFactorAuthSetupVerifySuccessStub = sinon.stub();
...
const recordPasswordResetRecoveryPhoneCodeSentStub = sinon.stub();
const recordPasswordResetRecoveryPhoneCodeSendErrorStub = sinon.stub();
...
const recordLoginFromKnownIp = sinon.stub();
const recordLoginSkipForNewAccounts = sinon.stub();
  ...
  './server_events': {
    ...
    createEventsServerEventLogger: () => ({
      ...
      recordTwoFactorAuthSetupVerifySuccess:
        recordTwoFactorAuthSetupVerifySuccessStub,
      ...
      recordPasswordResetRecoveryPhoneCodeSent:
        recordPasswordResetRecoveryPhoneCodeSentStub,
      recordPasswordResetRecoveryPhoneCodeSendError:
        recordPasswordResetRecoveryPhoneCodeSendErrorStub,
      recordPasswordResetRecoveryPhoneCodeComplete:
        recordPasswordResetRecoveryPhoneCodeCompleteStub,
      recordTwoStepAuthPhoneReplaceSuccess:
        recordTwoStepAuthPhoneReplaceSuccess,
      recordTwoStepAuthPhoneReplaceFailure:
        recordTwoStepAuthPhoneReplaceFailure,
      recordLoginFromKnownIp: recordLoginFromKnownIp,
      recordLoginSkipForNewAccounts: recordLoginSkipForNewAccounts,
    }),
  },
});
