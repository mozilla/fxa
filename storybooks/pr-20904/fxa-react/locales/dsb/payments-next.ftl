...
loyalty-discount-terms-contact-support-product-aria = Pomoc za { $productName } kontaktěrowaś
not-found-page-title-terms = Bok njejo se namakał
not-found-page-description-terms = Bok, kótaryž pytaśo, njeeksistěrujo.
not-found-page-button-terms-manage-subscriptions = Abonementy zastojaś
...
error-page-account-not-found-heading = Konto njejo se namakało
error-page-account-not-found-message = Konto, kótarež jo z wašym pósejźenim zwězane, njeeksistěrujo. Pšosym wužywajśo druge konto abo załožćo nowe, aby aboněrował.
error-page-account-not-found-continue-button = Dalej
# $productName (String) - The name of the product to create subscription, e.g. Mozilla VPN
...
subscription-management-error-link = Dajo problem z wašym kontom{ -brand-link }. Pšosym rozwěžćo problem, aby swóje aktiwne abonementy wobchował.
...
subscription-management-error-payment-method = Dajo problem z wašeju płaśeńskeju metodu. Pšosym rozwěžćo problem, aby swóje aktiwne abonementy wobchował.
...
free-trial-ineligible-notice = Wašo konto njedajo se za dermotny test wubraś. Móžośo ze zapłaśonym abonementom pókšacowaś.
...
free-trial-content-button-cancel-subscription = Abonement wupowěźeś
free-trial-content-button-cancel-subscription-aria = Abonement za { $productName } wupowěźeś
...
next-coupon-error-cannot-redeem = Kod, kótaryž sćo zapódał, njedajo se slědk wześ – wašo konto ma pjerwjejšny abonement jadnogo z našych słužbow.
next-coupon-error-expired = Zapódany kod jo spadnuł.
next-coupon-error-generic = Pśi pśeźěłowanju koda jo zmólka nastała. Pšosym wopytajśo hyšći raz.
...
next-charge-with-discount-no-tax-card = Zažarijośo { $discountPercent } % pśi swójom pśiducem wótpisanju { $nextInvoiceTotal } za kórtu, kótaraž se dnja { $currentPeriodEnd } na { $last4 } kóńcy.
next-charge-with-discount-no-tax-payment-method = Zažarijośo { $discountPercent } % pśi swójom pśiducem wótpisanju { $nextInvoiceTotal } za swóju płaśeńsku metodu { $paymentMethod } dnja { $currentPeriodEnd }.
next-charge-with-discount-no-tax = Zažarijośo { $discountPercent } % pśi swójom pśiducem wótpisanju { $nextInvoiceTotal } dnja { $currentPeriodEnd }.
next-charge-with-tax-card = Wašo pśiduce wótpisanje buźo { $nextInvoiceTotal } + { $taxDue } dankow za kórtu dnja { $currentPeriodEnd }, kótaraž se na { $last4 } kóńcy.
next-charge-with-tax-payment-method = Wašo pśiduce wótpisanje buźo { $nextInvoiceTotal } + { $taxDue } dankow za płaśeńsku metodu { $paymentMethod } dnja { $currentPeriodEnd }.
next-charge-with-tax = Wašo pśiduce wótpisanje buźo { $nextInvoiceTotal } + { $taxDue } dankow dnja { $currentPeriodEnd }.
next-charge-no-tax-card = Wašo pśiduce wótpisanje buźo { $nextInvoiceTotal } za kórtu dnja { $currentPeriodEnd }, kótaraž se na { $last4 } kóńcy.
next-charge-no-tax-payment-method = Wašo pśiduce wótpisanje buźo { $nextInvoiceTotal } za płaśeńsku metodu { $paymentMethod } dnja { $currentPeriodEnd }.
next-charge-no-tax = Wašo pśiduce wótpisanje buźo { $nextInvoiceTotal } dnja { $currentPeriodEnd }.
