...
import { LocalizerClient } from '@fxa/shared/l10n';
...
describe('EmailTemplateManager', () => {
  ...
  beforeEach(async () => {
    const moduleRef = await Test.createTestingModule({
      providers: [
        { provide: LocalizerClient, useValue: mockLocalizerClient },
