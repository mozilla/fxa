...
import { PaymentSection, SignInForm } from '@fxa/payments/ui';
import {
  getApp,
  CheckoutParams,
  SupportedPages,
      ...
      {!session && (
        <>
          ...
          <div className="flex flex-col gap-4 mt-6 mb-10 desktop:flex-row desktop:items-center desktop:justify-center">
            <button className="w-full flex items-center justify-center bg-[#F9F9FA] border border-grey-300 font-medium rounded text-sm">
