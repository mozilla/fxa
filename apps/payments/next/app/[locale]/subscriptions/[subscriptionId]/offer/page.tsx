    ...
    >
        <div className="w-full max-w-[480px] flex flex-col justify-center items-center p-10 tablet:bg-white tablet:rounded-xl tablet:border tablet:border-grey-200 tablet:shadow-[0_0_16px_0_rgba(0,0,0,0.08)]">
          <div className="w-full flex flex-col items-center gap-6 text-center">
            <div className="flex items-center justify-center w-20 h-20 aspect-square p-2">
          ...
          <div className="w-full flex flex-col gap-3 mt-12 items-center self-stretch">
            <Link
              className="border box-border font-header h-14 items-center justify-center rounded-md text-white text-center py-4 px-6 bg-blue-500 hover:bg-blue-700 flex w-full min-w-64"
            ...
            <Link
              className="border box-border font-header h-14 items-center justify-center rounded-md text-center py-4 px-6 bg-grey-10 border-grey-200 hover:bg-grey-50 flex w-full min-w-64"
