...
upgrade-page-acknowledgment-from-trial = Με την αναβάθμιση, η ενεργή δωρεάν δοκιμαστική περίοδος θα λήξει αμέσως και θα χρεωθείτε για το νέο σας πρόγραμμα σήμερα.
...
diners-logo-alt-text2 = Λογότυπο { -brand-diners }
...
interstitial-offer-error-button-sign-in = Σύνδεση
interstitial-offer-error-button-contact-support = Επικοινωνία με την υποστήριξη
...
subscription-management-free-trial-heading = Δωρεάν δοκιμές
subscription-management-your-free-trials-aria = Οι δωρεάν δοκιμές σας
# Heading for mobile only quick links menu
subscription-management-jump-to-heading = Μετάβαση σε
subscription-management-nav-free-trials = Δωρεάν δοκιμές
...
subscription-management-error-payment-method = Υπάρχει πρόβλημα με τη μέθοδο πληρωμής σας. Επιλύστε το ζήτημα για να διατηρήσετε τις ενεργές συνδρομές σας.
...
cancel-subscription-button-keep-subscription = Διατήρηση συνδρομής
...
churn-cancel-flow-button-cancel-subscription = Ακύρωση συνδρομής
...
free-trial-content-last-bill = Τελευταίος λογαριασμός • { $billedOnDate }
free-trial-content-last-bill-with-tax = { $invoiceTotal } + { $taxDue } (φόρος)
free-trial-content-last-bill-no-tax = { $invoiceTotal }

##

free-trial-content-link-view-invoice = Προβολή παραστατικού
# $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
...
interstitial-offer-button-keep-subscription = Διατήρηση συνδρομής
...
churn-error-page-title-customer-mismatch = Δεν είναι δυνατή η εξαργύρωση του κουπονιού
churn-error-page-message-customer-mismatch = Αυτό το κουπόνι εκδόθηκε για άλλη συνδρομή και μπορεί να εξαργυρωθεί μόνο από τον αρχικό παραλήπτη.
churn-error-page-button-sign-in = Σύνδεση
...
next-coupon-error-expired = Ο κωδικός που καταχωρίσατε έχει λήξει.
next-coupon-error-generic = Προέκυψε σφάλμα κατά την επεξεργασία του κωδικού. Δοκιμάστε ξανά.
next-coupon-error-invalid = Ο κωδικός που καταχωρίσατε δεν είναι έγκυρος.
# "Limit" refers to the maximum number of times a coupon can be redeemed.
next-coupon-error-limit-reached = Ο κωδικός που καταχωρίσατε έχει φτάσει το όριό του.
...
next-charge-with-discount-and-tax-card = Θα εξοικονομήσετε { $discountPercent }% στην επόμενη χρέωση των { $nextInvoiceTotal } (+ { $taxDue } φόρος), που θα πραγματοποιηθεί στις { $currentPeriodEnd } μέσω της κάρτας που λήγει σε { $last4 }.
next-charge-with-discount-and-tax-payment-method = Θα εξοικονομήσετε { $discountPercent }% στην επόμενη χρέωση των { $nextInvoiceTotal } (+ { $taxDue } φόρος), που θα πραγματοποιηθεί στις { $currentPeriodEnd } μέσω της μεθόδου πληρωμής { $paymentMethod }.
next-charge-next-charge-with-discount-and-tax = Θα εξοικονομήσετε { $discountPercent }% στην επόμενη χρέωση των { $nextInvoiceTotal } (+ { $taxDue } φόρος), που θα πραγματοποιηθεί στις { $currentPeriodEnd }.
next-charge-with-discount-no-tax-card = Θα εξοικονομήσετε { $discountPercent }% στην επόμενη χρέωση των { $nextInvoiceTotal }, που θα πραγματοποιηθεί στις { $currentPeriodEnd } μέσω της κάρτας που λήγει σε { $last4 }.
next-charge-with-discount-no-tax-payment-method = Θα εξοικονομήσετε { $discountPercent }% στην επόμενη χρέωση των { $nextInvoiceTotal }, που θα πραγματοποιηθεί στις { $currentPeriodEnd } μέσω της μεθόδου πληρωμής { $paymentMethod }.
next-charge-with-discount-no-tax = Θα εξοικονομήσετε { $discountPercent }% στην επόμενη χρέωση των { $nextInvoiceTotal }, που θα πραγματοποιηθεί στις { $currentPeriodEnd }.
next-charge-with-tax-card = Η επόμενη χρέωση θα είναι { $nextInvoiceTotal } (+ { $taxDue } φόρος) και θα πραγματοποιηθεί στις { $currentPeriodEnd } μέσω της κάρτας που λήγει σε { $last4 }.
next-charge-with-tax-payment-method = Η επόμενη χρέωση θα είναι { $nextInvoiceTotal } (+ { $taxDue } φόρος) και θα πραγματοποιηθεί στις { $currentPeriodEnd } μέσω της μεθόδου πληρωμής { $paymentMethod }.
next-charge-with-tax = Η επόμενη χρέωση θα είναι { $nextInvoiceTotal } (+ { $taxDue } φόρος) στις { $currentPeriodEnd }.
next-charge-no-tax-card = Η επόμενη χρέωση θα είναι { $nextInvoiceTotal } και θα πραγματοποιηθεί στις { $currentPeriodEnd } μέσω της κάρτας που λήγει σε { $last4 }.
next-charge-no-tax-payment-method = Η επόμενη χρέωση θα είναι { $nextInvoiceTotal } και θα πραγματοποιηθεί στις { $currentPeriodEnd } μέσω της μεθόδου πληρωμής { $paymentMethod }.
