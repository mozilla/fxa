...
subscriptionRenewalReminder-content-charge-with-tax-week = 届时，{ -brand-mozilla } 将续订您的周付订阅，并向您账户所设置的付款方式收取 { $invoiceTotalExcludingTax } + 税费 { $invoiceTax }。
subscriptionRenewalReminder-content-charge-with-tax-month = 届时，{ -brand-mozilla } 将续订您的月付订阅，并向您账户所设置的付款方式收取 { $invoiceTotalExcludingTax } + 税费 { $invoiceTax }。
subscriptionRenewalReminder-content-charge-with-tax-halfyear = 届时，{ -brand-mozilla } 将续订您的半年付订阅，并向您账户所设置的付款方式收取 { $invoiceTotalExcludingTax } + 税费 { $invoiceTax }。
subscriptionRenewalReminder-content-charge-with-tax-year = 届时，{ -brand-mozilla } 将续订您的年付订阅，并向您账户所设置的付款方式收取 { $invoiceTotalExcludingTax } + 税费 { $invoiceTax }。
subscriptionRenewalReminder-content-charge-with-tax-default = 届时，{ -brand-mozilla } 将续订您的订阅，并向您账户所设置的付款方式收取 { $invoiceTotalExcludingTax } + 税费 { $invoiceTax }。
# Variables
#   $invoiceTotal (String) - The amount of the subscription invoice, including currency, e.g. $10.00
