...
export default class AuthClient {
   ...
   * @param options.skipRecoveryCodes - When true, do not generate recovery codes
   * @param headers - Optional additional request headers
   * @returns Promise resolving to `{ qrCodeUrl, secret, recoveryCodes }`
   */
   ...
   * prefer the MFA JWT variant.
   *
   * @see verifyTotpSetupCodeWithJwt
   *
   * @param sessionToken - Verified session token for the signed-in user
