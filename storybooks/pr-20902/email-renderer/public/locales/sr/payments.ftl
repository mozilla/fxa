...
brand-name-mozilla-logo = Логотип { -brand-mozilla }-а

## Component - NewUserEmailForm

new-user-sign-in-link-2 = Већ имате { -product-mozilla-account }? <a>Пријавите се</a>
...
new-user-subscribe-product-updates-mozilla = Желео бих да примам вести о производима и ажурирања од { -brand-mozilla }
new-user-subscribe-product-updates-snp = Желео бих да примам вести о безбедности и приватности и ажурирања од { -brand-mozilla }
new-user-subscribe-product-updates-hubs = Желео бих да примам вести о производима и ажурирања од { -product-mozilla-hubs } и { -brand-mozilla }
new-user-subscribe-product-updates-mdnplus = Желео бих да примам вести о производима и ажурирања од { -product-mdn-plus } и { -brand-mozilla }
...
payment-confirm-with-legal-links-static-3 = Овлашћујем { -brand-mozilla } да терети мој начин плаћања за приказани износ, у складу са <termsOfServiceLink>Условима коришћења</termsOfServiceLink> и <privacyNoticeLink>Обавештењем о приватности</privacyNoticeLink>, све док не откажем своју претплату.
...
# $productName (String) - The name of the subscribed product.
iap-upgrade-already-subscribed-2 = Већ имате { $productName } претплату преко { -brand-google } или { -brand-apple } продавница апликација.
...
payment-pay-with-paypal-btn-2 = Плати путем { -brand-paypal }
payment-validate-name-error = Унесите ваше име

## Component - PaymentLegalBlurb

payment-legal-copy-stripe-and-paypal-3 = { -brand-mozilla } користи { -brand-name-stripe } и { -brand-paypal } за безбедну обраду плаћања.
payment-legal-link-stripe-paypal-2 = <stripePrivacyLink>Политика приватности за { -brand-name-stripe }</stripePrivacyLink> &nbsp; <paypalPrivacyLink>Политика приватности за { -brand-paypal }</paypalPrivacyLink>
payment-legal-copy-paypal-2 = { -brand-mozilla } користи { -brand-paypal } за безбедну обраду плаћања.
payment-legal-link-paypal-3 = <paypalPrivacyLink>Политика приватности за { -brand-paypal }</paypalPrivacyLink>
payment-legal-copy-stripe-3 = { -brand-mozilla } користи { -brand-name-stripe } за безбедну обраду плаћања.
...
pay-with-heading-paypal-2 = Плати путем { -brand-paypal }
...
location-unsupported = Ваша тренутна локација није подржана према нашим Условима коришћења.
...
product-location-unsupported-error = Локација није подржана
...
new-user-step-1-2 = 1. Направите { -product-mozilla-account }
...
brand-name-google-play-2 = { -google-play } продавница
...
sub-update-acknowledgment =
    Ваш план ће се одмах променити и данас ће вам бити наплаћен сразмеран
    износ за остатак овог обрачунског циклуса. Почев од { $startingDate }
...
sub-update-prorated-upgrade = Сразмерна надоградња
...
sub-update-new-plan-daily = { $productName } (дневно)
sub-update-new-plan-weekly = { $productName } (недељно)
sub-update-new-plan-monthly = { $productName } (месечно)
sub-update-new-plan-yearly = { $productName } (годишње)
sub-update-prorated-upgrade-credit = Приказани негативни салдо ће бити примењен као заслуга на ваш налог и коришћен за будуће рачуне.
...
sub-promo-coupon-applied = { $promotion_name } купон је примењен: <priceDetails></priceDetails>
subscription-management-account-credit-balance = Ова уплата претплате је резултирала заслугом на стање вашег налога: <priceDetails></priceDetails>
...
sub-route-idx-cancel-aside-2 = Имате питања? Посетите <a>{ -brand-mozilla } подршку</a>.
...
sub-next-bill-due-date = Следећи рачун доспева { $date }
...
sub-route-payment-modal-message-2 = Изгледа да постоји грешка са вашим { -brand-paypal } налогом, потребно је да предузмете неопходне кораке како бисте решили овај проблем са плаћањем.
...
sub-iap-item-google-purchase-2 = { -brand-google }: куповина унутар апликације
sub-iap-item-apple-purchase-2 = { -brand-apple }: куповина унутар апликације
