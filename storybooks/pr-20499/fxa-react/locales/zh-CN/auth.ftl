...
freeTrialEndingReminder-content-trial-ending = 您的免费试用将于 <strong>{ $serviceLastActiveDateOnly }</strong> 结束。
freeTrialEndingReminder-content-trial-ending-plaintext = 您的免费试用将于 { $serviceLastActiveDateOnly } 结束。
# Variables:
#   $invoiceTotal (String) - The total amount that will be charged, e.g. $9.99
#   $serviceLastActiveDateOnly (String) - The date the charge will occur, e.g. January 20, 2016
freeTrialEndingReminder-content-auto-charge = 您的订阅将自动开始，并于 <strong>{ $serviceLastActiveDateOnly }</strong> 向您账户所设置的付款方式收取 <strong>{ $invoiceTotal }</strong>，除非您在此之前取消。
freeTrialEndingReminder-content-auto-charge-plaintext = 您的订阅将自动开始，并于 { $serviceLastActiveDateOnly } 向您账户所设置的付款方式收取 { $invoiceTotal }，除非您在此之前取消。
freeTrialEndingReminder-content-charge-heading = 费用详情
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
#   $invoiceSubtotal (String) - The subtotal amount of the subscription, e.g. $12.99
freeTrialEndingReminder-content-charge-subscription = { $productName } 订阅：{ $invoiceSubtotal }
freeTrialEndingReminder-content-charge-subscription-2 = { $productName } 订阅
# Variables:
...
freeTrialEndingReminder-content-charge-tax = 税款：{ $invoiceTaxAmount }
freeTrialEndingReminder-content-charge-tax-2 = 税款
# Variables:
#   $serviceLastActiveDateOnly (String) - The date the charge will occur, e.g. January 20, 2016
#   $invoiceTotal (String) - The total amount due, e.g. $9.99
freeTrialEndingReminder-content-charge-total = { $serviceLastActiveDateOnly } 总计收取：{ $invoiceTotal }
freeTrialEndingReminder-content-charge-total-2 = { $serviceLastActiveDateOnly } 的应付总计
freeTrialEndingReminder-content-account-link = 您可以在<a data-l10n-name="freeTrialEndingReminder-update-billing">此处</a>检查或更新您的付款方式和账户信息。
freeTrialEndingReminder-content-account-link-plaintext = 您可以在此处检查或更新您的付款方式和账户信息：
# Variables:
#   $serviceLastActiveDateOnly (String) - The date the trial ends, e.g. January 20, 2016
freeTrialEndingReminder-content-cancel-link = 为避免收费，请于 <strong>{ $serviceLastActiveDateOnly }</strong> 前取消：<a data-l10n-name="freeTrialEndingReminder-cancel-subscription">取消订阅</a>
freeTrialEndingReminder-content-cancel-link-plaintext = 为避免收费，请于 { $serviceLastActiveDateOnly } 前取消：
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
...
subscriptionCancellation-freeTrial-content = 您的 { $productName } 免费试用已取消。您的访问权限将于 { $trialEndDateOnly } 终止。我们不会向您收费。
# Variables:
# $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
...
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
#   $serviceLastActiveDateOnly (String) - The date of last active service, e.g. 01/20/2016
subscriptionEndingReminder-content-line1 = <strong>{ $serviceLastActiveDateOnly }</strong> 后，您的 { $productName } 服务将结束。
subscriptionEndingReminder-content-line2-v2 = 若您希望继续使用 { $productName }，请于 <strong>{ $serviceLastActiveDateOnly }</strong> 前，在<a data-l10n-name="subscriptionEndingReminder-subscription-management">订阅管理</a>中延续订阅。如需协助，请<a data-l10n-name="subscriptionEndingReminder-contact-support">联系支持团队</a>。
subscriptionEndingReminder-content-line1-plaintext = 您对 { $productName } 的使用权限将于 { $serviceLastActiveDateOnly } 结束。
subscriptionEndingReminder-content-line2-plaintext-v2 = 若您希望继续使用 { $productName }，请于 { $serviceLastActiveDateOnly } 前，在订阅管理中延续订阅。如需协助，请联系支持团队。
...
subscriptionRenewalReminder-content-charge-with-tax-day = 届时，{ -brand-mozilla } 将续订您的日付订阅，并向您账户所设置的付款方式收取 { $invoiceTotalExcludingTax } + 税款 { $invoiceTax }。
subscriptionRenewalReminder-content-charge-with-tax-week = 届时，{ -brand-mozilla } 将续订您的周付订阅，并向您账户所设置的付款方式收取 { $invoiceTotalExcludingTax } + 税款 { $invoiceTax }。
subscriptionRenewalReminder-content-charge-with-tax-month = 届时，{ -brand-mozilla } 将续订您的月付订阅，并向您账户所设置的付款方式收取 { $invoiceTotalExcludingTax } + 税款 { $invoiceTax }。
subscriptionRenewalReminder-content-charge-with-tax-halfyear = 届时，{ -brand-mozilla } 将续订您的半年付订阅，并向您账户所设置的付款方式收取 { $invoiceTotalExcludingTax } + 税款 { $invoiceTax }。
subscriptionRenewalReminder-content-charge-with-tax-year = 届时，{ -brand-mozilla } 将续订您的年付订阅，并向您账户所设置的付款方式收取 { $invoiceTotalExcludingTax } + 税款 { $invoiceTax }。
subscriptionRenewalReminder-content-charge-with-tax-default = 届时，{ -brand-mozilla } 将续订您的订阅，并向您账户所设置的付款方式收取 { $invoiceTotalExcludingTax } + 税款 { $invoiceTax }。
# Variables
#   $invoiceTotal (String) - The amount of the subscription invoice, including currency, e.g. $10.00
subscriptionRenewalReminder-content-charge-invoice-total-day = 届时，{ -brand-mozilla } 将续订您的日付订阅，并向您账户所设置的付款方式收取 { $invoiceTotal }。
subscriptionRenewalReminder-content-charge-invoice-total-week = 届时，{ -brand-mozilla } 将续订您的周付订阅，并向您账户所设置的付款方式收取 { $invoiceTotal }。
subscriptionRenewalReminder-content-charge-invoice-total-month = 届时，{ -brand-mozilla } 将续订您的月付订阅，并向您账户所设置的付款方式收取 { $invoiceTotal }。
subscriptionRenewalReminder-content-charge-invoice-total-halfyear = 届时，{ -brand-mozilla } 将续订您的半年付订阅，并向您账户所设置的付款方式收取 { $invoiceTotal }。
subscriptionRenewalReminder-content-charge-invoice-total-year = 届时，{ -brand-mozilla } 将续订您的年付订阅，并向您账户所设置的付款方式收取 { $invoiceTotal }。
subscriptionRenewalReminder-content-charge-invoice-total-default = 届时，{ -brand-mozilla } 将续订您的订阅，并向您账户所设置的付款方式收取 { $invoiceTotal }。
...
subscriptionReplaced-content-credit = 上个订阅中未使用的天数将以余额形式返还至您的账户。余额将自动添加到您的账户，并抵扣将来的费用。
