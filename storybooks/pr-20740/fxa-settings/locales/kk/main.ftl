...
link-sr-new-window = Жаңа терезеде ашылады
...
button-passkey-signin = Рұқсат кілтімен кіру
button-passkey-signin-loading = Қауіпсіз кіру…
...
dark-mode-toggle-label = Теманы ауыстыру
...
cs-scope-firefox-vpn = { -brand-firefox } құрамындағы VPN
...
flow-setup-2a-qr-instruction = <strong>1-қадам:</strong> Duo немесе Google Authenticator сияқты кез келген аутентификация қолданбасын пайдаланып, осы QR кодын сканерлеңіз.
flow-setup-2fa-qr-alt-text =
    .alt = Екі сатылы аутентификацияны орнатуға арналған QR коды. Оны сканерлеңіз немесе құпия кілтті орнату үшін «QR кодын сканерлеу мүмкін емес пе?» таңдаңыз.
...
flow-setup-2fa-manual-key-instruction = <strong>1-қадам:</strong> Бұл кодты қалаған аутентификация қолданбаңызға енгізіңіз.
...
flow-setup-2fa-step-2-instruction = <strong>2-қадам:</strong> Аутентификация қолданбасынан кодты енгізіңіз.
flow-setup-2fa-input-label = 6-цифрлық кодты енгізіңіз
flow-setup-2fa-code-error = Жарамсыз немесе мерзімі өткен код. Аутентификация қолданбасын тексеріп, қайталап көріңіз.


flow-setup-2fa-backup-choice-heading = Қалпына келтіру тәсілін таңдаңыз
flow-setup-2fa-backup-choice-description = Бұл мобильді құрылғыңызға немесе аутентификация қолданбасына қол жеткізу мүмкін емес кезде жүйеге кіруге мүмкіндік береді.
flow-setup-2fa-backup-choice-phone-title = Қалпына келтіру телефоны
flow-setup-2fa-backup-choice-phone-badge = Ең оңай
flow-setup-2fa-backup-choice-phone-info = Қалпына келтіру кодын SMS арқылы алу. Қазіргі уақытта АҚШ пен Канадада қолжетімді.
...
flow-setup-2fa-backup-code-confirm-confirm-saved = Кодтарды сақтағаныңызды растау үшін біреуін енгізіңіз. Бұл кодтарсыз аутентификация қолданбасы болмаса, жүйеге кіре алмауыңыз мүмкін.
...
flow-setup-2fa-inline-complete-success-banner-description = Барлық қосылған құрылғыларыңызды қорғау үшін, осы тіркелгіні пайдаланып жатқан барлық жерде жүйеден шығып, жаңа екі сатылы аутентификацияны пайдаланып қайта кіруіңіз керек.
...
modal-mfa-protected-subtitle = Тіркелгі ақпаратыңызды өзгертіп жатқан адам өзіңіз екеніңізге көз жеткізуге көмектесіңіз
modal-mfa-protected-instruction =
    { $expirationTime ->
        [one] <email>{ $email }</email> адресіне жіберілген кодты { $expirationTime } минут ішінде енгізіңіз.
       *[other] <email>{ $email }</email> адресіне жіберілген кодты { $expirationTime } минут ішінде енгізіңіз.
    }
...
page-2fa-change-totpinfo-error = Екі сатылы аутентификация қолданбасын ауыстыру кезінде қате орын алды. Кейінірек қайталап көріңіз.
page-2fa-change-qr-instruction = <strong>1-қадам:</strong> Duo немесе Google Authenticator сияқты кез келген аутентификация қолданбасын пайдаланып, осы QR кодын сканерлеңіз. Бұл жаңа қосылым жасайды, ескі қосылымдар енді жұмыс істемейді.
...
tfa-replace-code-confirm-description = Кодтардың бірін енгізіп, оларды сақтағаныңызды растаңыз. Бұл қадамды аяқтаған соң, бұрынғы сақтық көшірме аутентификация кодтарыңыз сөндіріледі.
...
delete-account-delete-button-passwordless = Тіркелгіні өшіру
...
page-passkey-add-creating-heading = Рұқсат кілті жасалуда…
page-passkey-add-follow-prompts = Құрылғыңыздағы нұсқауларды орындаңыз.
page-passkey-add-cancel = Бас тарту


page-passkey-add-success = Рұқсат кілті жасалды
page-passkey-add-error-system-v2 = Рұқсат кілтіңізді жасау кезінде қате орын алды. Кейінірек қайталап көріңіз.
...
verify-secondary-email-resend-code-button = Растау кодын қайта жіберу
...
tfa-row-backup-phone-title-v2 = Қалпына келтіру телефоны
...
tfa-row-backup-phone-delete-restriction-v2 = Қалпына келтіру телефон нөмірін өшіргіңіз келсе, алдымен сақтық көшірме аутентификация кодтарын қосыңыз немесе тіркелгіңіздің құлыпталуын болдырмау үшін екі сатылы аутентификацияны сөндіріңіз.
tfa-row-backup-phone-description-v2 = Егер сіз аутентификация қолданбасын пайдалана алмасаңыз, бұл ең оңай қалпына келтіру әдісі.
...
passkey-row-header = Рұқсат кілттері
...
terms-privacy-agreement-intro-3 = Жалғастыру арқылы сіз келесімен келісесіз:
terms-privacy-agreement-customized-terms = { $serviceName }: <termsLink>Қызмет көрсету шарттары</termsLink> мен <privacyLink>Жекелік ескертуі</privacyLink>
terms-privacy-agreement-mozilla-2 = { -product-mozilla-accounts(capitalization: "uppercase") } <mozillaAccountsTos>Қолдану шарттары</mozillaAccountsTos> және <mozillaAccountsPrivacy>Қауіпсіздік ескертуі</mozillaAccountsPrivacy>
...
auth-error-224 = Рұқсат кілті табылмады
auth-error-225 = Рұқсат кілті әлдеқашан тіркелген
...
passkey-registration-error-invalid-state = Бұл рұқсат кілті тіркелген болып тұр. Оны жүйеге кіру үшін пайдаланыңыз немесе басқа қол жеткізу кілтін қосыңыз.
...
passkey-authentication-error-security = Бұл бетте рұқсат кілттерін пайдалану мүмкін емес. Дұрыс қауіпсіз сайтта екеніңізді тексеріп, қайталап көріңіз.
passkey-authentication-error-invalid-state = Рұқсат кілтіңізбен бірнәрсе дұрыс болмады. Қайталап көріңіз немесе басқа кіру әдісін пайдаланыңыз.
...
pair-auth-allow-refuse-device-link = Бұл сіз болмасаңыз, <a>пароліңізді өзгертіңіз</a>
...
pair-auth-complete-send-tab-heading = Сіз бірнеше бетті жіберуге дайынсыз
pair-auth-complete-send-tab-device-connected = { $deviceOS } үшін { $deviceFamily } қосылған.
pair-auth-complete-send-tab-benefits = Ашық беттер, парольдер және бетбелгілерді құрылғылар арасында лезде жібере аласыз.
...
pair-failure-header-v2 = Құрылғыны жұптау сәтсіз аяқталды
pair-failure-message-v2 = Орнатуды аяқтау мүмкін емес. Эл. поштаңызбен жүйеге кіріңіз.
pair-failure-try-again-link = Қайтадан көру


pair-sync-header = Телефонда немесе планшетте { -brand-firefox } синхрондаңыз
pair-cad-header-v2 = Басқа құрылғыны байланыстыру
...
pair-choice-subheader = Өзіңіздің { -brand-firefox } тәжірибеңізді синхрондаңыз
pair-choice-description = Барлық құрылғыларда сақталған парольдер, беттер, шолу тарихын және т.б. қараңыз.
pair-choice-header-send-tab = Беттерді жібергіңіз келетін құрылғыға { -brand-firefox } жүктеп алыңыз немесе ашыңыз
pair-choice-legend = Жалғастыру үшін опцияны таңдаңыз:
pair-choice-has-mobile-title = Менде мобильді { -brand-firefox } бар
pair-choice-has-mobile-description = Мобильді құрылғыңызда { -brand-firefox } бар болса, синхрондауды қазір бастаңыз.
pair-choice-needs-mobile-title = Менде мобильді { -brand-firefox } жоқ
pair-choice-needs-mobile-description = Мобильді құрылғыңызға { -brand-firefox } жүктеп алыңыз, содан кейін синхрондауды бастаңыз.
pair-choice-continue-button = Жалғастыру
pair-signed-in-successfully = Жүйеге сәтті кірдіңіз!
pair-account-created-now-syncing = Тіркелгі жасалды. Қазір синхрондау жүруде.
pair-password-created-now-syncing = Пароль жасалды. Қазір синхрондау жүруде.


pair-download-subheader = Мобильді құрылғылар үшін { -brand-firefox } жүктеп алыңыз
pair-download-description = Телефонда немесе планшетте { -brand-firefox } синхрондау үшін алдымен мобильді телефонға { -brand-firefox } жүктеп алу керек. Оны келесідей жасауға болады:
pair-download-step-scan-qr = <b>{ $stepNumber }-қадам</b>: Мобильді құрылғыңыздағы камерамен осы QR кодын сканерлеу арқылы { -brand-firefox } қолданбасын жүктеп алыңыз:
pair-download-step-continue-sync = <b>{ $stepNumber }-қадам</b>: Мобильді құрылғыда { -brand-firefox } тәжірибесін синхрондау үшін "Синхрондауға жалғастыру" опциясын таңдаңыз.
...
pair-success-tab-close-message = Бұл бет { -brand-firefox } арқылы автоматты түрде жабылады.
...
pair-unsupported-oops-header = Ой! Сіз { -brand-firefox } қолданбайтын сияқтысыз.
pair-unsupported-switch-to-firefox = { -brand-firefox } ішіне ауысып, басқа құрылғыны қосу үшін осы бетті ашыңыз.
...
pair-unsupported-connecting-mobile-instructions-v2 = Компьютеріңізде { -brand-firefox } ашып, <b>firefox.com/pair</b> сайтына кіріңіз және мобильді құрылғыны қосу үшін экрандағы нұсқауларды орындаңыз.
...
set-password-passwordless-info = Бұл пароль синхрондалған деректеріңізді шифрлейді және оларды қауіпсіз сақтайды.
...
signin-passkey-fallback-header = Кіруді аяқтау
...
signin-passwordless-code-subheading = Бұл кодты пайдаланған кезде жүйеге кіру небәрі бір қадамды алады.
signin-passwordless-code-instruction =
    { $expirationMinutes ->
        [one] <email>{ $email }</email> адресіне жіберілген кодты { $expirationMinutes } минут ішінде енгізіңіз.
       *[other] <email>{ $email }</email> адресіне жіберілген кодты { $expirationMinutes } минут ішінде енгізіңіз.
    }
signin-passwordless-code-input-label-v2 = 6-цифрлық кодты енгізіңіз
signin-passwordless-code-confirm-button = Растау
signin-passwordless-code-required-error = Растау коды қажет
signin-passwordless-code-expired = Кодтың мерзімі бітті ме?
signin-passwordless-code-resend-countdown =
    { $seconds ->
        [one] Жаңа кодты { $seconds } секундтан кейін эл. пошта арқылы жіберу
       *[other] Жаңа кодты { $seconds } секундтан кейін эл. пошта арқылы жіберу
    }
signin-passwordless-code-resend-link = Жаңа кодты эл. поштамен жіберу.
signin-passwordless-code-resend-error = Бірнәрсе қате кетті. Жаңа кодты жіберу мүмкін емес.
signin-passwordless-code-other-account-link = Басқа тіркелгіні қолдану


signup-passwordless-code-subheading = Бұл кодты пайдаланған кезде жүйеге тіркелу небәрі бір қадамды алады.


signin-passwordless-totp-required = Тіркелгіңізде екі сатылы аутентификация іске қосулы. Жүйеге парольмен кіріңіз.
...
signup-sync-info = { -brand-firefox } қолданатын әр жерде парольдер, бетбелгілерді және т.б. синхрондаңыз.
signup-sync-info-with-payment = { -brand-firefox } қолданатын әр жерде парольдер, төлем әдірстері, бетбелгілерді және т.б. синхрондаңыз.
...
signup-confirmed-sync-description-with-payment-v2 = Парольдер, төлем әдістері, адрестер, бетбелгілер, тарих және тағы басқаларыңыз { -brand-firefox } пайдаланатын барлық жерде синхрондала алады.
signup-confirmed-sync-description-v2 = Парольдер, адрестер, бетбелгілер, тарих және тағы басқаларыңыз { -brand-firefox } пайдаланатын барлық жерде синхрондала алады.
