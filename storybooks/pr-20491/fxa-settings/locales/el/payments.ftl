...
price-details-tax = { $priceAmount } + { $taxAmount } (φόρος)
# $intervalCount (Number) - The interval between payments, in days.
...
insufficient-funds-error = Φαίνεται πως η κάρτα σας δεν διαθέτει επαρκές υπόλοιπο. Δοκιμάστε μια άλλη κάρτα.
...
sub-route-idx-cancel-aside-2 = Έχετε απορίες; Επισκεφθείτε την <a>Υποστήριξη { -brand-mozilla }</a>.
