...
# Variables
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
freeTrialEndingReminder-subject = תקופת הניסיון החינמית שלך עבור { $productName } מסתיימת בקרוב
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
freeTrialEndingReminder-content-greeting = לקוח { $productName } יקר,
# Variables:
#   $serviceLastActiveDateOnly (String) - The date the free trial ends, e.g. January 20, 2016
freeTrialEndingReminder-content-trial-ending = תקופת הניסיון החינמית שלך מתוכננת להסתיים בתאריך <strong>{ $serviceLastActiveDateOnly }</strong>.
freeTrialEndingReminder-content-trial-ending-plaintext = תקופת הניסיון החינמית שלך מתוכננת להסתיים בתאריך { $serviceLastActiveDateOnly }.
# Variables:
#   $invoiceTotal (String) - The total amount that will be charged, e.g. $9.99
#   $serviceLastActiveDateOnly (String) - The date the charge will occur, e.g. January 20, 2016
freeTrialEndingReminder-content-auto-charge = אלא אם תבטל לפני כן, המינוי שלך יתחיל אוטומטית ונחייב <strong>{ $invoiceTotal }</strong> מאמצעי התשלום שבחשבון שלך, בתאריך <strong>{ $serviceLastActiveDateOnly }</strong>.
freeTrialEndingReminder-content-auto-charge-plaintext = אלא אם תבטל לפני כן, המינוי שלך יתחיל אוטומטית ונחייב { $invoiceTotal } מאמצעי התשלום שבחשבון שלך, בתאריך { $serviceLastActiveDateOnly }.
freeTrialEndingReminder-content-charge-heading = פרטי חיוב
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
...
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-free-trial-subject = תקופת הניסיון החינמית שלך ל־{ $productName } הופעלה מחדש
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-title = תודה שהפעלת מחדש את המינוי שלך ל־{ $productName }!
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-free-trial-title = תודה שהפעלת מחדש את תקופת הניסיון החינמית שלך ל־{ $productName }!
# Variables:
#  $invoiceTotal (String) - The amount of the subscription invoice, including currency, e.g. $10.00
