...
import { AppleIapService, GoogleIapService } from '@fxa/payments/iap';
...
export class SubscriptionManagementService {
  ...
  private async getAppleIapPurchases(uid: string) {
    ...
    const appleIapSubscriptions =
      await this.appleIapService.getActiveSubscriptions(uid);
  ...
  private async getGoogleIapPurchases(uid: string) {
    ...
    const googleIapSubscriptions =
      await this.googleIapService.getActiveSubscriptions(uid);
