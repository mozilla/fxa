loyalty-discount-terms-support = Ярдәм хезмәтенә мөрәҗәгать итү

## Page

# This string appears as a separation between the two sign-in options, "Enter your email"(signin-form-email-input) "or"(this string) "Continue with Google"(continue-signin-with-google-button) / "Continue with Apple"(continue-signin-with-apple-button)
checkout-signin-options-or = яки
continue-signin-with-google-button = { -brand-google } аркылы дәвам итү
continue-signin-with-apple-button = { -brand-apple } аркылы дәвам итү
...
upgrade-page-payment-information = Түләү турындагы мәгълүмат
...
checkout-error-contact-support-button = Ярдәм хезмәтенә мөрәҗәгать итү

## Error pages - Payment method failure messages

intent-expired-card-error = Кредит картагызның вакыты чыккан, ахрысы. Башка карта кулланып карагыз.
...
interstitial-offer-error-button-sign-in = Керү
...
next-pay-with-heading-paypal = { -brand-paypal } белән түләү

## $productName (String) - The name of the product associated with the subscription.

churn-stay-subscribed-button-stay-subscribed = Язылуда калу
...
interstitial-offer-cancel-subscription-button = Язылудан баш тарту
...
select-tax-location-title = Урнашу
...
churn-error-page-button-contact-support = Ярдәм хезмәтенә мөрәҗәгать итү
churn-error-page-button-sign-in = Керү
...
upgrade-purchase-details-new-plan-daily = { $productName } (көндәлек)
upgrade-purchase-details-new-plan-weekly = { $productName } (атналык)
upgrade-purchase-details-new-plan-monthly = { $productName } (айлык)
upgrade-purchase-details-new-plan-yearly = { $productName } (еллык)
