...
upgrade-page-acknowledgment-from-trial = 升级后，目前的免费试用将立即结束，并从即日起按新方案的价格收费。
...
cart-free-trial-mismatch-error = 您的免费试用资格已发生变化，请再试一次。
...
interstitial-offer-error-customer-mismatch-heading = 此订阅未与您的账户关联
interstitial-offer-error-customer-mismatch-message = 请确认登录的账户无误。如需帮助，请联系支持。
...
interstitial-offer-error-button-sign-in = 登录
interstitial-offer-error-button-contact-support = 联系支持
...
subscription-management-free-trial-heading = 免费试用
subscription-management-your-free-trials-aria = 您的免费试用
# Heading for mobile only quick links menu
subscription-management-jump-to-heading = 跳转到
subscription-management-nav-free-trials = 免费试用
...
checkbox-payment-required-no-charge = 开始免费试用前需要添加付款方式。在 { $endDate } 前不会向您收费。
checkbox-confirm-free-trial-with-legal-links = 我授权 { -brand-mozilla } 在免费试用结束后于 { $endDate } 依照<termsOfServiceLink>服务条款</termsOfServiceLink>和<privacyNoticeLink>隐私声明</privacyNoticeLink>，向我的付款方式收取此费用，直到我主动取消订阅为止。
...
free-trial-ineligible-notice = 您的账户不符合免费试用的资格，您可以通过付费订阅来继续使用。
...
# $productName (String) - The name of the product to create subscription, e.g. Mozilla VPN
churn-cancel-flow-discount-already-applied-message = 此折扣已应用于您账户的 { $productName } 订阅。若仍需帮助，请联系我们的支持团队。
...
churn-cancel-flow-after = 之后，您的订阅将按标准费用自动续订，除非您主动取消。
churn-cancel-flow-cancel-success-title = 有缘再会
# $productName (String) - The name of the product to create subscription, e.g. Mozilla VPN
# $date (Date) - Last day of product access
churn-cancel-flow-cancel-success-dialog-msg = 您的 { $productName } 订阅已取消。您仍可使用 { $productName } 到 { $date }。
churn-cancel-flow-cancel-turn-back-on = 您可在订阅到期前随时重新订阅。
churn-cancel-flow-cancel-success-dialog-aside = 遇到问题？请访问 <LinkExternal>{ -brand-mozilla } 技术支持</LinkExternal>。
...
churn-stay-subscribed-button-no-thanks = 不了，谢谢
    .aria-label = 返回订阅页面
churn-stay-subscribed-link-terms-and-restrictions = 限制条款和限制条件适用
...
churn-stay-subscribed-thanks-valued-subscriber = 感谢您成为尊贵的订阅用户！
...
# The sentence before this informs the customer that they will save a discount on their next bill (e.g. You will save 10% on your next charge of $12 to your PayPal payment method on March 6, 2026.)
churn-stay-subscribed-after = 之后，您的订阅将按标准费用自动续订，除非您主动取消。
...
free-trial-content-trial-expires = 您的免费试用将于 { $date } 到期。
free-trial-content-trial-cancelled = 已取消您的免费试用。
...
free-trial-content-charge-info-with-tax-default = { $date } 免费试用期结束后，将向您收费 { $amount } + 税款 { $tax }。

# Charge info strings - no tax, per interval

free-trial-content-charge-info-no-tax-day = { $date } 免费试用期结束后，将每天向您收费 { $amount }。
free-trial-content-charge-info-no-tax-week = { $date } 免费试用期结束后，将每周向您收费 { $amount }。
free-trial-content-charge-info-no-tax-month = { $date } 免费试用期结束后，将每月向您收费 { $amount }。
free-trial-content-charge-info-no-tax-halfyear = { $date } 免费试用期结束后，将每半年向您收费 { $amount }。
free-trial-content-charge-info-no-tax-year = { $date } 免费试用期结束后，将每年向您收费 { $amount }。
...
free-trial-content-button-cancel-subscription-aria = 取消订阅 { $productName }
...
interstitial-offer-success-cancel-title = 有缘再会
# $productName (String) - The name of the product to create subscription, e.g. Mozilla VPN
# $date (Date) - Last day of product access
interstitial-offer-cancel-success-dialog-msg = 您的 { $productName } 订阅已取消。您仍可使用 { $productName } 到 { $date }。
interstitial-offer-turn-back-on = 您可在订阅到期前随时重新订阅。
interstitial-offer-cancel-success-dialog-aside = 遇到问题？请访问 <LinkExternal>{ -brand-mozilla } 技术支持</LinkExternal>。
interstitial-offer-button-back-to-subscriptions = 返回“订阅”
interstitial-offer-action-error = 发生意外错误，请重试。
...
interstitial-offer-button-keep-subscription = 保持订阅
...
free-trial-start-message-yearly = 今天无需付费。{ $endDate } 免费试用期结束后，才会向您收费 { $firstPrice }/年。
...
stay-subscribed-next-charge-with-tax = 下次将于 { $currentPeriodEnd } 收取 { $nextInvoiceTotal } + 税款 { $taxDue }。
...
subscription-content-last-bill-with-tax = { $invoiceTotal } + 税款 { $taxDue }
...
subscription-content-next-bill-with-tax-1 = { $nextInvoiceTotal } + 税款 { $taxDue }
...
subscription-content-link-churn-intervention-terms-aria = 查看优惠券条款与限制
...
churn-error-page-title-discount-already-applied = 已经使用此折扣码
# $productName (String) - The name of the product associated with the subscription.
churn-error-page-message-discount-already-applied = 此折扣已应用于您账户的 { $productName } 订阅。若仍需帮助，请联系我们的支持团队。
churn-error-page-button-manage-subscriptions = 管理订阅
churn-error-page-button-contact-support = 联系技术支持
churn-error-page-button-try-again = 重试
churn-error-page-title-customer-mismatch = 优惠券无法兑换
churn-error-page-message-customer-mismatch = 此优惠券是向其他订阅发放的，仅限原接收者兑换使用。
churn-error-page-button-sign-in = 登录
churn-error-page-title-general-error = 续订时出现问题
churn-error-page-message-general-error = 联系用户支持，或再试一次。
# $productName (String) - The name of the product associated with the subscription.
...
manage-payment-method-intent-error-card-declined = 无法处理您的交易。请检查您的信用卡信息，然后重试。
manage-payment-method-intent-error-expired-card-error = 您的信用卡似乎已过期，请改用其他卡。
manage-payment-method-intent-error-try-again = 呃，您的付款授权有问题。请再试一次或与您的发卡机构联系。
...
next-charge-with-discount-and-tax-card = 下次于 { $currentPeriodEnd } 向尾号 { $last4 } 的卡片收取 { $nextInvoiceTotal } + 税款 { $taxDue } 时，您将享受 { $discountPercent }% 优惠。
next-charge-with-discount-and-tax-payment-method = 下次于 { $currentPeriodEnd } 通过 { $paymentMethod } 付款方式收取 { $nextInvoiceTotal } + 税款 { $taxDue } 时，您将享受 { $discountPercent }% 优惠。
next-charge-next-charge-with-discount-and-tax = 下次于 { $currentPeriodEnd } 收取 { $nextInvoiceTotal } + 税款 { $taxDue } 时，您将享受 { $discountPercent }% 优惠。
