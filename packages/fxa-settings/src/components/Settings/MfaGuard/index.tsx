 ...
 * Returns a stable memoized function to match useErrorHandler behavior.
 */
export const useMfaErrorHandler = () => {
  ...
  // Memoize to return a stable reference, matching useErrorHandler behavior
  return useCallback(
    (error: unknown) => {
      clearMfaAndJwtCacheOnInvalidJwt(error, scope);
    },
    [scope]
  );
};
