...
automated-email-sign-in =
    Бұл — автоматты түрде жіберілген хат; егер сіз бұл әрекетке рұқсат бермесеңіз, <a data-l10n-name="securitySettingsLink">тіркелгіңіздің қауіпсіздік баптауларын қарап шығыңыз</a>.
    Қосымша ақпарат алу үшін <a data-l10n-name="supportLink">{ -brand-mozilla }</a> қолдау көрсету орталығына кіріңіз.
automated-email-sign-in-plaintext = Егер сіз бұл әрекетке рұқсат бермесеңіз, тіркелгіңіздің қауіпсіздік баптауларын мына адрес бойынша қарап шығыңыз:
...
postAddPasskey-subject = Рұқсат кілті жасалды
postAddPasskey-preview = Енді құрылғыңызды жүйеге кіру үшін пайдалана аласыз
postAddPasskey-title = Сіз рұқсат кілтін жасадыңыз
postAddPasskey-description = Енді сіз оны барлық { -product-mozilla-account } қызметтеріңізге кіру үшін пайдалана аласыз.
postAddPasskey-sync-note = Назар аударыңыз, { -brand-firefox } синхрондау деректеріңізге кіру үшін пароль қажет болады.
# Links out to a support article about passkeys and { -brand-firefox } sync
postAddPasskey-learn-more = Көбірек білу
postAddPasskey-requested-from = Сіз мұны келесі жерден сұрадыңыз:
postAddPasskey-action = Тіркелгіні басқару
...
postRemovePasskey-subject = Рұқсат кілті өшірілді
postRemovePasskey-preview = Рұқсат кілті сіздің тіркелгіңізден өшірілді
postRemovePasskey-title = Сіз өз рұқсат кілтіңізді өшірдіңіз
postRemovePasskey-description = Кіру үшін басқа әдісті пайдалануыңыз қажет болады.
postRemovePasskey-requested-from = Сіз мұны келесі жерден сұрадыңыз:
postRemovePasskey-action = Тіркелгіні басқару
