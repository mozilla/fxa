...
export class MetricErrorReporter {
  ...
  constructor(protected readonly sentry: BrowserClient) {}
...
export class MetricValidator {
  protected readonly maxEventOffset: number;
  ...
  constructor(
    ...
    if (opts.maxEventOffset != null) {
      ...
      console.trace('wut');
      throw new Error('config.maxEventOffset missing');
    }
   ...
   * @param {any} def - default value in the event value is not a number
