...
const TESTS: [string, any, Record<string, any>?][] = [
  ...
  ['passwordResetSyncNoRecoveryKeyEmail', new Map<string, Test | any>([
    ['subject', { test: 'equal', expected: 'Password updated' }],
    ['headers', new Map([
      ['X-Link', { test: 'equal', expected: configUrl('createAccountRecoveryUrl', 'password-reset-sync-no-recovery-key', 'create-recovery-key', 'email', 'uid') }],
      ['X-SES-MESSAGE-TAGS', { test: 'equal', expected: sesMessageTagsHeaderValue('passwordResetSyncNoRecoveryKey') }],
      ['X-Template-Name', { test: 'equal', expected: 'passwordResetSyncNoRecoveryKey' }],
      ['X-Template-Version', { test: 'equal', expected: TEMPLATE_VERSIONS.passwordResetSyncNoRecoveryKey }],
    ])],
    ['html', [
      { test: 'include', expected: 'Your password has been reset' },
      { test: 'include', expected: decodeUrl(configHref('createAccountRecoveryUrl', 'password-reset-sync-no-recovery-key', 'create-recovery-key', 'email', 'uid')) },
      { test: 'include', expected: decodeUrl(configHref('initiatePasswordChangeUrl', 'password-reset-sync-no-recovery-key', 'change-password', 'email')) },
      { test: 'include', expected: decodeUrl(configHref('privacyUrl', 'password-reset-sync-no-recovery-key', 'privacy')) },
      { test: 'include', expected: decodeUrl(configHref('supportUrl', 'password-reset-sync-no-recovery-key', 'support')) },
      { test: 'include', expected: 'If you didn’t take this action, '},
      { test: 'include', expected: 'change your password'},
      { test: 'include', expected: `${MESSAGE.device.uaBrowser} on ${MESSAGE.device.uaOS} ${MESSAGE.device.uaOSVersion}` },
      { test: 'include', expected: `${MESSAGE.date}` },
    ...
    ['text', [
      { test: 'include', expected: 'Your password has been reset' },
      { test: 'include', expected: configUrl('createAccountRecoveryUrl', 'password-reset-sync-no-recovery-key', 'create-recovery-key', 'email', 'uid') },
      { test: 'include', expected: `change your password right away:\n${configUrl('initiatePasswordChangeUrl', 'password-reset-sync-no-recovery-key', 'change-password', 'email')}` },
      { test: 'include', expected: `Mozilla Accounts Privacy Notice\n${configUrl('privacyUrl', 'password-reset-sync-no-recovery-key', 'privacy')}` },
      { test: 'include', expected: `For more info, visit Mozilla Support:\n${configUrl('supportUrl', 'password-reset-sync-no-recovery-key', 'support')}` },
      { test: 'include', expected: `${MESSAGE.device.uaBrowser} on ${MESSAGE.device.uaOS} ${MESSAGE.device.uaOSVersion}` },
      { test: 'include', expected: `${MESSAGE.date}` },
      { test: 'exists', expected: `${MESSAGE.time}` },
      { test: 'include', expected: `Download Firefox on the App Store:` },
