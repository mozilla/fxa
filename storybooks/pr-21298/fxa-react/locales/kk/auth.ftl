...
# Variables
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
freeTrialEndingReminder-subject = Сіздің { $productName } тегін сынақ нұсқаңыз жақында аяқталады
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
freeTrialEndingReminder-content-greeting = Құрметті { $productName } пайдаланушысы,
# Variables:
#   $serviceLastActiveDateOnly (String) - The date the free trial ends, e.g. January 20, 2016
freeTrialEndingReminder-content-trial-ending = Сіздің тегін сынақ мерзімі <strong>{ $serviceLastActiveDateOnly }</strong> күні аяқталады деп жоспарланған.
freeTrialEndingReminder-content-trial-ending-plaintext = Сіздің тегін сынақ мерзімі { $serviceLastActiveDateOnly } күні аяқталады деп жоспарланған.
# Variables:
...
freeTrialEndingReminder-content-thanks-plaintext = { $productName } қолданып көргеніңіз үшін рақмет. Сынақ нұсқасы немесе жазылым туралы сұрақтарыңыз болса, бізбен хабарласыңыз.
freeTrialEndingReminder-content-closing = Құрметпен,
# Variables:
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
freeTrialEndingReminder-content-signature = { $productName } командасы
# Variables:
#  $subscriptionSupportUrlWithUtm (String) - URL to the subscription products support page
freeTrialEndingReminder-content-support-plaintext = Бізбен хабарласу: { $subscriptionSupportUrlWithUtm }
#  Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
...
#   $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
#   $serviceLastActiveDateOnly (String) - The date of last active service, e.g. 01/20/2016
subscriptionEndingReminder-content-line1 = Сіздің { $productName } қызметіне қол жеткізу мүмкіндігіңіз <strong>{ $serviceLastActiveDateOnly }</strong> күні аяқталады.
subscriptionEndingReminder-content-line2-v2 = Егер { $productName } қызметін пайдалануды жалғастырғыңыз келсе, жазылымды <strong>{ $serviceLastActiveDateOnly }</strong> күніне дейін <a data-l10n-name="subscriptionEndingReminder-subscription-management">Жазылымды басқару</a> бөлімінде ұзарта аласыз. Көмек қажет болса, <a data-l10n-name="subscriptionEndingReminder-contact-support">қолдау көрсету тобына хабарласыңыз</a>.
...
subscriptionEndingReminder-content-line2-plaintext-v2 = Егер { $productName } қызметін пайдалануды жалғастырғыңыз келсе, жазылымды { $serviceLastActiveDateOnly } күніне дейін Жазылымды басқару бөлімінде ұзарта аласыз. Көмек қажет болса, қолдау көрсету тобына хабарласыңыз.
...
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-free-trial-subject = Сіздің { $productName } тегін сынақ мерзіміңіз қайта белсендірілді
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-title = { $productName } жазылуын қайта белсендіргеніңіз үшін рақмет!
# Variables:
#  $productName (String) - The name of the subscribed product, e.g. Mozilla VPN
subscriptionReactivation-free-trial-title = { $productName } тегін сынақ мерзімін қайта белсендіргеніңіз үшін рақмет!
# Variables:
#  $invoiceTotal (String) - The amount of the subscription invoice, including currency, e.g. $10.00
