...
automated-email-sign-in =
    นี่คืออีเมลอัตโนมัติ หากคุณไม่อนุญาตให้ดำเนินการนี้ โปรด<a data-l10n-name="securitySettingsLink">ตรวจสอบการตั้งค่าความปลอดภัยบัญชีของคุณ</a>
    สำหรับข้อมูลเพิ่มเติม โปรดไปที่ <a data-l10n-name="supportLink">ฝ่ายสนับสนุนของ { -brand-mozilla }</a>
automated-email-sign-in-plaintext = หากคุณไม่อนุญาตให้ดำเนินการนี้ โปรดตรวจสอบการตั้งค่าความปลอดภัยบัญชีของคุณที่:
...
postAddPasskey-subject = พาสคีย์ถูกสร้างแล้ว
postAddPasskey-preview = คุณสามารถใช้อุปกรณ์ของคุณในการลงชื่อเข้า
postAddPasskey-title = คุณได้สร้างพาสคีย์แล้ว
postAddPasskey-description = คุณสามารถใช้มันเพื่อลงชื่อเข้าบริการ { -product-mozilla-account } ทั้งหมดของคุณ
postAddPasskey-sync-note = โปรดทราบว่ารหัสผ่านของคุณยังจำเป็นในการเข้าถึงข้อมูลซิงค์ { -brand-firefox } ของคุณ
# Links out to a support article about passkeys and { -brand-firefox } sync
postAddPasskey-learn-more = เรียนรู้เพิ่มเติม
postAddPasskey-requested-from = คุณขอสิ่งนี้จาก:
postAddPasskey-action = จัดการบัญชี
...
postAddTwoStepAuthentication-recovery-method-phone = นอกจากนี้ คุณยังได้เพิ่ม { $maskedPhoneNumber } เป็นเบอร์โทรศัพท์สำหรับกู้คืนของคุณด้วย
...
postConsumeRecoveryCode-subject-v3 = รหัสยืนยันตัวตนสำรองถูกใช้แล้ว
postConsumeRecoveryCode-preview = ตรวจสอบให้แน่ใจว่านี่คือคุณ
...
postRemovePasskey-subject = พาสคีย์ถูกลบแล้ว
postRemovePasskey-preview = พาสคีย์ได้ถูกเอาออกจากบัญชีของคุณแล้ว
postRemovePasskey-title = คุณลบพาสคีย์ของคุณแล้ว
postRemovePasskey-description = คุณจำเป็นต้องใช้วิธีอื่นในการลงชื่อเข้า
postRemovePasskey-requested-from = คุณขอสิ่งนี้จาก:
postRemovePasskey-action = จัดการบัญชี
postRemoveRecoveryPhone-subject = เอาเบอร์โทรศัพท์สำหรับกู้คืนออกแล้ว
postRemoveRecoveryPhone-preview = บัญชีที่ปกป้องโดยการยืนยันตัวตนสองขั้นตอน
postRemoveRecoveryPhone-title = เอาเบอร์โทรศัพท์สำหรับกู้คืนออกแล้ว
postRemoveRecoveryPhone-description-v2 = เบอร์โทรศัพท์สำหรับกู้คืนของคุณได้ถูกเอาออกจากการตั้งค่าการยืนยันตัวตนสองขั้นตอนแล้ว
postRemoveRecoveryPhone-description-extra = คุณยังสามารถใช้รหัสยืนยันตัวตนสำรองในการลงชื่อเข้าหากคุณไม่สามารถใช้งานแอปยืนยันตัวตนของคุณได้
...
postSigninRecoveryCode-subject = รหัสยืนยันตัวตนสำรองถูกใช้เพื่อลงชื่อเข้าแล้ว
postSigninRecoveryCode-preview = ยืนยันกิจกรรมในบัญชี
postSigninRecoveryCode-title = รหัสยืนยันตัวตนสำรองของคุณถูกใช้ในการลงชื่อเข้าแล้ว
postSigninRecoveryCode-description = หากคุณไม่ได้ดำเนินการสิ่งนี้ คุณควรเปลี่ยนรหัสผ่านของคุณทันทีเพื่อรักษาความปลอดภัยของบัญชีของคุณ
postSigninRecoveryCode-device = คุณลงชื่อเข้าใช้จาก:
postSigninRecoveryCode-action = จัดการบัญชี
postSigninRecoveryPhone-subject = เบอร์โทรศัพท์สำหรับกู้คืนถูกใช้ลงชื่อเข้าแล้ว
postSigninRecoveryPhone-preview = ยืนยันกิจกรรมในบัญชี
postSigninRecoveryPhone-title = เบอร์โทรศัพท์สำหรับกู้คืนได้ถูกใช้ลงชื่อเข้าแล้ว
postSigninRecoveryPhone-description = หากคุณไม่ได้ดำเนินการสิ่งนี้ คุณควรเปลี่ยนรหัสผ่านของคุณทันทีเพื่อรักษาความปลอดภัยของบัญชีของคุณ
...
unblockCode-subject-2 = ใช้ { $unblockCode } เพื่อลงชื่อเข้า
unblockCode-preview = รหัสนี้จะหมดอายุในหนึ่งชั่วโมง
...
verifyAccountChange-subject = ใช้ { $code } เพื่อเปลี่ยนบัญชีของคุณ
# Variables:
# $expirationTime (Number) - Represents the expiration time in minutes
verifyAccountChange-preview = รหัสนี้จะหมดอายุภายใน { $expirationTime } นาที
verifyAccountChange-title = คุณต้องการเปลี่ยนข้อมูลบัญชีหรือไม่?
# After the colon is a description of the device used to sign in to the service
verifyAccountChange-safe = ช่วยเรารักษาบัญชีของคุณให้ปลอดภัยด้วยการอนุมัติการเปลี่ยนแปลงนี้:
verifyAccountChange-prompt = ถ้าใช่ นี่คือรหัสอนุญาตของคุณ:
# Variables:
# $expirationTime (Number) - Represents the expiration time in minutes
verifyAccountChange-expiry-notice = มันจะหมดอายุภายใน { $expirationTime } นาที
# Variables:
#  $clientName (String) - A client the user hasn't signed into before (e.g. Firefox, Sync)
...
# Variables:
#  $code (String) - The confirmation code for sign-in
verifyLoginCode-subject-line-3 = ใช้ { $code } เพื่อลงชื่อเข้า
verifyLoginCode-preview = รหัสนี้จะหมดอายุภายใน 5 นาที
# Variables:
...
verifySecondaryCode-subject-2 = ใช้ { $code } เพื่อยืนยันอีเมลสำรองของคุณ
verifySecondaryCode-preview = รหัสนี้จะหมดอายุภายใน 5 นาที
...
verifyShortCode-subject-4 = ใช้ { $code } เพื่อยืนยันบัญชีของคุณ
verifyShortCode-preview-2 = รหัสนี้จะหมดอายุภายใน 5 นาที
