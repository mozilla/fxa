...
passkey-registration-error-not-supported = 여기에 패스키는 지원되지 않습니다. 다른 방법이나 장치를 사용해 보세요.
...
passkey-authentication-error-not-supported = 패스키는 지원되지 않습니다. 다른 방법이나 장치를 사용해 보세요.
