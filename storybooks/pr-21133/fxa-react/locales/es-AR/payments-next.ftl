...
loyalty-discount-terms-contact-support-product-aria = Contactá a soporte para { $productName }
...
upgrade-page-acknowledgment-from-trial = Al actualizar, tu prueba gratuita activa finalizará de inmediato y se te cobrará el nuevo plan hoy.
...
cart-free-trial-mismatch-error = Tu elegibilidad para la prueba gratuita cambió. Probá de nuevo.
...
new-account-prepaid-card-free-trial-not-allowed = Las tarjetas prepagas no se pueden usar para comenzar una prueba gratuita en cuentas nuevas. Probá un método de pago diferente.
...
churn-cancel-flow-error-offer-expired-title = Esta oferta ya expiró
churn-cancel-flow-error-offer-expired-message = Actualmente no hay descuentos disponibles para esta suscripción. Podés continuar con la cancelación si querés.
...
interstitial-offer-error-customer-mismatch-heading = Esta suscripción no está asociada con tu cuenta
interstitial-offer-error-customer-mismatch-message = Asegurate de haber iniciado sesión con la cuenta correcta o contactate con Soporte si necesitás ayuda.
...
interstitial-offer-error-button-sign-in = Iniciar sesión
interstitial-offer-error-button-contact-support = Contactar soporte
...
already-canceling-title = Tu suscripción está programada para finalizar
# $productName (String) - The name of the product to create subscription, e.g. Mozilla VPN
# $date (Date) - Last day of product access
already-canceling-message = Continuarás teniendo acceso a { $productName } hasta { $date }.
already-canceling-turn-back-on = Podés volver a activar tu suscripción en cualquier momento antes de que finalice.
already-canceling-button-back-to-subscriptions = Volver a suscripciones
...
cancel-subscription-button-keep-subscription = Mantener la suscripción
...
checkbox-payment-required-no-charge = Se requiere un método de pago para empezar la prueba gratuita. No se te cobrará hasta el { $endDate }.
checkbox-confirm-free-trial-with-legal-links = Autorizo a { -brand-mozilla } a realizar cobros, por el monto indicado, a mi método de pago a partir de la fecha de fin de la prueba gratuita el { $endDate }, en cumplimiento de los <termsOfServiceLink>términos de servicio</termsOfServiceLink> y la <privacyNoticeLink>nota de privacidad</privacyNoticeLink>, y hasta que cancele mi suscripción.
...
churn-cancel-flow-button-back-to-subscriptions = Volver a suscripciones
churn-cancel-flow-action-error = Ocurrió un error inesperado. Probá de nuevo.
# $discountPercent (Number) - The discount amount between 1 and 100 as an integer (e.g, 'Stay subscribed and save 10%', discountPercent = 10)
churn-cancel-flow-button-stay-subscribed-and-save-discount = Mantenete suscripto y ahorrá { $discountPercent }%
churn-cancel-flow-button-stay-subscribed-and-save = Mantenete suscripto y ahorrá
...
# $productName (String) - The name of the product to create subscription, e.g. Mozilla VPN
churn-cancel-flow-discount-already-applied-message = Este descuento fue aplicado a una suscripción a { $productName } para tu cuenta. Si todavía necesitás ayuda, contactá a nuestro equipo de Soporte.
churn-cancel-flow-button-manage-subscriptions = Administrar suscripciones
churn-cancel-flow-button-contact-support = Contactar soporte
...
free-trial-content-trial-expires = La prueba gratuita vence el { $date }.
free-trial-content-trial-cancelled = Se canceló tu prueba gratuita.
...
interstitial-offer-action-error = Ocurrió un error inesperado. Probá de nuevo.
...
interstitial-offer-button-keep-subscription = Mantener la suscripción
...
free-trial-start-message-daily = No se requiere pago hoy. Se te cobrará { $firstPrice }/día después de que finalice la prueba gratuita el { $endDate }.
free-trial-start-message-weekly = No se requiere pago hoy. Se te cobrará { $firstPrice }/semana después de que finalice la prueba gratuita el { $endDate }.
free-trial-start-message-monthly = No se requiere pago hoy. Se te cobrará { $firstPrice }/mes después de que finalice la prueba gratuita el { $endDate }.
free-trial-start-message-halfyearly = No se requiere pago hoy. Se te cobrará { $firstPrice }/6 meses después de que finalice la prueba gratuita el { $endDate }.
free-trial-start-message-yearly = No se requiere pago hoy. Se te cobrará { $firstPrice }/año después de que finalice la prueba gratuita el { $endDate }.

##

# $endDate (String) - The date of the first charge after the free trial ends
free-trial-first-charge-title = Primer cargo: { $endDate }
...
subscription-content-link-churn-intervention-terms-apply = Aplican términos
subscription-content-link-churn-intervention-terms-aria = Ver términos y restricciones del cupón
...
paypal-unavailable-error = { -brand-paypal } no está disponible actualmente. Usá otra opción de pago o volvé a intentarlo más tarde.
...
churn-error-page-title-customer-mismatch = El cupón no puede ser canjeado
churn-error-page-message-customer-mismatch = Este cupón fue emitido para una suscripción diferente y solo puede ser canjeado por el destinatario original.
churn-error-page-button-sign-in = Iniciar sesión
churn-error-page-title-general-error = Hubo un problema con la renovación de la suscripción
churn-error-page-message-general-error = Contactá a soporte o intentá de nuevo.
# $productName (String) - The name of the product associated with the subscription.
...
manage-payment-method-intent-error-card-declined = La transacción no pudo ser procesada. Verificá la información de la tarjeta de crédito y probá nuevamente.
manage-payment-method-intent-error-expired-card-error = Parece que la tarjeta de crédito ha expirado. Probá con otra tarjeta.
manage-payment-method-intent-error-try-again = Hmm. Hubo un problema al autorizar el pago. Probá nuevamente o ponete en contacto con el emisor de tu tarjeta.
...
next-charge-with-discount-and-tax-card = Ahorrarás { $discountPercent }% en tu próximo cargo de { $nextInvoiceTotal } + { $taxDue } de impuestos a la tarjeta que termina en { $last4 } el { $currentPeriodEnd }.
next-charge-with-discount-and-tax-payment-method = Ahorrarás { $discountPercent }% en tu próximo cargo de { $nextInvoiceTotal } + { $taxDue } impuestos a tu método de pago { $paymentMethod } el { $currentPeriodEnd }.
...
next-charge-no-tax-card = Tu próximo cargo será de { $nextInvoiceTotal } a la tarjeta que termina en { $last4 } el { $currentPeriodEnd }.
next-charge-no-tax-payment-method = Tu próximo cargo será de { $nextInvoiceTotal } a tu método de pago { $paymentMethod } el { $currentPeriodEnd }.
next-charge-no-tax = Tu próximo cargo será de { $nextInvoiceTotal } el { $currentPeriodEnd }.
