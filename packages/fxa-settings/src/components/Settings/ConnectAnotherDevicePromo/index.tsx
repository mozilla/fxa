  ...
  return (
    ...
    >
      ...
      <div className="flex flex-2 justify-center mt-5 mobileLandscape:mt-0 mobileLandscape:justify-end mobileLandscape:rtl:justify-start">
        <LinkExternal
          className="self-center rounded focus-visible:outline focus-visible:outline-blue-500 focus-visible:outline-2 outline-offset-2"
        ...
        <LinkExternal
          className="self-center m-2 rounded focus-visible:outline focus-visible:outline-blue-500 focus-visible:outline-2 outline-offset-2"
