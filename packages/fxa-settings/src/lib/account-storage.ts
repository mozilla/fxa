...
function migrateLegacyAccountState(uid: string): void {
  ...
  // Merge legacy data into the account
  accounts[uid] = {
    ...currentAccount,
    ...legacyData,
    // Preserve loadingFields as array
    loadingFields: legacyData.loadingFields || [],
...
/**
 * Get current account UID from localStorage
 */
...
/**
 * Get account data from localStorage (unified structure)
 */
...
/**
 * Update account data in localStorage (unified)
 */
export function updateAccountData(
  ...
  accounts[accountUid] = {
    ...currentAccount,
    ...updates,
    // Ensure loadingFields stays as array
    loadingFields: updates.loadingFields ?? currentAccount.loadingFields ?? [],
    // Preserve error structure
    error: updates.error !== undefined ? updates.error : (currentAccount.error ?? null),
  };
