...
export class CartService {
  ...
  async getCart(cartId: string): Promise<WithUpcomingInvoiceCart> {
    ...
    const taxAmounts = [
      {
        title: upcomingInvoice.total_tax_amounts[0].tax_rate.display_name,
        inclusive: upcomingInvoice.total_tax_amounts[0].inclusive,
        amount: upcomingInvoice.total_tax_amounts[0].amount,
      },
    ];
    ...
    const discountAmount =
      ...
      upcomingInvoice.total_discount_amounts.length > 0
        ? upcomingInvoice.total_discount_amounts[0].amount
        : null;
    ...
    return {
      ...
      invoicePreview: {
        ...
        listAmount: upcomingInvoice.amount_due,
        totalAmount: upcomingInvoice.total,
