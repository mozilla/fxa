...
export default async function Manage({
  ...
  return (
    <div
      className="flex flex-col justify-center tablet:px-8"
    ...
    >
      {isPaypalBillingAgreementError && (
        <Banner variant={BannerVariant.Error}>
          <div className="leading-6 text-base">
            ...
            >
              {l10n.getString(
                'subscription-management-page-paypal-error-link-manage-payment-method',
      ...
      <h1
        ...
        className="font-bold leading-6 mt-4 px-4 text-xl tablet:px-6"
      >
        {l10n.getString('subscription-management-heading', 'Subscriptions')}
      </h1>
      {subscriptions.length > 0 && (
        <nav className="px-4 tablet:hidden" aria-labelledby="mobile-jump-menu">
          <h2 id="mobile-jump-menu" className="font-bold my-6">
            {l10n.getString(
      ...
      >
        ...
        <div className="w-full py-6 text-grey-600 bg-white rounded-[12px] border border-grey-200 opacity-100 shadow-[0_0_16px_0_rgba(0,0,0,0.08)] tablet:px-6 tablet:py-8">
          <div className="px-4 tablet:px-0">
            ...
            {isStripeCustomer && (
              <>
                ...
                />
                <div
                  className={`w-full flex flex-col gap-2 items-start tablet:flex-row ${(type === 'card' && !walletType) || isPaypalBillingAgreementError ? 'tablet:items-start' : 'tablet:items-center'}`}
                >
                  <h3 className="tablet:min-w-[160px]">
                    {l10n.getString(
                  ...
                  {!defaultPaymentMethod && subscriptions.length > 0 && (
                    <div className="w-full flex flex-col gap-2 tablet:flex-row tablet:items-center tablet:justify-between">
                      <p>
                        {l10n.getString(
                          'subscripton-manaagement-payment-method-add',
                      ...
                      >
                        <span>
                          {l10n.getString(
                            'subscription-management-button-add-payment-method-1',
                            'Add payment method'
                          )}
                        </span>
                      </Link>
                  ...
                  {type === 'external_paypal' && (
                    <div
                      className={`w-full flex ${isPaypalBillingAgreementError ? 'items-start' : 'items-center'} justify-between gap-4`}
                    >
                      <div className="leading-6">
                        <Image
                      ...
                      <LinkExternal
                        className={
                          isPaypalBillingAgreementError
                            ? 'bg-blue-500 border border-blue-600 box-border font-bold font-header inline-block rounded text-center py-2 px-5 w-auto text-white'
      ...
      {/* {subscriptions.length === 0 &&
        ...
        appleIapSubscriptions.length === 0 && (
          <section aria-labelledby="no-subscriptions-list-heading">
            <h2
              id="no-subscriptions-list-heading"
              className="font-bold px-4 py-6 text-lg tablet:px-6"
            >
              {l10n.getString(
                      ...
                      <div className="w-full py-1 text-grey-600 rounded-lg border-2 border-[#E0E0E6] bg-white">
                        <div className="flex flex-col p-4 tablet:flex-row tablet:items-start tablet:px-6">
                          ...
                          <div className="flex flex-col gap-4 w-full">
                            ...
                            <div className="flex tablet:justify-end w-full tablet:w-auto">
                              <LinkExternal
                                className="text-blue-500 hover:text-blue-600 cursor-pointer flex items-center gap-1 flex-shrink-0 overflow-hidden text-ellipsis underline whitespace-nowrap"
