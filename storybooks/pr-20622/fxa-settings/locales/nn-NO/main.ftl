...
app-footer-privacy-notice = Personvernfråsegn for nettstaden
...
terms-privacy-agreement-intro-3 = Ved å halde fram godtek du følgjande:
terms-privacy-agreement-customized-terms = { $serviceName }: <termsLink>Bruksvilkår</termsLink> og <privacyLink>personvernfråsegn</privacyLink>
...
passkey-registration-canceled = Oppsett av passnøkkel vart avbrote. Prøv igjen.
...
pair-auth-allow-heading-text = Logga du nettopp på { -brand-firefox }?
pair-auth-allow-confirm-button = Ja, godkjenn eininga
pair-auth-allow-refuse-device-link = Viss dette ikkje var deg, <a>endre passordet ditt</a>
...
signin-recovery-error = Noko gjekk gale. Logg inn på nytt.
