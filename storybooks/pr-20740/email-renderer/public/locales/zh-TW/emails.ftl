...
postAddPasskey-requested-from = 您從下列位置提出要求：
...
postAddTwoStepAuthentication-from-device-v2 = 您從下列位置提出要求：
...
postChangeRecoveryPhone-requested-device = 您從下列位置提出要求：
...
postRemovePasskey-subject = 已刪除 passkey
