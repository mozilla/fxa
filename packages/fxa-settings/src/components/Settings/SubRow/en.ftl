...
# Backup recovery phone is a backup method for two-step authentication
...
tfa-row-backup-phone-delete-restriction = If you need to remove your phone number as a backup recovery option, first add backup authentication codes or disable two-step authentication to prevent account lockout.
# "this" refers to backup recovery phone
tfa-row-backup-phone-description = This is the easier method if you canʼt use your authenticator app, because you will receive an instant recovery code via text message, eliminating the need to save backup authentication codes.
