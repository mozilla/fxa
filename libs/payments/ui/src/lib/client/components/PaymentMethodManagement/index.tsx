...
export function PaymentMethodManagement({
  ...
  return (
    <div className="tablet:px-8">
      ...
      {isReady && (
        <h1
          className="font-bold leading-6 mt-4 px-4 py-6 text-xl tablet:px-6"
      ...
      <Form.Root
        ...
        className="w-full py-6 text-grey-600 bg-white rounded-[12px] border border-grey-200 opacity-100 shadow-[0_0_16px_0_rgba(0,0,0,0.08)]"
      >
