...
class RecoveryPhoneHandler {
  ...
  getLocalizedStrings = async (
    ...
    const fallbackMessage =
      type === 'setup'
        ? `${code} is your Mozilla verification code. It will expire in 5 minutes. Do not share this code with anyone.`
        : `${code} is your Mozilla recovery code. It will expire in 5 minutes. Do not share this code with anyone.`;
