...
link-sr-new-window = Wočinja w nowym woknje


app-loading-spinner-aria-label-loading = Začituje so…
...
dark-mode-toggle-label = Drastu změnić
...
dc-subheader-content-2 = { -product-mozilla-accounts(capitalization: "upper", case: "dat") } dowolić, techniske a interakciske daty na { -brand-mozilla } pósłać.
...
dc-opt-in-success-2 = Wulki dźak! Dźělenje tutych datow nam pomha, { -product-mozilla-accounts(capitalization: "lower", case: "acc") } polěpšić.
...
delete-account-confirm-title-4 = Sće snano swoje { -product-mozilla-account(capitalization: "lower", case: "acc") } z jednym produktom abo z jednej słužbu  { -brand-mozilla } abo z wjacorymi z nich zwjazał, kotrež was wěsty a produktiwny we webje dźerža:
...
delete-account-delete-button-passwordless = Konto zhašeć
...
page-passkey-add-creating-heading = Hesłowy kluč so wutworja…
page-passkey-add-follow-prompts = Slědujće namołwam na swojim graće.
page-passkey-add-cancel = Přetorhnyć
...
product-promo-vpn-description = Wotkryjće přidatu runinu anonymneho přehladowanja a škita.
product-promo-vpn-cta = { -product-mozilla-vpn-short } wobstarać
...
terms-privacy-agreement-intro-3 = Hdyž pokročujeće, zwoliće do tole:
terms-privacy-agreement-customized-terms = { $serviceName }: <termsLink>Wužiwanske wuměnjenja</termsLink> a <privacyLink>zdźělenka priwatnosće</privacyLink>
terms-privacy-agreement-mozilla-2 = { -product-mozilla-accounts(capitalization: "uppercase") } <mozillaAccountsTos>Wužiwanske wuměnjenja</mozillaAccountsTos> a <mozillaAccountsPrivacy>zdźělenki priwatnosće</mozillaAccountsPrivacy>
...
cookies-disabled-enable-prompt-2 = Prošu zmóžńće placki a lokalny składowak we wašim wobhladowaku, zo byšće přistup k swojemu { -product-mozilla-account(capitalization: "lower", case: "dat") } měł. To funkcije zmóžnja, kaž na přikład spomjatkowanje přez posedźenja.
...
pair-failure-header-v2 = Koplowanje gratow njeje so poradźiło
pair-failure-message-v2 = Instalaciski proces njeda so dokónčić. Prošu přizjewće so ze swojej e-mejlowej adresu.
pair-failure-try-again-link = Hišće raz spytać


pair-sync-header = { -brand-firefox } na swójim šmóratce abo tableće synchronizować
pair-cad-header-v2 = Z druhim gratom zwjazać
...
pair-choice-has-mobile-title = Mam hižo { -brand-firefox } za mobilne graty
pair-choice-has-mobile-description = Startujće swoju synchronizaciju, jeli hižo { -brand-firefox } na swojim mobilnym graće maće.
pair-choice-needs-mobile-title = Nimam { -brand-firefox } za mobilne graty
pair-choice-needs-mobile-description = Sćehńće { -brand-firefox } do swojeho mobilneho grata a startujće potom swoju synchronizaciju.
pair-choice-continue-button = Dale
pair-signed-in-successfully = Wuspěšnje přizjewjeny!
...
signin-password-needed-header-2 = Zapodajće swoje hesło <span>za swoje { -product-mozilla-account(capitalization: "lower", case: "acc") }</span>
...
signin-recovery-error = Něšto je so nimokuliło. Prošu přizjewće so hišće raz.
...
signin-passwordless-code-input-label-v2 = 6-městnowy kod zapodać
...
signin-token-code-heading-2 = Zapodajće wobkrućenski kod<span>za swoje { -product-mozilla-account(capitalization: "lower", case: "acc") }</span>
...
confirm-signup-code-heading-2 = Zapodajće wobkrućenski kod <span>za swoje { -product-mozilla-account(capitalization: "lower", case: "acc") }</span>
