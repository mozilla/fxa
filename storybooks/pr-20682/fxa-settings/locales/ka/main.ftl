...
link-sr-new-window = გახსნა ახალ ფანჯარაში


app-loading-spinner-aria-label-loading = იტვირთება…
...
button-passkey-signin-loading = უსაფრთხო შესვლა…
...
cs-scope-firefox-vpn = { -brand-firefox } ჩაშენებული VPN-ით
...
page-passkey-add-creating-heading = იქმნება საშვი…
page-passkey-add-follow-prompts = მიჰყევით მითითებებს თქვენს მოწყობილობაზე.
page-passkey-add-cancel = გაუქმება


page-passkey-add-success = საშვი შექმნილია
page-passkey-add-error-system-v2 = ხარვეზს წააწყდა საშვის შექმნისას. კვლავ სცადეთ მოგვიანებით.
...
recent-activity-account-two-factor-removed = ორბიჯიანი დამოწმება მოცილდა
...
recent-activity-account-recovery-phone-replace-complete = აღდგენის ტელეფონი ჩანაცვლდა
recent-activity-account-recovery-phone-replace-failure = აღდგენის ტელეფონის უშედეგო ჩანაცვლება
recent-activity-account-two-factor-replace-success = ორბიჯიანი დამოწმება ჩანაცვლდა
recent-activity-account-two-factor-replace-failure = ორბიჯიანი დამოწმების უშედეგო ჩანაცვლება
recent-activity-account-recovery-phone-setup-failed = აღდგენის ტელეფონი უშედეგო გამართვა
recent-activity-account-recovery-phone-reset-password-complete = აღდგენის ტელეფონით პაროლის განულება შესრულდა
recent-activity-account-recovery-phone-reset-password-failed = აღდგენის ტელეფონით პაროლის განულება ვერ მოხერხდა
recent-activity-account-mfa-otp-sent = ანგარიშზე ცვლილების დამოწმების მოთხოვნა
recent-activity-account-mfa-otp-verified = ანგარიშზე ცვლილება დამოწმდა
recent-activity-account-mfa-otp-failed = ანგარიშზე ცვლილების უშედეგო დამოწმება
recent-activity-account-passkey-registration-success = საშვი დამატებულია
recent-activity-account-passkey-registration-failure = საშვის აღნუსხვა ვერ მოხერხდა
recent-activity-account-passkey-removed = საშვი მოცილებულია
recent-activity-account-passkey-authentication-success = საშვით შესვლა შესრულდა
recent-activity-account-passkey-authentication-failure = საშვით უშედეგო შესვლა
recent-activity-account-passwordless-login-otp-sent = უპაროლო შესვლის კოდი გაიგზავნა
recent-activity-account-passwordless-login-otp-failed = უპაროლო შესვლის უშედეგო კოდი
...
product-promo-vpn-description = გამოცადეთ და დაამატეთ ვინაობის გაუმხელობისა და უსაფრთხოების კიდევ ერთი შრე.
product-promo-vpn-cta = გამოიყენეთ { -product-mozilla-vpn-short }
...
passkey-sub-row-created-date = შექმნილი: { $createdDate }
...
passkey-row-header = საშვები
passkey-row-enabled = ჩართულია
...
passkey-row-max-limit-banner =
    { $count ->
        [one] უკვე გამოყენებული გაქვთ ყველა, სულ { $count } საშვი. წაშალეთ რომელიმე ახლის შესაქმნელად.
       *[other] უკვე გამოყენებული გაქვთ ყველა, სულ { $count } საშვი. წაშალეთ რომელიმე ახლის შესაქმნელად.
    }
passkey-row-max-limit-disabled-reason = მიღწეულია საშვების ნებადართული რაოდენობა.
...
terms-privacy-agreement-intro-3 = თუ განაგრძობთ, ამით თანახმა ხართ მიიღოთ:
terms-privacy-agreement-customized-terms = { $serviceName }: <termsLink>მომსახურების პირობები</termsLink> და <privacyLink>პირადულობის განაცხადი</privacyLink>
terms-privacy-agreement-mozilla-2 = { -product-mozilla-accounts } <mozillaAccountsTos>მომსახურების პირობები</mozillaAccountsTos> და <mozillaAccountsPrivacy>პირადულობის განაცხადი</mozillaAccountsPrivacy>
...
auth-error-224 = საშვი არაა
auth-error-225 = საშვი უკვე აღნუსხულია
...
passkey-registration-canceled = საშვის გამართვა გაუქმებულია. სცადეთ ხელახლა.
...
passkey-authentication-error-not-readable = წვდომა ვერ მოხერხდა დამმოწმებელთან. სცადეთ ხელახლა ან გამოიყენეთ შესვლის სხვა გზა.
passkey-authentication-error-unexpected = რაღაც ხარვეზია. სცადეთ ხელახლა ან აირჩიეთ შესვლის სხვა გზა.
passkey-authentication-error-not-found = საშვის ამოცნობა ვერ მოხერხდა. შესვლისთვის სხვა გზა გამოიყენეთ.
...
pair-auth-complete-send-tab-device-connected = { $deviceFamily } { $deviceOS }-ზე დაკავშირებულია.
...
pair-choice-subheader = დაასინქრონეთ თქვენი { -brand-firefox }
...
pair-download-description = { -brand-firefox } რომ დასინქრონდეს ტელეფონზე ან პლანშეტზე, ჯერ უნდა ჩამოტვირთოთ { -brand-firefox } მობილურზე. აი, როგორ:
pair-download-step-scan-qr = <b>ნაბიჯი { $stepNumber }</b>: ჩამოტვირთეთ { -brand-firefox } ამ QR-კოდის წაკითხვით თქვენი მობილურის კამერით:
pair-download-step-continue-sync = <b>ნაბიჯი { $stepNumber }</b>: გახსენით { -brand-firefox } და მიუთითეთ „გაგრძელება დასინქრონებისთვის“ თქვენს მობილურ მოწყობილობაზე.
...
pair-unsupported-switch-to-firefox = გადართეთ { -brand-firefox }-ზე და გახსენით ეს გვერდი სხვა მოწყობილობაზე დაკავშირებისთვის.
...
pair-unsupported-connecting-mobile-instructions-v2 = გაუშვით { -brand-firefox } თქვენს კომპიუტერში, ინახულეთ გვერდი <b>firefox.com/pair</b> და მიჰყევით ეკრანზე მითითებებს თქვენი მობილური მოწყობილობის დასაკავშირებლად.
...
set-password-passwordless-info = ეს პაროლი შიფრავს თქვენს დასინქრონებულ მონაცემებს და ინახავს უსაფრთხოდ.
...
signin-recovery-error = რაღაც ხარვეზი წარმოიქმნა. გთხოვთ, შეხვიდეთ მოგვიანებით.
...
signin-passkey-fallback-header = დაასრულეთ შესვლა
...
signin-token-code-resend-code-countdown =
    { $seconds ->
        [one] ახალი კოდი გაგზავნეთ { $seconds } წამში
       *[other] ახალი კოდი გაგზავნეთ { $seconds } წამში
    }
