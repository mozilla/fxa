...
button-passkey-signin = Mit Zugangsschlüssel anmelden
button-passkey-signin-loading = Sichere Anmeldung…
...
dark-mode-toggle-label = Theme umschalten
...
remember-password-passkey-text = Haben Sie einen Zugangsschlüssel oder kennen Sie Ihr Passwort?
...
password-reset-warning-review-sign-in-options = Überprüfen Sie die Anmeldeoptionen, um die Browser-Daten zu behalten
password-reset-warning-have-key = Haben Sie einen Kontowiederherstellungsschlüssel?
password-reset-warning-use-key-link-v2 = Verwenden Sie ihn, um Ihr Passwort zurückzusetzen und Ihre Browser-Daten zu behalten
password-reset-warning-signed-in-device = Sind Sie noch auf einem anderen Gerät angemeldet?
password-reset-warning-signed-in-device-description = Möglicherweise sind Ihre Browser-Daten noch verfügbar. Setzen Sie Ihr Passwort zurück und melden Sie sich auf dem Gerät an, um Ihre Daten wiederherzustellen und zu synchronisieren.
password-reset-warning-restore-data-link = Erfahren Sie, wie Sie Browser-Daten von einem angemeldeten Gerät wiederherstellen
password-reset-warning-new-device = Verwenden Sie ein neues Gerät, können aber nicht auf Ihre alten zugreifen?
password-reset-warning-new-device-description = Nachdem Sie Ihr Passwort zurückgesetzt haben, sind verschlüsselte Browser-Daten auf den Servern von { -brand-firefox } auf diesem Gerät nicht mehr verfügbar.
...
delete-account-delete-button-passwordless = Konto löschen
...
recent-activity-account-passkey-wrap-deleted = Synchronisierungszugriff für Zugangsschlüssel entfernt
recent-activity-account-passkey-wrap-deletion-failure = Synchronisierungszugriff für Zugangsschlüssel konnte nicht entfernt werden
...
passkey-row-info-link-2 = Weitere Informationen
passkey-row-max-limit-banner =
    { $count ->
        [one] Sie haben alle { $count } Zugangsschlüssel verwendet. Löschen Sie einen Zugangsschlüssel, um einen neuen zu erstellen.
...
terms-privacy-agreement-intro-3 = Indem Sie fortfahren, stimmen Sie dem folgenden zu:
terms-privacy-agreement-customized-terms = { $serviceName }: <termsLink>Nutzungsbedingungen</termsLink> und <privacyLink>Datenschutzhinweis</privacyLink>
terms-privacy-agreement-mozilla-2 = { -product-mozilla-accounts(capitalization: "uppercase") }: <mozillaAccountsTos>Nutzungsbedingungen</mozillaAccountsTos> und <mozillaAccountsPrivacy>Datenschutzhinweis</mozillaAccountsPrivacy>
...
pair-auth-complete-send-tab-heading = Sie sind bereit, einige Tabs zu senden
pair-auth-complete-send-tab-device-connected = { $deviceFamily } für { $deviceOS } ist verbunden.
pair-auth-complete-send-tab-benefits = Sie können sofort offene Tabs, Passwörter und Lesezeichen zwischen Geräten senden.
...
pair-failure-header-v2 = Kopplung des Geräts fehlgeschlagen
pair-failure-message-v2 = Die Einrichtung konnte nicht abgeschlossen werden. Bitte melden Sie sich mit Ihrer E-Mail-Adresse an.
pair-failure-try-again-link = Erneut versuchen


pair-sync-header = Synchronisieren Sie { -brand-firefox } auf Ihrem Handy oder Tablet
pair-cad-header-v2 = Weiteres Gerät verbinden
...
pair-choice-subheader = Synchronisieren Sie Ihr Erlebnis mit { -brand-firefox }
pair-choice-description = Sehen Sie Ihre gespeicherten Passwörter, Tabs, Chronik und mehr – auf allen Ihren Geräten.
pair-choice-header-send-tab = Laden Sie { -brand-firefox } herunter oder öffnen Sie { -brand-firefox } auf dem Gerät, an das Sie Tabs senden möchten
...
pair-choice-continue-button = Weiter
pair-signed-in-successfully = Erfolgreich angemeldet!
pair-account-created-now-syncing = Konto erstellt. Sie synchronisieren jetzt.
pair-password-created-now-syncing = Passwort erstellt. Sie synchronisieren jetzt.
...
pair-download-step-continue-sync = <b>Schritt { $stepNumber }</b>: Wählen Sie „Weiter zur Synchronisierung“, um Ihr { -brand-firefox }-Erlebnis auf Ihrem Mobilgerät zu synchronisieren.
pair-continue-to-sync-button = Weiter zur Synchronisierung
...
pair-unsupported-oops-header = Hoppla! Anscheinend verwenden Sie { -brand-firefox } nicht.
pair-unsupported-switch-to-firefox = Wechseln Sie zu { -brand-firefox } und öffnen Sie diese Seite, um ein anderes Gerät zu verbinden.
...
pair-unsupported-connecting-mobile-instructions-v2 = Öffnen Sie { -brand-firefox } auf Ihrem Computer, besuchen Sie <b>firefox.com/pair</b> und befolgen Sie die Anweisungen auf dem Bildschirm, um Ihr Mobilgerät zu verbinden.
pair-unsupported-learn-more-link-v2 = Weitere Informationen
...
signin-password-needed-header-2 = Geben Sie Ihr Passwort <span>für Ihr { -product-mozilla-account } ein</span>
...
signin-recovery-error = Es trat ein Problem auf. Bitte melden Sie sich erneut an.
...
signin-passkey-fallback-header = Anmeldung abschließen
...
signin-passwordless-code-input-label-v2 = 6-stelligen Code eingeben
