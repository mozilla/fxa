...
churn-cancel-flow-error-offer-expired-title = Deze aanbieding is verlopen
...
error-payment-method-banner-title-expired-card = Verlopen kaart
error-payment-method-banner-message-add-new-card = Voeg een nieuwe kaart of betalingsmethode toe om onderbreking van uw abonnementen te voorkomen.
error-payment-method-banner-label-update-payment-method = Betalingsmethode bijwerken
error-payment-method-expired-card = Uw kaart is verlopen. Voeg een nieuwe kaart of betalingsmethode toe om onderbreking van uw abonnementen te voorkomen.
error-payment-method-banner-title-invalid-payment-information = Ongeldige betalingsgegevens
error-payment-method-banner-message-account-issue = Er is een probleem met uw account.
subscription-management-button-manage-payment-method-1 = Betalingsmethode beheren
subscription-management-error-apple-pay = Er is een probleem met uw { -brand-apple-pay }-account. Los het probleem op om uw actieve abonnementen te behouden.
subscription-management-error-google-pay = Er is een probleem met uw { -brand-google-pay }-account. Los het probleem op om uw actieve abonnementen te behouden.
subscription-management-error-link = Er is een probleem met uw { -brand-link }-account. Los het probleem op om uw actieve abonnementen te behouden.
...
subscription-management-error-payment-method = Er is een probleem met uw betalingsmethode. Los het probleem op om uw actieve abonnementen te behouden.
...
churn-cancel-flow-success-title = U bent nog steeds geabonneerd
...
churn-cancel-flow-success-message = Uw abonnement loopt door en u bespaart { $discountPercent }% op uw volgende factuur.
# $productName (String) - The name of the product to create subscription, e.g. Mozilla VPN
churn-cancel-flow-thanks-valued-subscriber = Bedankt voor het gebruik van { $productName }!
churn-cancel-flow-button-back-to-subscriptions = Terug naar abonnementen
churn-cancel-flow-action-error = Er is een onverwachte fout opgetreden. Probeer het opnieuw.
